 ...
 */
class peano::integration::dataqueries::QueryServer: public tarch::services::Service {
  private:
	...
	struct Query {
      ...
      Query( const DataQuery& queryDescription, tarch::plotter::griddata::regular::CartesianGridWriter::VertexDataWriter* plotter);
	 ...
	 */
	std::vector<Query> _pendingQueries;
  ...
  public:
     ...
     */
    DataQuery getPendingQueryDescription( int queryNumber ) const;
