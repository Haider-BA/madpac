...
#ifndef _PEANO_KERNEL_STACKS_VERTEX_FILE_STACK_H_
#define _PEANO_KERNEL_STACKS_VERTEX_FILE_STACK_H_
 ...
 */
template <class Vertex>
class peano::kernel::stacks::VertexFileStack {
  private:
    typedef peano::kernel::stacks::implementation::FileStack< typename Vertex::PersistentVertex >  PersistentContainer;
    typedef peano::kernel::stacks::implementation::FileStack< Vertex >                             TemporaryContainer;
     ...
     */
    VertexFileStack<Vertex>( const VertexFileStack<Vertex>& stack ) {}

    /**
     * One is not allowed to clone a stack.
     */
    VertexFileStack<Vertex>& operator=( const VertexFileStack<Vertex>& stack ) { return *this; }
  public:
    /**
     * Constructor.
     *
...
#include "peano/kernel/stacks/VertexFileStack.cpph"
