...
#ifndef _PEANO_KERNEL_STACKS_IMPLEMENTATION_ARRAY_STACK_H_
#define _PEANO_KERNEL_STACKS_IMPLEMENTATION_ARRAY_STACK_H_
 ...
 */
template <class T>
class peano::kernel::stacks::implementation::ArrayStack {
  private:
    /**
     * Log device.
     */
...
template <class T>
tarch::logging::Log peano::kernel::stacks::implementation::ArrayStack<T>::_log( "peano::kernel::stacks::implementation::ArrayStack" );
