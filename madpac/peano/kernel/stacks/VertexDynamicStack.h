...
#ifndef _PEANO_KERNEL_STACKS_VERTEX_Dynamic_STACK_H_
#define _PEANO_KERNEL_STACKS_VERTEX_Dynamic_STACK_H_
 ...
 */
template <class Vertex>
class peano::kernel::stacks::VertexDynamicStack {
  private:
    /**
     * Logging device.
     */
    ...
    typedef peano::kernel::stacks::implementation::DynamicStack< typename Vertex::PersistentVertex >  PersistentContainer;
     ...
     */
    VertexDynamicStack<Vertex>( const VertexDynamicStack<Vertex>& stack ) {}

    /**
     * One is not allowed to clone a stack.
     */
    VertexDynamicStack<Vertex>& operator=( const VertexDynamicStack<Vertex>& stack ) { return *this; }
  public:
    /**
     * Constructor.
     *
...
#include "peano/kernel/stacks/VertexDynamicStack.cpph"
