...
#ifndef _PEANO_KERNEL_STACKS_CELL_ARRAY_STACK_H_
#define _PEANO_KERNEL_STACKS_CELL_ARRAY_STACK_H_
 ...
 */
template <class Cell>
class peano::kernel::stacks::CellArrayStack {
  private:
    typedef typename peano::kernel::stacks::implementation::ArrayStack<typename Cell::PersistentCell> Container;
