...
#ifndef _PEANO_KERNEL_SPACETREEGRID_NODES_TASKS_INVOKE_ENTER_CELL_H_
#define _PEANO_KERNEL_SPACETREEGRID_NODES_TASKS_INVOKE_ENTER_CELL_H_
...
>
class peano::kernel::spacetreegrid::nodes::tasks::InvokeEnterCell {
  private:
