...
#ifndef _PEANO_KERNEL_SPACETREE_GRID_TESTS_CELL_LOCAL_PEANO_CURVE_TEST_H_
#define _PEANO_KERNEL_SPACETREE_GRID_TESTS_CELL_LOCAL_PEANO_CURVE_TEST_H_
 ...
 */
class peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest: public tarch::tests::TestCase {
  private:
