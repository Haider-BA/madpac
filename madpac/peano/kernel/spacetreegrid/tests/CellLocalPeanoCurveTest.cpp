#include "peano/kernel/spacetreegrid/tests/CellLocalPeanoCurveTest.h"
#include "peano/kernel/spacetreegrid/aspects/CellLocalPeanoCurve.h"
#include "peano/utils/Globals.h"


#include "tarch/tests/TestCaseFactory.h"
registerTest(peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest)
...
peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::CellLocalPeanoCurveTest():
  tarch::tests::TestCase( "peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest" ) {
}
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::run() {
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::setUp() {
}


void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::test2DCreateReadVertexSequenceForP0P0P1P2() {
  TestCell cell;
  ...
  peano::kernel::datatraversal::ActionSetTraversal sequentialTraversal = peano::kernel::spacetreegrid::aspects::CellLocalPeanoCurve::createSequentialReadVertexSequence( cell, false );
  peano::kernel::datatraversal::ActionSetTraversal parallelTraversal   = peano::kernel::spacetreegrid::aspects::CellLocalPeanoCurve::createParallelReadVertexSequence( cell, false );
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::test2DCreateReadVertexSequenceForM1M2P2P3() {
  #ifdef Dim2
  TestCell cell;
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::test2DCreateReadVertexSequenceForM1P0P0P1() {
  #ifdef Dim2
  TestCell cell;
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::test2DCreateReadVertexSequenceForP1M1O0P2() {
  #ifdef Dim2
  TestCell cell;
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::test2DCreateReadVertexSequenceForP3P2P1M1() {
  #ifdef Dim2
  TestCell cell;
  ...
  peano::kernel::datatraversal::ActionSetTraversal sequentialTraversal = peano::kernel::spacetreegrid::aspects::CellLocalPeanoCurve::createSequentialReadVertexSequence( cell, true );
  peano::kernel::datatraversal::ActionSetTraversal parallelTraversal   = peano::kernel::spacetreegrid::aspects::CellLocalPeanoCurve::createParallelReadVertexSequence( cell, true );
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::test2DCreateReadVertexSequenceForP3M1P1P2() {
  #ifdef Dim2
  TestCell cell;
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::test2DCreateReadVertexSequenceForM1P3P1P2() {
  #ifdef Dim2
  TestCell cell;
  ...
  peano::kernel::datatraversal::ActionSetTraversal sequentialTraversal         = peano::kernel::spacetreegrid::aspects::CellLocalPeanoCurve::createSequentialReadVertexSequence( cell, false );
  peano::kernel::datatraversal::ActionSetTraversal invertedSequentialTraversal = peano::kernel::spacetreegrid::aspects::CellLocalPeanoCurve::createSequentialReadVertexSequence( cell, true  );
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::test2DCreateWriteVertexSequenceForM1P0P1P2() {
  #ifdef Dim2
  TestCell cell;
  ...
  peano::kernel::datatraversal::ActionSetTraversal sequentialTraversal         = peano::kernel::spacetreegrid::aspects::CellLocalPeanoCurve::createSequentialWriteVertexSequence( cell, false );
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::test2DCreateWriteVertexSequenceForP1M1M2P2() {
  #ifdef Dim2
  TestCell cell;
  ...
  peano::kernel::datatraversal::ActionSetTraversal sequentialTraversalInverted = peano::kernel::spacetreegrid::aspects::CellLocalPeanoCurve::createSequentialWriteVertexSequence( cell, true );
...
void peano::kernel::spacetreegrid::tests::CellLocalPeanoCurveTest::test3DCreateReadVertexSequenceForM2P4M1P1P2P3() {
  #ifdef Dim3
  #endif
}
