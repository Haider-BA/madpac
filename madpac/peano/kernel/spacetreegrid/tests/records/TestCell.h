#ifndef _PEANO_KERNEL_SPACETREEGRID_TESTS_RECORDS_TESTCELL_H
#define _PEANO_KERNEL_SPACETREEGRID_TESTS_RECORDS_TESTCELL_H
...
namespace peano {
    ...
    */
   class peano::kernel::spacetreegrid::tests::records::TestCell { 
      
      public:
         
         typedef peano::kernel::spacetreegrid::tests::records::TestCellPacked Packed;
       ...
       * @date   19/05/2011 08:54
       */
      class peano::kernel::spacetreegrid::tests::records::TestCellPacked { 
         
         public:
            
            typedef peano::kernel::spacetreegrid::tests::records::TestCell::State State;
         ...
         class peano::kernel::spacetreegrid::tests::records::TestCell { 
            ...
            class peano::kernel::spacetreegrid::tests::records::TestCell { 
               ...
               public:
                   ...
                   * Generated
                   */
                  TestCell(const bool& isInside, const State& state, const int& delta, const int& rankOfActiveNode, const double& maxChildWeight, const double& accumulatedWeight, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber);
               ...
               class peano::kernel::spacetreegrid::tests::records::TestCellPacked { 
                  ...
                  public:
                      ...
                      * Generated
                      */
                     TestCellPacked(const bool& isInside, const State& state, const int& delta, const int& rankOfActiveNode, const double& maxChildWeight, const double& accumulatedWeight, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber);
               ...
               class peano::kernel::spacetreegrid::tests::records::TestCell { 
                  ...
                  public:
                      ...
                      * Generated
                      */
                     TestCell(const bool& isInside, const State& state, const int& level, const int& delta, const int& rankOfActiveNode, const double& maxChildWeight, const double& accumulatedWeight, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber);
                  ...
                  class peano::kernel::spacetreegrid::tests::records::TestCellPacked { 
                     ...
                     public:
                         ...
                         * Generated
                         */
                        TestCellPacked(const bool& isInside, const State& state, const int& level, const int& delta, const int& rankOfActiveNode, const double& maxChildWeight, const double& accumulatedWeight, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber);
