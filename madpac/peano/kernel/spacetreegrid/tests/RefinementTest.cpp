#include "peano/kernel/spacetreegrid/tests/RefinementTest.h"
#include "peano/kernel/spacetreegrid/aspects/CellRefinement.h"


#include "tarch/tests/TestCaseFactory.h"
registerTest(peano::kernel::spacetreegrid::tests::RefinementTest)
...
peano::kernel::spacetreegrid::tests::RefinementTest::RefinementTest():
  TestCase( "peano::kernel::spacetreegrid::tests::RefinementTest" ) {
}
...
void peano::kernel::spacetreegrid::tests::RefinementTest::run() {
  testMethod( testRootNodeRefinementCells );
  testMethod( test2DCellM1M2P0P0 );
}


void peano::kernel::spacetreegrid::tests::RefinementTest::testRootNodeRefinementCells() {
  ...
  coarseGridTestCell.switchToRoot();
  peano::kernel::spacetreegrid::aspects::CellRefinement::refine(coarseGridTestCell,fineGridTestCell);
...
void peano::kernel::spacetreegrid::tests::RefinementTest::test2DCellM1M2P0P0() {
  TestCell coarseGridTestCell;
  TestCell fineGridTestCell[THREE_POWER_D];
...
void peano::kernel::spacetreegrid::tests::RefinementTest::setUp() {
}
