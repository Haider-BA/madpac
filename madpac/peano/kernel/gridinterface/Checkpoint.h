...
#ifndef _PEANO_KERNEL_GRID_INTERFACE_CHECKPOINT_H_
#define _PEANO_KERNEL_GRID_INTERFACE_CHECKPOINT_H_
 ...
 */
template <class Vertex, class Cell>
class peano::kernel::gridinterface::Checkpoint {
  public:
...
#include "peano/kernel/gridinterface/Checkpoint.cpph"
