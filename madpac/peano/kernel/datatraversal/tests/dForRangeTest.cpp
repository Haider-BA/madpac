#include "peano/kernel/datatraversal/tests/dForRangeTest.h"
#include "peano/kernel/datatraversal/dForRange.h"


#include "tarch/tests/TestCaseFactory.h"
registerTest(peano::kernel::datatraversal::tests::dForRangeTest)
...
peano::kernel::datatraversal::tests::dForRangeTest::dForRangeTest():
  TestCase( "peano::kernel::datatraversal::tests::dForRangeTest" ) {
}
...
void peano::kernel::datatraversal::tests::dForRangeTest::run() {
...
void peano::kernel::datatraversal::tests::dForRangeTest::setUp() {
}


void peano::kernel::datatraversal::tests::dForRangeTest::test2D10x10Range1() {
  #ifdef Dim2
  tarch::la::Vector<DIMENSIONS,int>  range(10);

  peano::kernel::datatraversal::dForRange testRange1(range,1,false);

  validate( testRange1.is_divisible() );

  peano::kernel::datatraversal::dForRange::Split split;

  peano::kernel::datatraversal::dForRange testRange1_1(testRange1, split);
...
void peano::kernel::datatraversal::tests::dForRangeTest::test2D10x10Range12() {
  #ifdef Dim2
  tarch::la::Vector<DIMENSIONS,int>  range(10);

  peano::kernel::datatraversal::dForRange testRange12(range,12,false);

  validate( testRange12.is_divisible() );

  peano::kernel::datatraversal::dForRange::Split split;

  peano::kernel::datatraversal::dForRange testRange12_1(testRange12, split);
...
void peano::kernel::datatraversal::tests::dForRangeTest::test2D10x10Range23() {
  #ifdef Dim2
  tarch::la::Vector<DIMENSIONS,int>  range(10);

  peano::kernel::datatraversal::dForRange testRange23(range,23,false);

  validate( testRange23.is_divisible() );

  peano::kernel::datatraversal::dForRange::Split split;

  peano::kernel::datatraversal::dForRange testRange23_1(testRange23, split);
...
void peano::kernel::datatraversal::tests::dForRangeTest::test2D10x10Range40() {
  #ifdef Dim2
  tarch::la::Vector<DIMENSIONS,int>  range(10);

  peano::kernel::datatraversal::dForRange testRange40(range,40,false);

  validate( testRange40.is_divisible() );

  peano::kernel::datatraversal::dForRange::Split split;

  peano::kernel::datatraversal::dForRange testRange40_1(testRange40, split);
  ...
  peano::kernel::datatraversal::dForRange testRange40_2(testRange40, split);
  peano::kernel::datatraversal::dForRange testRange40_3(testRange40_1, split);
...
void peano::kernel::datatraversal::tests::dForRangeTest::test2D10x10Range80() {
  #ifdef Dim2
  tarch::la::Vector<DIMENSIONS,int>  range(10);

  peano::kernel::datatraversal::dForRange testRange80(range,80,false);

  validate( testRange80.is_divisible() );

  peano::kernel::datatraversal::dForRange::Split split;

  peano::kernel::datatraversal::dForRange testRange80_1(testRange80, split);
