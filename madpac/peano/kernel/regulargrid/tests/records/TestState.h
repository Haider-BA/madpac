#ifndef _PEANO_KERNEL_REGULARGRID_TESTS_RECORDS_TEST_STATE_H_
#define _PEANO_KERNEL_REGULARGRID_TESTS_RECORDS_TEST_STATE_H_
 ...
 *
 * @date   08/11/2010 10:59
 */
class peano::kernel::regulargrid::tests::records::TestState { 
   
   public:
      
      typedef peano::kernel::regulargrid::tests::records::TestStatePacked Packed;
   ...
   public:
       ...
       * Generated
       */
      TestState(const tarch::la::Vector<DIMENSIONS,double>& meshWidth, const double& numberOfInnerVertices, const double& numberOfBoundaryVertices, const double& numberOfOuterVertices, const double& numberOfInnerCells, const double& numberOfOuterCells, const bool& gridIsStationary);
    ...
    * @date   08/11/2010 10:59
    */
   class peano::kernel::regulargrid::tests::records::TestStatePacked { 
      ...
      public:
          ...
          * Generated
          */
         TestStatePacked(const tarch::la::Vector<DIMENSIONS,double>& meshWidth, const double& numberOfInnerVertices, const double& numberOfBoundaryVertices, const double& numberOfOuterVertices, const double& numberOfInnerCells, const double& numberOfOuterCells, const bool& gridIsStationary);
