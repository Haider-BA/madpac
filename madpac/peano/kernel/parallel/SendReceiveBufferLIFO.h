...
#ifndef _PEANO_KERNEL_PARALLEL_SEND_RECEIVE_BUFFER_LIFO_H_
#define _PEANO_KERNEL_PARALLEL_SEND_RECEIVE_BUFFER_LIFO_H_
 ...
 */
template <class Vertex>
class peano::kernel::parallel::SendReceiveBufferLIFO: public peano::kernel::parallel::SendReceiceBufferAbstractImplementation<Vertex> {
  private:
    /**
     * Log device.
     */
...
#include "peano/kernel/parallel/SendReceiveBufferLIFO.cpph"
