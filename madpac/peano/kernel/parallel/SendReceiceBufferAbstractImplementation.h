...
#ifndef _PEANO_KERNEL_PARALLEL_SEND_RECEIVE_BUFFER_IMPLEMENTATION_H_
#define _PEANO_KERNEL_PARALLEL_SEND_RECEIVE_BUFFER_IMPLEMENTATION_H_
 ...
 */
template <class Vertex>
class peano::kernel::parallel::SendReceiceBufferAbstractImplementation: public peano::kernel::parallel::SendReceiveBuffer {
  protected:
    /**
     * Log device.
     */
...
#include "peano/kernel/parallel/SendReceiceBufferAbstractImplementation.cpph"
