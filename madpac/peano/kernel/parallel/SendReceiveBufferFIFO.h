...
#ifndef _PEANO_KERNEL_PARALLEL_SEND_RECEIVE_BUFFER_FIFO_H_
#define _PEANO_KERNEL_PARALLEL_SEND_RECEIVE_BUFFER_FIFO_H_
 ...
 */
template <class Vertex>
class peano::kernel::parallel::SendReceiveBufferFIFO: public peano::kernel::parallel::SendReceiceBufferAbstractImplementation<Vertex> {
  private:
    /**
     * Log device.
     */
    ...
    typedef peano::kernel::parallel::SendReceiceBufferAbstractImplementation<Vertex> Base;
...
#include "peano/kernel/parallel/SendReceiveBufferFIFO.cpph"
