...
peano::toolbox::stencil::ElementWiseAssemblyMatrix
peano::toolbox::stencil::ElementMatrix::getElementWiseAssemblyMatrix( const peano::toolbox::stencil::Stencil& stencil ) const {
  /**
...
double peano::toolbox::stencil::ElementMatrix::getDiagonalElement( const ElementWiseAssemblyMatrix& matrix ) const {
  return matrix(0,0) * TWO_POWER_D;
}


double peano::toolbox::stencil::ElementMatrix::getDiagonalElement( const Stencil& stencil ) const {
  #ifdef Dim2
...
peano::toolbox::stencil::ElementMatrix::reconstructStencil(const ElementWiseAssemblyMatrix& matrix ) const {
  peano::toolbox::stencil::Stencil result(0.0);
...
peano::toolbox::stencil::ElementWiseAssemblyMatrix
peano::toolbox::stencil::ElementMatrix::getElementWiseAssemblyMatrix( const VectorOfStencils& vectorOfStencils ) const {
  /**
   * @todo Die Abbildung sollte man im Konstruktor einmal bauen und dann hier
   * nur noch anwenden. Deshalb ist das Ding ja eine Methode und kein
   * statisches Ding.
