...
#ifndef PEANO_APPLICATIONS_FAXEN_CONFIGURATIONSFaxenBatchJobConfiguration_FOR_SPACETREE_GRID_H_
#define PEANO_APPLICATIONS_FAXEN_CONFIGURATIONSFaxenBatchJobConfiguration_FOR_SPACETREE_GRID_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen {
      ...
      class FaxenBatchJobConfigurationForSpacetreeGrid;
      } 
}
}
}
...
class peano::applications::faxen::configurations::FaxenBatchJobConfigurationForSpacetreeGrid: public tarch::configuration::TopLevelConfiguration {
  public: 
    FaxenBatchJobConfigurationForSpacetreeGrid(); 
    virtual ~FaxenBatchJobConfigurationForSpacetreeGrid();
