...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2SetScenarioBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2SetScenarioBoundary_H_
 ...
 */
class peano::applications::faxen::adapters::SpacetreeGrid2SetScenarioBoundary {
  private:
    peano::applications::faxen::mappings::SpacetreeGrid2SetScenarioBoundary _map2SetScenarioBoundary;
