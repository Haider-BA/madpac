...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2SetScenarioBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2SetScenarioBoundary_H_
 ...
 */
class peano::applications::faxen::adapters::RegularGrid2SetScenarioBoundary {
  private:
    peano::applications::faxen::mappings::RegularGrid2SetScenarioBoundary _map2SetScenarioBoundary;
