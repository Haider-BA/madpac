...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2PlotSolution_H_
 ...
 */
class peano::applications::faxen::adapters::RegularGrid2PlotSolution {
  private:
    peano::applications::faxen::mappings::RegularGrid2PlotSolution _map2PlotSolution;
