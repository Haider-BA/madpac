...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2ControlTimeStep_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2ControlTimeStep_H_
 ...
 */
class peano::applications::faxen::adapters::RegularGrid2ControlTimeStep {
  private:
    peano::applications::faxen::mappings::RegularGrid2ControlTimeStep _map2ControlTimeStep;
