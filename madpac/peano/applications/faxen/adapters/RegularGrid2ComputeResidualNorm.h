...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2ComputeResidualNorm_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2ComputeResidualNorm_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen {
      namespace adapters {
        class RegularGrid2ComputeResidualNorm;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::adapters::RegularGrid2ComputeResidualNorm {
  private:
    peano::applications::faxen::mappings::RegularGrid2ComputeResidualNorm _map2ComputeResidualNorm;

  public:
    RegularGrid2ComputeResidualNorm();

    virtual ~RegularGrid2ComputeResidualNorm();
