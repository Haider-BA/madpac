...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2SetVelocitiesBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2SetVelocitiesBoundary_H_
 ...
 */
class peano::applications::faxen::adapters::SpacetreeGrid2SetVelocitiesBoundary {
  private:
    peano::applications::faxen::mappings::SpacetreeGrid2SetVelocitiesBoundary _map2SetVelocitiesBoundary;
