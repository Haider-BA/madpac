...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2ComputeVelocitiesDerivatives_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2ComputeVelocitiesDerivatives_H_
 ...
 */
class peano::applications::faxen::adapters::RegularGrid2ComputeVelocitiesDerivatives {
  private:
    peano::applications::faxen::mappings::RegularGrid2ComputeVelocitiesDerivatives _map2ComputeVelocitiesDerivatives;
