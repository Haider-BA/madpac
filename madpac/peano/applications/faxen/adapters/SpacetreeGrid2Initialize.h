...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2Initialize_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2Initialize_H_
 ...
 */
class peano::applications::faxen::adapters::SpacetreeGrid2Initialize {
  private:
    peano::applications::faxen::mappings::SpacetreeGrid2Initialize _map2Initialize;
