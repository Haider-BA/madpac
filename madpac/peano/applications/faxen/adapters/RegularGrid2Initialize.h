...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2Initialize_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2Initialize_H_
 ...
 */
class peano::applications::faxen::adapters::RegularGrid2Initialize {
  private:
