...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2InitializeAndSetBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2InitializeAndSetBoundary_H_
 ...
 */
class peano::applications::faxen::adapters::RegularGrid2InitializeAndSetBoundary {
  private:
    peano::applications::faxen::mappings::RegularGrid2Initialize _map2Initialize;
    peano::applications::faxen::mappings::RegularGrid2ExploreBoundaries _map2ExploreBoundaries;
