...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2ComputeRightHandSide_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2ComputeRightHandSide_H_
 ...
 */
class peano::applications::faxen::adapters::RegularGrid2ComputeRightHandSide {
  private:
    peano::applications::faxen::mappings::RegularGrid2ComputeRightHandSide _map2ComputeRightHandSide;
