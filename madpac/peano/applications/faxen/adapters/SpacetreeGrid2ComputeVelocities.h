...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2ComputeVelocities_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2ComputeVelocities_H_
 ...
 */
class peano::applications::faxen::adapters::SpacetreeGrid2ComputeVelocities {
  private:
    peano::applications::faxen::mappings::SpacetreeGrid2ComputeVelocities _map2ComputeVelocities;
