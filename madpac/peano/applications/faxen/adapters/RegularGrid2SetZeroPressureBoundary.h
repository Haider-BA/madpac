...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2SetZeroPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2SetZeroPressureBoundary_H_
 ...
 */
class peano::applications::faxen::adapters::RegularGrid2SetZeroPressureBoundary {
  private:
    peano::applications::faxen::mappings::RegularGrid2SetZeroPressureBoundary _map2SetZeroPressureBoundary;
