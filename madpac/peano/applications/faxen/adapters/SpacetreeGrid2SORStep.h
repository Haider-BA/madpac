...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2SORStep_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2SORStep_H_
 ...
 */
class peano::applications::faxen::adapters::SpacetreeGrid2SORStep {
  private:
    peano::applications::faxen::mappings::SpacetreeGrid2SORStep _map2SORStep;
