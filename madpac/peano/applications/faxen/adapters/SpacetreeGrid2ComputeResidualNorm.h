...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2ComputeResidualNorm_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2ComputeResidualNorm_H_
...
#include "peano/applications/faxen/SpacetreeGridState.h"
 ...
 #include "peano/applications/faxen/mappings/SpacetreeGrid2ComputeResidualNorm.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen {
      namespace adapters {
        class SpacetreeGrid2ComputeResidualNorm;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::adapters::SpacetreeGrid2ComputeResidualNorm {
  private:
    peano::applications::faxen::mappings::SpacetreeGrid2ComputeResidualNorm _map2ComputeResidualNorm;

  public:
    SpacetreeGrid2ComputeResidualNorm();

    virtual ~SpacetreeGrid2ComputeResidualNorm();
