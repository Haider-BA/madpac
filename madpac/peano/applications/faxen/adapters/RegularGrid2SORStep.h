...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2SORStep_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_RegularGrid2SORStep_H_
 ...
 */
class peano::applications::faxen::adapters::RegularGrid2SORStep {
  private:
    peano::applications::faxen::mappings::RegularGrid2SORStep _map2SORStep;
