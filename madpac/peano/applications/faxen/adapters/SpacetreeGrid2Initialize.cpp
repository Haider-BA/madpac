...
peano::applications::faxen::adapters::SpacetreeGrid2Initialize::SpacetreeGrid2Initialize() {
}
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::createHangingVertex(
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::destroyHangingVertex(
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::createInnerVertex(
      peano::applications::faxen::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::createBoundaryVertex(
      peano::applications::faxen::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::destroyVertex(
      const peano::applications::faxen::SpacetreeGridVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::faxen::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::createCell(
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::destroyCell(
...
#ifdef Parallel
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::mergeWithNeighbour(
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::touchVertexFirstTime(
      peano::applications::faxen::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::touchVertexLastTime(
      peano::applications::faxen::SpacetreeGridVertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::faxen::SpacetreeGridVertex * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::prepareSendToNeighbour(
  peano::applications::faxen::SpacetreeGridVertex& vertex
) {
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::beginIteration(
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::endIteration(
  peano::applications::faxen::SpacetreeGridState&  solverState
) {
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::enterCell(
      peano::applications::faxen::SpacetreeGridCell&                 fineGridCell,
...
void peano::applications::faxen::adapters::SpacetreeGrid2Initialize::leaveCell(
      peano::applications::faxen::SpacetreeGridCell&           fineGridCell,
      peano::applications::faxen::SpacetreeGridVertex * const  fineGridVertices,
      const peano::kernel::gridinterface::VertexEnumerator&          fineGridVerticesEnumerator,
      peano::applications::faxen::SpacetreeGridVertex * const  coarseGridVertices,
