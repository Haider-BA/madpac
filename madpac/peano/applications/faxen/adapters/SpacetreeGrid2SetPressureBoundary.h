...
#ifndef PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2SetPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_ADAPTERS_SpacetreeGrid2SetPressureBoundary_H_
 ...
 */
class peano::applications::faxen::adapters::SpacetreeGrid2SetPressureBoundary {
  private:
    peano::applications::faxen::mappings::SpacetreeGrid2SetPressureBoundary _map2SetPressureBoundary;
