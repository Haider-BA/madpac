...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ComputeResidualNorm_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ComputeResidualNorm_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2ComputeResidualNorm {
  private:
    /**
     * Logging device.
     */
