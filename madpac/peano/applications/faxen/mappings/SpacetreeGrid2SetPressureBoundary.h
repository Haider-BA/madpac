...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2SetPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2SetPressureBoundary_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2SetPressureBoundary {
  private:
    /**
     * Logging device.
     */
