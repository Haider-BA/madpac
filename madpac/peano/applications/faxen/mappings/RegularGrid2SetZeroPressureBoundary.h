...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2SetZeroPressureBoundary_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2SetZeroPressureBoundary_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2SetZeroPressureBoundary {
  private:
    /**
     * Logging device.
     */
