...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ComputeRightHandSide_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ComputeRightHandSide_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2ComputeRightHandSide {
  private:
    /**
     * Logging device.
     */
