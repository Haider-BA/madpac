...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ControlTimeStep_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ControlTimeStep_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2ControlTimeStep {
  private:
    /**
     * Logging device.
     */
