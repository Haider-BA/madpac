...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ExploreBoundaries_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ExploreBoundaries_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2ExploreBoundaries {
  private:
    /**
     * Logging device.
     */
