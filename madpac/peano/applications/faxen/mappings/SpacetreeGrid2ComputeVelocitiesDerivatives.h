...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ComputeVelocitiesDerivatives_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ComputeVelocitiesDerivatives_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2ComputeVelocitiesDerivatives {
  private:
    /**
     * Logging device.
     */
