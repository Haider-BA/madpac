...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ComputeVelocities_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ComputeVelocities_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2ComputeVelocities {
  private:
    /**
     * Logging device.
     */
