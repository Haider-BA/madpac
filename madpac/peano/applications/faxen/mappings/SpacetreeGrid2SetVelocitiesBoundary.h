...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2SetVelocitiesBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2SetVelocitiesBoundary_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2SetVelocitiesBoundary {
  private:
    /**
     * Logging device.
     */
