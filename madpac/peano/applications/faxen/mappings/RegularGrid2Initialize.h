...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2Initialize_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2Initialize_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2Initialize {
private:
	/**
	 * Logging device.
	 */
