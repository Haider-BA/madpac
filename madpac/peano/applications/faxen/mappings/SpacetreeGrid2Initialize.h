...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2Initialize_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2Initialize_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2Initialize {
  private:
    /**
     * Logging device.
     */
