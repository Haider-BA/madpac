...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2SORStep_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2SORStep_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2SORStep {
  private:
    /**
     * Logging device.
     */
