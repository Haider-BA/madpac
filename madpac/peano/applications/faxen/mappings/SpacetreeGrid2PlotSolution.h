...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2PlotSolution_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
