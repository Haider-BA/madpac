...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ComputeResidualNorm_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ComputeResidualNorm_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2ComputeResidualNorm {
  private:
    /**
     * Logging device.
     */
