...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_RegularGrid2SetScenarioBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_RegularGrid2SetScenarioBoundary_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2SetScenarioBoundary {
  private:
    /**
     * Logging device.
     */
