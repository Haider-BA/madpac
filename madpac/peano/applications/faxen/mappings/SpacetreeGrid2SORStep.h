...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2SORStep_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2SORStep_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2SORStep {
  private:
    /**
     * Logging device.
     */
