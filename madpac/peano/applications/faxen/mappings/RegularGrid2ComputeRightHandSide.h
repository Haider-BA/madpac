...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ComputeRightHandSide_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ComputeRightHandSide_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2ComputeRightHandSide {
  private:
    /**
     * Logging device.
     */
