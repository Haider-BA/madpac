...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2PlotSolution_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2PlotSolution {
private:
	/**
	 * Logging device.
	 */
