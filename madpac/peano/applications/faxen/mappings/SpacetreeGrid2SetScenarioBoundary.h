...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2SetScenarioBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2SetScenarioBoundary_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2SetScenarioBoundary {
  private:
    /**
     * Logging device.
     */
