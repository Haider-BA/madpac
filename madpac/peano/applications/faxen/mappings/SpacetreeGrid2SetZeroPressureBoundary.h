...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2SetZeroPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2SetZeroPressureBoundary_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2SetZeroPressureBoundary {
  private:
    /**
     * Logging device.
     */
