...
tarch::logging::Log peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::_log( "peano::applications::faxen::mappings::RegularGrid2ComputeVelocities" );


peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::RegularGrid2ComputeVelocities() {
...
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::createBoundaryVertex(
  const tarch::la::Vector<DIMENSIONS,double>&  x,
  const tarch::la::Vector<DIMENSIONS,double>&  h,
  peano::applications::faxen::RegularGridVertex&  vertex
) {
...
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::destroyVertex(
  const tarch::la::Vector<DIMENSIONS,double>&  x,
  const tarch::la::Vector<DIMENSIONS,double>&  h,
  peano::applications::faxen::RegularGridVertex&  vertex
) {
...
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::createCell(
...
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::destroyCell(
  peano::applications::faxen::RegularGridVertex const * const vertices,
  peano::applications::faxen::RegularGridCell&  cell,
  const peano::kernel::gridinterface::VertexEnumerator&  enumerator
) {
...
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::handleCell(
...
//  std::cout << "--- logging to check velocities ---\n";
//  std::cout << "cell u: " << cell.getU() << "\n";
//  std::cout << "cell v: " << cell.getV() << "\n";

  logTraceOut( "handleCell()" );
}

#ifdef Parallel
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::mergeWithNeighbour(
  peano::applications::faxen::RegularGridVertex& vertex,
...
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::touchVertexFirstTime(
  peano::applications::faxen::RegularGridVertex&  vertex,
  const tarch::la::Vector<DIMENSIONS,double>&  x
) {
...
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::touchVertexLastTime(
  peano::applications::faxen::RegularGridVertex&  vertex,
  const tarch::la::Vector<DIMENSIONS,double>&  x
) {
...
#ifdef Parallel
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::prepareSendToNeighbour(
  peano::applications::faxen::RegularGridVertex& vertex
) {
  // @todo Insert your code here
}
...
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::beginIteration(
...
void peano::applications::faxen::mappings::RegularGrid2ComputeVelocities::endIteration(
  peano::applications::faxen::RegularGridState&  solverState
) {
