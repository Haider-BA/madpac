...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2SetVelocitiesBoundary_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2SetVelocitiesBoundary_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2SetVelocitiesBoundary {
  private:
    /**
     * Logging device.
     */
