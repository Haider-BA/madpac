...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ControlTimeStep_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ControlTimeStep_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2ControlTimeStep {
  private:
    /**
     * Logging device.
     */
