...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ExploreBoundaries_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ExploreBoundaries_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2ExploreBoundaries {
  private:
    /**
     * Logging device.
     */
