...
#ifndef PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ComputeVelocitiesDerivatives_H_
#define PEANO_APPLICATIONS_faxen_MAPPINGS_RegularGrid2ComputeVelocitiesDerivatives_H_
 ...
 */
class peano::applications::faxen::mappings::RegularGrid2ComputeVelocitiesDerivatives {
  private:
    /**
     * Logging device.
     */
