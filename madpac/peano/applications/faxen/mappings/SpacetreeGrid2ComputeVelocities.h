...
#ifndef PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ComputeVelocities_H_
#define PEANO_APPLICATIONS_FAXEN_MAPPINGS_SpacetreeGrid2ComputeVelocities_H_
 ...
 */
class peano::applications::faxen::mappings::SpacetreeGrid2ComputeVelocities {
  private:
    /**
     * Logging device.
     */
