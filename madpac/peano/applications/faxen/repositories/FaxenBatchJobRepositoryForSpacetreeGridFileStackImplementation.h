...
#ifndef PEANO_APPLICATIONS_FAXEN_REPOSITORIES_FaxenBatchJobRepository_FOR_SPACETREE_GRID_FILE_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_FAXEN_REPOSITORIES_FaxenBatchJobRepository_FOR_SPACETREE_GRID_FILE_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace faxen {
      namespace repositories {
        class FaxenBatchJobRepositoryForSpacetreeGridFileStackImplementation;  
      }
}
}
}
...
class peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridFileStackImplementation: public peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellFileStack<peano::applications::faxen::SpacetreeGridCell>       CellStack;
    typedef peano::kernel::stacks::VertexFileStack<peano::applications::faxen::SpacetreeGridVertex>   VertexStack;
  ...
  public:
    FaxenBatchJobRepositoryForSpacetreeGridFileStackImplementation(
    ...
    virtual ~FaxenBatchJobRepositoryForSpacetreeGridFileStackImplementation();
