...
#ifndef PEANO_APPLICATIONS_FAXEN_REPOSITORIES_FaxenBatchJobRepository_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_FAXEN_REPOSITORIES_FaxenBatchJobRepository_FOR_REGULAR_GRID_H_
 ...
 */
template class peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::RegularGridVertex, peano::applications::faxen::RegularGridCell>;


class peano::applications::faxen::repositories::FaxenBatchJobRepositoryForRegularGrid: public peano::applications::faxen::repositories::FaxenBatchJobRepository {
  public:
    virtual peano::applications::faxen::RegularGridState& getState() = 0;
     ...
     */
    virtual void writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::RegularGridVertex, peano::applications::faxen::RegularGridCell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::RegularGridVertex, peano::applications::faxen::RegularGridCell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::RegularGridVertex, peano::applications::faxen::RegularGridCell>* createEmptyCheckpoint() = 0;
