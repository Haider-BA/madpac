...
#ifndef PEANO_APPLICATIONS_FAXEN_REPOSITORIES_FaxenBatchJobRepository_FOR_SPACETREE_GRID_H_
#define PEANO_APPLICATIONS_FAXEN_REPOSITORIES_FaxenBatchJobRepository_FOR_SPACETREE_GRID_H_


#include "peano/applications/faxen/repositories/FaxenBatchJobRepository.h"
 ...
 */
template class peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell>;


class peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGrid: public peano::applications::faxen::repositories::FaxenBatchJobRepository {
  public:
    virtual peano::applications::faxen::SpacetreeGridState& getState() = 0;
     ...
     */
    virtual void writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell>* createEmptyCheckpoint() = 0;
