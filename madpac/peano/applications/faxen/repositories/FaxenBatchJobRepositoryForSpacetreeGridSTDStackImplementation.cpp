...
tarch::logging::Log peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::_log( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation" );


peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation(...)" );
}
...
peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation(Geometry&)" );

  _repositoryState.setAction( FaxenBatchJobRepositoryState::Terminate );
  
  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(14);
  
  logTraceOut( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation(Geometry&)" );
}
...
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::restart(
...
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::terminate() {
...
peano::applications::faxen::SpacetreeGridState& peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::getState() {
  return _solverState;
}

    
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::iterate() {
  tarch::utils::Watch watch( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation", "iterate()", false);
 ...
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToInitialize() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterInitialize); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToInitializeAndSetBoundary() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterInitializeAndSetBoundary); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToPlotGrid() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterPlotGrid); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToControlTimeStep() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterControlTimeStep); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToSetVelocitiesBoundary() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterSetVelocitiesBoundary); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToSetScenarioBoundary() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterSetScenarioBoundary); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToComputeVelocitiesDerivatives() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterComputeVelocitiesDerivatives); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToComputeRightHandSide() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterComputeRightHandSide); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToSetZeroPressureBoundary() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterSetZeroPressureBoundary); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToSetPressureBoundary() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterSetPressureBoundary); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToSORStep() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterSORStep); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToComputeResidualNorm() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterComputeResidualNorm); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToComputeVelocities() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterComputeVelocities); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::switchToPlotSolution() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterPlotSolution); }



 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterInitialize() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterInitialize; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterInitializeAndSetBoundary() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterInitializeAndSetBoundary; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterPlotGrid() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterPlotGrid; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterControlTimeStep() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterControlTimeStep; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterSetVelocitiesBoundary() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterSetVelocitiesBoundary; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterSetScenarioBoundary() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterSetScenarioBoundary; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterComputeVelocitiesDerivatives() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterComputeVelocitiesDerivatives; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterComputeRightHandSide() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterComputeRightHandSide; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterSetZeroPressureBoundary() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterSetZeroPressureBoundary; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterSetPressureBoundary() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterSetPressureBoundary; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterSORStep() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterSORStep; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterComputeResidualNorm() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterComputeResidualNorm; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterComputeVelocities() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterComputeVelocities; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::isActiveAdapterPlotSolution() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterPlotSolution; }



#ifdef CCA
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
...
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::logIterationStatistics() const {
...
peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell>* peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::createEmptyCheckpoint() {
...
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell> * const checkpoint) {
...
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell> const * const checkpoint ) {
...
#ifdef Parallel
bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDStackImplementation::continueToIterate() {
