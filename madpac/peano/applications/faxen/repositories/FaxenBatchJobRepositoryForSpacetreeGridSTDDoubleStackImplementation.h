...
#ifndef PEANO_APPLICATIONS_FAXEN_REPOSITORIES_FaxenBatchJobRepository_FOR_SPACETREE_GRID_STD_DOUBLE_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_FAXEN_REPOSITORIES_FaxenBatchJobRepository_FOR_SPACETREE_GRID_STD_DOUBLE_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace faxen {
      namespace repositories {
        class FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation;  
      }
}
}
}
...
class peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation: public peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellSTDDoubleStack<peano::applications::faxen::SpacetreeGridCell>       CellStack;
    typedef peano::kernel::stacks::VertexSTDDoubleStack<peano::applications::faxen::SpacetreeGridVertex>   VertexStack;
  ...
  public:
    FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
    ...
    virtual ~FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation();
