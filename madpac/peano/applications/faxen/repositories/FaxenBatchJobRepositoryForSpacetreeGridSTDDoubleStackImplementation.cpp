...
tarch::logging::Log peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::_log( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation" );


peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(...)" );
}
...
peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(Geometry&)" );

  _repositoryState.setAction( FaxenBatchJobRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(14);
  
  logTraceOut( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(Geometry&)" );
}
...
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::restart(
...
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::terminate() {
...
peano::applications::faxen::SpacetreeGridState& peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::getState() {
  return _solverState;
}

    
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::iterate() {
  tarch::utils::Watch watch( "peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation", "iterate()", false);
 ...
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToInitialize() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterInitialize); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToInitializeAndSetBoundary() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterInitializeAndSetBoundary); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPlotGrid() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterPlotGrid); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToControlTimeStep() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterControlTimeStep); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetVelocitiesBoundary() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterSetVelocitiesBoundary); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetScenarioBoundary() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterSetScenarioBoundary); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToComputeVelocitiesDerivatives() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterComputeVelocitiesDerivatives); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToComputeRightHandSide() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterComputeRightHandSide); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetZeroPressureBoundary() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterSetZeroPressureBoundary); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetPressureBoundary() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterSetPressureBoundary); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSORStep() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterSORStep); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToComputeResidualNorm() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterComputeResidualNorm); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToComputeVelocities() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterComputeVelocities); }
 void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPlotSolution() { _repositoryState.setAction(FaxenBatchJobRepositoryState::UseAdapterPlotSolution); }



 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterInitialize() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterInitialize; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterInitializeAndSetBoundary() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterInitializeAndSetBoundary; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPlotGrid() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterPlotGrid; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterControlTimeStep() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterControlTimeStep; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetVelocitiesBoundary() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterSetVelocitiesBoundary; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetScenarioBoundary() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterSetScenarioBoundary; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterComputeVelocitiesDerivatives() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterComputeVelocitiesDerivatives; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterComputeRightHandSide() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterComputeRightHandSide; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetZeroPressureBoundary() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterSetZeroPressureBoundary; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetPressureBoundary() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterSetPressureBoundary; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSORStep() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterSORStep; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterComputeResidualNorm() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterComputeResidualNorm; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterComputeVelocities() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterComputeVelocities; }
 bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPlotSolution() const { return _repositoryState.getAction() == FaxenBatchJobRepositoryState::UseAdapterPlotSolution; }



#ifdef CCA
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
...
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::logIterationStatistics() const {
...
peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell>* peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::createEmptyCheckpoint() {
...
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell> * const checkpoint) {
...
void peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell> const * const checkpoint ) {
...
#ifdef Parallel
bool peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::continueToIterate() {
