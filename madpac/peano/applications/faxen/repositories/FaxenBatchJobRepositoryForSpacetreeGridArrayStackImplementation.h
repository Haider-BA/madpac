...
#ifndef PEANO_APPLICATIONS_FAXEN_REPOSITORIES_FaxenBatchJobRepository_FOR_SPACETREE_GRID_ARRAY_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_FAXEN_REPOSITORIES_FaxenBatchJobRepository_FOR_SPACETREE_GRID_ARRAY_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace faxen {
      namespace repositories {
        class FaxenBatchJobRepositoryForSpacetreeGridArrayStackImplementation;  
      }
}
}
}
...
class peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGridArrayStackImplementation: public peano::applications::faxen::repositories::FaxenBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellArrayStack<peano::applications::faxen::SpacetreeGridCell>       CellStack;
    typedef peano::kernel::stacks::VertexArrayStack<peano::applications::faxen::SpacetreeGridVertex>   VertexStack;
  ...
  public:
    FaxenBatchJobRepositoryForSpacetreeGridArrayStackImplementation(
    ...
    virtual ~FaxenBatchJobRepositoryForSpacetreeGridArrayStackImplementation();
