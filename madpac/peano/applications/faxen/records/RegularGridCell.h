#ifndef _PEANO_APPLICATIONS_FAXEN_RECORDS_REGULARGRIDCELL_H
#define _PEANO_APPLICATIONS_FAXEN_RECORDS_REGULARGRIDCELL_H
 ...
 */
class peano::applications::faxen::records::RegularGridCell { 
   
   public:
      
      typedef peano::applications::faxen::records::RegularGridCellPacked Packed;
   ...
   public:
       ...
       * Generated
       */
      RegularGridCell(const double& P, const double& U, const double& V, const double& F, const double& G, const double& rhs, const double& res, const bool& isInside);
    ...
    * @date   06/05/2011 22:32
    */
   class peano::applications::faxen::records::RegularGridCellPacked { 
      ...
      public:
          ...
          * Generated
          */
         RegularGridCellPacked(const double& P, const double& U, const double& V, const double& F, const double& G, const double& rhs, const double& res, const bool& isInside);
