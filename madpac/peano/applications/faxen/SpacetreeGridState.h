...
#ifndef _PEANO_APPLICATIONS_FAXEN_SpacetreeGridState_H_ 
#define _PEANO_APPLICATIONS_FAXEN_SpacetreeGridState_H_
...
class peano::applications::faxen::SpacetreeGridState: public peano::kernel::spacetreegrid::State< peano::applications::faxen::records::SpacetreeGridState > { 
  private: 
    typedef class peano::kernel::spacetreegrid::State< peano::applications::faxen::records::SpacetreeGridState >  Base;
  ...
  public:
    ...
    void writeToCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell>& checkpoint ) const;    
    void readFromCheckpoint( const peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::SpacetreeGridVertex, peano::applications::faxen::SpacetreeGridCell>& checkpoint );    
