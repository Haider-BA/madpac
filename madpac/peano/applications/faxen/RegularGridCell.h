...
#ifndef _PEANO_APPLICATIONS_faxen_RegularGridCell_H_
#define _PEANO_APPLICATIONS_faxen_RegularGridCell_H_
...
class peano::applications::faxen::RegularGridCell: public peano::kernel::regulargrid::Cell< peano::applications::faxen::records::RegularGridCell > {
private:
	typedef class peano::kernel::regulargrid::Cell< peano::applications::faxen::records::RegularGridCell >  Base;
