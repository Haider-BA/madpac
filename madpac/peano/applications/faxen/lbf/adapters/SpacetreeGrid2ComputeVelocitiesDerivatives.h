...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2ComputeVelocitiesDerivatives_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2ComputeVelocitiesDerivatives_H_
...
#include "peano/applications/faxen/lbf/SpacetreeGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/SpacetreeGrid2ComputeVelocitiesDerivatives.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2ComputeVelocitiesDerivatives;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2ComputeVelocitiesDerivatives {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2ComputeVelocitiesDerivatives _map2ComputeVelocitiesDerivatives;

  public:
    SpacetreeGrid2ComputeVelocitiesDerivatives();

    virtual ~SpacetreeGrid2ComputeVelocitiesDerivatives();
