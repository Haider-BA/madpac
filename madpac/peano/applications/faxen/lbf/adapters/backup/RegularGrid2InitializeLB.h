...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2InitializeLB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2InitializeLB_H_
...
#include "peano/applications/faxen/lbf/RegularGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/RegularGrid2InitializeLB.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class RegularGrid2InitializeLB;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2InitializeLB {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2InitializeLB _map2InitializeLB;

  public:
    RegularGrid2InitializeLB();

    virtual ~RegularGrid2InitializeLB();
