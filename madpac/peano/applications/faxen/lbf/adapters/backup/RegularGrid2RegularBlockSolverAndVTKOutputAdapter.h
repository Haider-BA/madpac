...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2RegularBlockSolverAndVTKOutputAdapter_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2RegularBlockSolverAndVTKOutputAdapter_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2RegularBlockSolverAndVTKOutputAdapter {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2BlockVTKOutput _map2BlockVTKOutput;
