...
int peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::_snapshotCounter = 0;


tarch::logging::Log peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::_log( "peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid" );


peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::SpacetreeGrid2PlotGrid():
  _vertex2IndexMap(),
  _vtkWriter(),
  _vertexWriter(0),
  _cellWriter(0),
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::plotVertex(
  ...
  if ( 
    fineGridVertex.getRefinementControl() != peano::applications::faxen::lbf::SpacetreeGridBlockVertex::Records::Refined &&
    fineGridVertex.getRefinementControl() != peano::applications::faxen::lbf::SpacetreeGridBlockVertex::Records::Refining &&
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::createInnerVertex(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::createBoundaryVertex(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::createHangingVertex(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::destroyHangingVertex(
      const peano::applications::faxen::lbf::SpacetreeGridBlockVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::destroyVertex(
      const peano::applications::faxen::lbf::SpacetreeGridBlockVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::createCell(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::destroyCell(
...
#ifdef Parallel
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::mergeWithNeighbour(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::touchVertexFirstTime(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::touchVertexLastTime(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::prepareSendToNeighbour(
  peano::applications::faxen::lbf::SpacetreeGridBlockVertex& vertex
) {
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::beginIteration(
  ...
  _vertexTypeWriter               = _vtkWriter.createVertexDataWriter(peano::applications::faxen::lbf::SpacetreeGridBlockVertex::Records::getInsideOutsideDomainMapping() ,1);
  _vertexRefinementControlWriter  = _vtkWriter.createVertexDataWriter(peano::applications::faxen::lbf::SpacetreeGridBlockVertex::Records::getRefinementControlMapping() ,1);
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::endIteration(
  peano::applications::faxen::lbf::SpacetreeGridBlockState&  solverState
) {
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::enterCell(
      peano::applications::faxen::lbf::SpacetreeGridBlockCell&                 fineGridCell,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotGrid::leaveCell(
      peano::applications::faxen::lbf::SpacetreeGridBlockCell&           fineGridCell,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex * const  fineGridVertices,
      const peano::kernel::gridinterface::VertexEnumerator&          fineGridVerticesEnumerator,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex * const  coarseGridVertices,
