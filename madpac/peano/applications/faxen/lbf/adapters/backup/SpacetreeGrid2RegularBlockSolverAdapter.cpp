...
peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::SpacetreeGrid2RegularBlockSolverAdapter() {
}
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::createHangingVertex(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::destroyHangingVertex(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::createInnerVertex(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::createBoundaryVertex(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::destroyVertex(
      const peano::applications::faxen::lbf::SpacetreeGridBlockVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::createCell(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::destroyCell(
...
#ifdef Parallel
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::mergeWithNeighbour(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::touchVertexFirstTime(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::touchVertexLastTime(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::prepareSendToNeighbour(
  peano::applications::faxen::lbf::SpacetreeGridBlockVertex& vertex
) {
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::beginIteration(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::endIteration(
  peano::applications::faxen::lbf::SpacetreeGridBlockState&  solverState
) {
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::enterCell(
      peano::applications::faxen::lbf::SpacetreeGridBlockCell&                 fineGridCell,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter::leaveCell(
      peano::applications::faxen::lbf::SpacetreeGridBlockCell&           fineGridCell,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex * const  fineGridVertices,
      const peano::kernel::gridinterface::VertexEnumerator&          fineGridVerticesEnumerator,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex * const  coarseGridVertices,
