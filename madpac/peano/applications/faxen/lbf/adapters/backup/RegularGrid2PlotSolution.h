...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2PlotSolution_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2PlotSolution {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution _map2PlotSolution;
