...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SwitchFromLB2NSE_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SwitchFromLB2NSE_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2SwitchFromLB2NSE {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2SwitchFromLB2NSE _map2SwitchFromLB2NSE;
