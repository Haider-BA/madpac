...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SORStep_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SORStep_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2SORStep {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2SORStep _map2SORStep;

  public:
    SpacetreeGrid2SORStep();

    virtual ~SpacetreeGrid2SORStep();
