...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2InitializeAndSetBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2InitializeAndSetBoundary_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2InitializeAndSetBoundary;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2InitializeAndSetBoundary {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2Initialize _map2Initialize;
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2ExploreBoundaries _map2ExploreBoundaries;

  public:
    SpacetreeGrid2InitializeAndSetBoundary();

    virtual ~SpacetreeGrid2InitializeAndSetBoundary();
