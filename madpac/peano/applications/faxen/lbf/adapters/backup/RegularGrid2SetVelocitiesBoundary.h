...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SetVelocitiesBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SetVelocitiesBoundary_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2SetVelocitiesBoundary {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2SetVelocitiesBoundary _map2SetVelocitiesBoundary;
