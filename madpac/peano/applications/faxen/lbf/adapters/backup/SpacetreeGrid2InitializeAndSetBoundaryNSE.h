...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2InitializeAndSetBoundaryNSE_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2InitializeAndSetBoundaryNSE_H_
...
#include "peano/applications/faxen/lbf/SpacetreeGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/SpacetreeGrid2InitializeNSE.h"
 #include "peano/applications/faxen/lbf/mappings/SpacetreeGrid2ExploreBoundaries.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2InitializeAndSetBoundaryNSE;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2InitializeAndSetBoundaryNSE {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2InitializeNSE _map2InitializeNSE;
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2ExploreBoundaries _map2ExploreBoundaries;

  public:
    SpacetreeGrid2InitializeAndSetBoundaryNSE();

    virtual ~SpacetreeGrid2InitializeAndSetBoundaryNSE();
