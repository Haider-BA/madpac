...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2RegularBlockSolverAdapter_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2RegularBlockSolverAdapter_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAdapter {
  private:
