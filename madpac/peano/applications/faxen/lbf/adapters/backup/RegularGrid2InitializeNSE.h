...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2InitializeNSE_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2InitializeNSE_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class RegularGrid2InitializeNSE;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2InitializeNSE {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2InitializeNSE _map2InitializeNSE;

  public:
    RegularGrid2InitializeNSE();

    virtual ~RegularGrid2InitializeNSE();
