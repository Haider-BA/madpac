...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2InitialiseSpacetreeGridAdapter_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2InitialiseSpacetreeGridAdapter_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2InitialiseSpacetreeGridAdapter {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2InitialiseSpacetreeGrid _map2InitialiseSpacetreeGrid;
