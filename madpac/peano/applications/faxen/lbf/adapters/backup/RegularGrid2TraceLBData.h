...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2TraceLBData_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2TraceLBData_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2TraceLBData {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2TraceLBData _map2TraceLBData;

  public:
    RegularGrid2TraceLBData();

    virtual ~RegularGrid2TraceLBData();
