...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SetZeroPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SetZeroPressureBoundary_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2SetZeroPressureBoundary;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2SetZeroPressureBoundary {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2SetZeroPressureBoundary _map2SetZeroPressureBoundary;

  public:
    SpacetreeGrid2SetZeroPressureBoundary();

    virtual ~SpacetreeGrid2SetZeroPressureBoundary();
