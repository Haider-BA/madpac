...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2InitializeAndSetBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2InitializeAndSetBoundary_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class RegularGrid2InitializeAndSetBoundary;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2InitializeAndSetBoundary {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2Initialize _map2Initialize;
    peano::applications::faxen::lbf::mappings::RegularGrid2ExploreBoundaries _map2ExploreBoundaries;

  public:
    RegularGrid2InitializeAndSetBoundary();

    virtual ~RegularGrid2InitializeAndSetBoundary();
