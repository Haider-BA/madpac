...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2InitializeLB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2InitializeLB_H_
...
#include "peano/applications/faxen/lbf/SpacetreeGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/SpacetreeGrid2InitializeLB.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2InitializeLB;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2InitializeLB {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2InitializeLB _map2InitializeLB;

  public:
    SpacetreeGrid2InitializeLB();

    virtual ~SpacetreeGrid2InitializeLB();
