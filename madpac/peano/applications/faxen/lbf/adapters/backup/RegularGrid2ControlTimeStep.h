...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2ControlTimeStep_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2ControlTimeStep_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class RegularGrid2ControlTimeStep;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2ControlTimeStep {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2ControlTimeStep _map2ControlTimeStep;

  public:
    RegularGrid2ControlTimeStep();

    virtual ~RegularGrid2ControlTimeStep();
