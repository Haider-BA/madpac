...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2MoveParticles_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2MoveParticles_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2MoveParticles {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2MoveParticles _map2MoveParticles;
