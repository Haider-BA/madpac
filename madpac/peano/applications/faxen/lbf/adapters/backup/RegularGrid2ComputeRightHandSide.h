...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2ComputeRightHandSide_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2ComputeRightHandSide_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2ComputeRightHandSide {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2ComputeRightHandSide _map2ComputeRightHandSide;
