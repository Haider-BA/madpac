...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2DynamicRefinementForSpacetreeGridAdapter_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2DynamicRefinementForSpacetreeGridAdapter_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2DynamicRefinementForSpacetreeGridAdapter {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2DynamicRefinementForSpacetreeGrid _map2DynamicRefinementForSpacetreeGrid;
