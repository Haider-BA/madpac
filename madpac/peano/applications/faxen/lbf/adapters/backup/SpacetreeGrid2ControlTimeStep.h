...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2ControlTimeStep_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2ControlTimeStep_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2ControlTimeStep;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2ControlTimeStep {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2ControlTimeStep _map2ControlTimeStep;

  public:
    SpacetreeGrid2ControlTimeStep();

    virtual ~SpacetreeGrid2ControlTimeStep();
