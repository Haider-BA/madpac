...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2RegularBlockSolverAndVTKOutputAdapter_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2RegularBlockSolverAndVTKOutputAdapter_H_
...
#include "peano/applications/faxen/lbf/SpacetreeGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/SpacetreeGrid2BlockVTKOutput.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2RegularBlockSolverAndVTKOutputAdapter;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2RegularBlockSolverAndVTKOutputAdapter {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2BlockVTKOutput _map2BlockVTKOutput;
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2RegularBlockSolver _map2RegularBlockSolver;
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2BlockCCAOutput _map2BlockCCAOutput;

  public:
    SpacetreeGrid2RegularBlockSolverAndVTKOutputAdapter();

    virtual ~SpacetreeGrid2RegularBlockSolverAndVTKOutputAdapter();
    ...
    #ifdef Parallel
    void prepareSendToNeighbour(peano::applications::faxen::lbf::SpacetreeGridBlockVertex& vertex);
    #endif
