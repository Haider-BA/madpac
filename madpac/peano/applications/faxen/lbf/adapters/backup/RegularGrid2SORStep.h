...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SORStep_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SORStep_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2SORStep {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2SORStep _map2SORStep;

  public:
    RegularGrid2SORStep();

    virtual ~RegularGrid2SORStep();
