...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2InitializeNSE_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2InitializeNSE_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2InitializeNSE;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2InitializeNSE {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2InitializeNSE _map2InitializeNSE;

  public:
    SpacetreeGrid2InitializeNSE();

    virtual ~SpacetreeGrid2InitializeNSE();
