...
peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::SpacetreeGrid2PlotSolution() {
}
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::createHangingVertex(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::destroyHangingVertex(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::createInnerVertex(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::createBoundaryVertex(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::destroyVertex(
      const peano::applications::faxen::lbf::SpacetreeGridBlockVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::createCell(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::destroyCell(
...
#ifdef Parallel
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::mergeWithNeighbour(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::touchVertexFirstTime(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex const * const  coarseGridVertices,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::touchVertexLastTime(
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::prepareSendToNeighbour(
  peano::applications::faxen::lbf::SpacetreeGridBlockVertex& vertex
) {
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::beginIteration(
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::endIteration(
  peano::applications::faxen::lbf::SpacetreeGridBlockState&  solverState
) {
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::enterCell(
      peano::applications::faxen::lbf::SpacetreeGridBlockCell&                 fineGridCell,
...
void peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution::leaveCell(
      peano::applications::faxen::lbf::SpacetreeGridBlockCell&           fineGridCell,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex * const  fineGridVertices,
      const peano::kernel::gridinterface::VertexEnumerator&          fineGridVerticesEnumerator,
      peano::applications::faxen::lbf::SpacetreeGridBlockVertex * const  coarseGridVertices,
