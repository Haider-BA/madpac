...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SwitchFromLB2NSE_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SwitchFromLB2NSE_H_
...
#include "peano/applications/faxen/lbf/SpacetreeGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/SpacetreeGrid2SwitchFromLB2NSE.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2SwitchFromLB2NSE;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2SwitchFromLB2NSE {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2SwitchFromLB2NSE _map2SwitchFromLB2NSE;

  public:
    SpacetreeGrid2SwitchFromLB2NSE();

    virtual ~SpacetreeGrid2SwitchFromLB2NSE();
