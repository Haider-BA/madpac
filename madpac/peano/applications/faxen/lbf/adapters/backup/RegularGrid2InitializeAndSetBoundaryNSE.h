...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2InitializeAndSetBoundaryNSE_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2InitializeAndSetBoundaryNSE_H_
...
#include "peano/applications/faxen/lbf/RegularGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/RegularGrid2InitializeNSE.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class RegularGrid2InitializeAndSetBoundaryNSE;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2InitializeAndSetBoundaryNSE {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2InitializeNSE _map2InitializeNSE;
    peano::applications::faxen::lbf::mappings::RegularGrid2ExploreBoundaries _map2ExploreBoundaries;

  public:
    RegularGrid2InitializeAndSetBoundaryNSE();

    virtual ~RegularGrid2InitializeAndSetBoundaryNSE();
