...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SetPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SetPressureBoundary_H_
...
#include "peano/applications/faxen/lbf/SpacetreeGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/SpacetreeGrid2SetPressureBoundary.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2SetPressureBoundary;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2SetPressureBoundary {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2SetPressureBoundary _map2SetPressureBoundary;

  public:
    SpacetreeGrid2SetPressureBoundary();

    virtual ~SpacetreeGrid2SetPressureBoundary();
