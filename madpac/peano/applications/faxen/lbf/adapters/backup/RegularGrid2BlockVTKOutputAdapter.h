...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2BlockVTKOutputAdapter_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2BlockVTKOutputAdapter_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2BlockVTKOutputAdapter {
  private:
