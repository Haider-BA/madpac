...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2PlotSolution_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2PlotSolution {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2PlotSolution _map2PlotSolution;
