...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2ComputeRightHandSide_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2ComputeRightHandSide_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2ComputeRightHandSide;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2ComputeRightHandSide {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2ComputeRightHandSide _map2ComputeRightHandSide;

  public:
    SpacetreeGrid2ComputeRightHandSide();

    virtual ~SpacetreeGrid2ComputeRightHandSide();
