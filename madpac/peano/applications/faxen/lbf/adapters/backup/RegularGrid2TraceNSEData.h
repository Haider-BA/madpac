...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2TraceNSEData_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2TraceNSEData_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2TraceNSEData {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2TraceNSEData _map2TraceNSEData;
