...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2ComputeVelocities_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2ComputeVelocities_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2ComputeVelocities;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2ComputeVelocities {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2ComputeVelocities _map2ComputeVelocities;

  public:
    SpacetreeGrid2ComputeVelocities();

    virtual ~SpacetreeGrid2ComputeVelocities();
