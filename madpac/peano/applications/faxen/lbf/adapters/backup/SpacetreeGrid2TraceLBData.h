...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2TraceLBData_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2TraceLBData_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2TraceLBData;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2TraceLBData {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2TraceLBData _map2TraceLBData;

  public:
    SpacetreeGrid2TraceLBData();

    virtual ~SpacetreeGrid2TraceLBData();
