...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SetZeroPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SetZeroPressureBoundary_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class RegularGrid2SetZeroPressureBoundary;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2SetZeroPressureBoundary {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2SetZeroPressureBoundary _map2SetZeroPressureBoundary;

  public:
    RegularGrid2SetZeroPressureBoundary();

    virtual ~RegularGrid2SetZeroPressureBoundary();
