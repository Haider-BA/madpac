...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2InitialiseSpacetreeGridAdapter_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2InitialiseSpacetreeGridAdapter_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2InitialiseSpacetreeGridAdapter;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2InitialiseSpacetreeGridAdapter {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2InitialiseSpacetreeGrid _map2InitialiseSpacetreeGrid;

  public:
    SpacetreeGrid2InitialiseSpacetreeGridAdapter();

    virtual ~SpacetreeGrid2InitialiseSpacetreeGridAdapter();
