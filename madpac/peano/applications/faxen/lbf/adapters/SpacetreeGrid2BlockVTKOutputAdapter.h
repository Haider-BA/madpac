...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2BlockVTKOutputAdapter_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2BlockVTKOutputAdapter_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2BlockVTKOutputAdapter;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2BlockVTKOutputAdapter {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2BlockVTKOutput _map2BlockVTKOutput;

  public:
    SpacetreeGrid2BlockVTKOutputAdapter();

    virtual ~SpacetreeGrid2BlockVTKOutputAdapter();
