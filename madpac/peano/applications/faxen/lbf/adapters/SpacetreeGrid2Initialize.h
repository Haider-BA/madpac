...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2Initialize_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2Initialize_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2Initialize;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2Initialize {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2Initialize _map2Initialize;

  public:
    SpacetreeGrid2Initialize();

    virtual ~SpacetreeGrid2Initialize();
