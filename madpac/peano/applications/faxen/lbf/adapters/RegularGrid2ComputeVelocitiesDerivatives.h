...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2ComputeVelocitiesDerivatives_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2ComputeVelocitiesDerivatives_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2ComputeVelocitiesDerivatives {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2ComputeVelocitiesDerivatives _map2ComputeVelocitiesDerivatives;
