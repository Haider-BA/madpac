...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2ExtractDataNSE2LB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2ExtractDataNSE2LB_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2ExtractDataNSE2LB;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2ExtractDataNSE2LB {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2ExtractDataNSE2LB _map2ExtractDataNSE2LB;

  public:
    SpacetreeGrid2ExtractDataNSE2LB();

    virtual ~SpacetreeGrid2ExtractDataNSE2LB();
