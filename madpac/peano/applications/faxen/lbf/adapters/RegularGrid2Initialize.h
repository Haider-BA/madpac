...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2Initialize_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2Initialize_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2Initialize {
  private:
