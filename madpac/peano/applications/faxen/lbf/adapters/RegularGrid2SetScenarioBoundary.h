...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SetScenarioBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SetScenarioBoundary_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2SetScenarioBoundary {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2SetScenarioBoundary _map2SetScenarioBoundary;
