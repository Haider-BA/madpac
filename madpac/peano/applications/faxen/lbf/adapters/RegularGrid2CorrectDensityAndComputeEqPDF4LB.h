...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2CorrectDensityAndComputeEqPDF4LB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2CorrectDensityAndComputeEqPDF4LB_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class RegularGrid2CorrectDensityAndComputeEqPDF4LB;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2CorrectDensityAndComputeEqPDF4LB {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2CorrectDensity4LB _map2CorrectDensity4LB;
    peano::applications::faxen::lbf::mappings::RegularGrid2ComputeEqPDF4LB _map2ComputeEqPDF4LB;

  public:
    RegularGrid2CorrectDensityAndComputeEqPDF4LB();

    virtual ~RegularGrid2CorrectDensityAndComputeEqPDF4LB();
