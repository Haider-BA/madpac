...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2BlockCCAOutputAdapter_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2BlockCCAOutputAdapter_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2BlockCCAOutputAdapter;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2BlockCCAOutputAdapter {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2BlockCCAOutput _map2BlockCCAOutput;

  public:
    SpacetreeGrid2BlockCCAOutputAdapter();

    virtual ~SpacetreeGrid2BlockCCAOutputAdapter();
