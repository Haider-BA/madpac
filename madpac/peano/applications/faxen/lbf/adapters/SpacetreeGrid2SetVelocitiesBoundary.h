...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SetVelocitiesBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SetVelocitiesBoundary_H_
...
#include "peano/applications/faxen/lbf/SpacetreeGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/SpacetreeGrid2SetVelocitiesBoundary.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2SetVelocitiesBoundary;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2SetVelocitiesBoundary {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2SetVelocitiesBoundary _map2SetVelocitiesBoundary;

  public:
    SpacetreeGrid2SetVelocitiesBoundary();

    virtual ~SpacetreeGrid2SetVelocitiesBoundary();
