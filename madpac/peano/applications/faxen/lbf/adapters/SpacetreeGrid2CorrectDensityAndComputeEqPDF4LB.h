...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2CorrectDensityAndComputeEqPDF4LB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2CorrectDensityAndComputeEqPDF4LB_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2CorrectDensityAndComputeEqPDF4LB;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2CorrectDensityAndComputeEqPDF4LB {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2CorrectDensity4LB _map2CorrectDensity4LB;
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2ComputeEqPDF4LB _map2ComputeEqPDF4LB;

  public:
    SpacetreeGrid2CorrectDensityAndComputeEqPDF4LB();

    virtual ~SpacetreeGrid2CorrectDensityAndComputeEqPDF4LB();
