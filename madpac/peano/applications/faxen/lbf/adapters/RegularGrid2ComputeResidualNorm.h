...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2ComputeResidualNorm_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2ComputeResidualNorm_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2ComputeResidualNorm {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2ComputeResidualNorm _map2ComputeResidualNorm;
