...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SetPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2SetPressureBoundary_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2SetPressureBoundary {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2SetPressureBoundary _map2SetPressureBoundary;
