...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2MoveParticles_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2MoveParticles_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2MoveParticles;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2MoveParticles {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2MoveParticles _map2MoveParticles;

  public:
    SpacetreeGrid2MoveParticles();

    virtual ~SpacetreeGrid2MoveParticles();
