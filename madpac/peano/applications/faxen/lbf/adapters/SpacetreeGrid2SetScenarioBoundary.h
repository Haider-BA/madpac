...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SetScenarioBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SetScenarioBoundary_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2SetScenarioBoundary;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2SetScenarioBoundary {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2SetScenarioBoundary _map2SetScenarioBoundary;

  public:
    SpacetreeGrid2SetScenarioBoundary();

    virtual ~SpacetreeGrid2SetScenarioBoundary();
