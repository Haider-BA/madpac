...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2RegularBlockSolverAdapter_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2RegularBlockSolverAdapter_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class RegularGrid2RegularBlockSolverAdapter;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2RegularBlockSolverAdapter {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2RegularBlockSolver _map2RegularBlockSolver;

  public:
    RegularGrid2RegularBlockSolverAdapter();

    virtual ~RegularGrid2RegularBlockSolverAdapter();
