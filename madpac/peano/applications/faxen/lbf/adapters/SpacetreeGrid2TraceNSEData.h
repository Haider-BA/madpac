...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2TraceNSEData_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2TraceNSEData_H_
...
#include "peano/applications/faxen/lbf/SpacetreeGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/SpacetreeGrid2TraceNSEData.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2TraceNSEData;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2TraceNSEData {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2TraceNSEData _map2TraceNSEData;

  public:
    SpacetreeGrid2TraceNSEData();

    virtual ~SpacetreeGrid2TraceNSEData();
