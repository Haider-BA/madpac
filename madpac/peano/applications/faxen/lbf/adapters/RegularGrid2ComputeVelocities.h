...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2ComputeVelocities_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_RegularGrid2ComputeVelocities_H_
 ...
 */
class peano::applications::faxen::lbf::adapters::RegularGrid2ComputeVelocities {
  private:
    peano::applications::faxen::lbf::mappings::RegularGrid2ComputeVelocities _map2ComputeVelocities;
