...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SwitchFromNSE2LB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_ADAPTERS_SpacetreeGrid2SwitchFromNSE2LB_H_
...
#include "peano/applications/faxen/lbf/SpacetreeGridBlockState.h"
 ...
 #include "peano/applications/faxen/lbf/mappings/SpacetreeGrid2SwitchFromNSE2LB.h"
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace adapters {
        class SpacetreeGrid2SwitchFromNSE2LB;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::adapters::SpacetreeGrid2SwitchFromNSE2LB {
  private:
    peano::applications::faxen::lbf::mappings::SpacetreeGrid2SwitchFromNSE2LB _map2SwitchFromNSE2LB;

  public:
    SpacetreeGrid2SwitchFromNSE2LB();

    virtual ~SpacetreeGrid2SwitchFromNSE2LB();
