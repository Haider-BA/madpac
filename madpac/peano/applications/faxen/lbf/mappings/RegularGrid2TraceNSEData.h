...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2TraceNSEData_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2TraceNSEData_H_
...
namespace lbf {
namespace mappings {
class RegularGrid2TraceNSEData;
}
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2TraceNSEData {
private:
	/**
	 * Logging device.
	 */
...
public:
	 ...
	 * modification.
	 */
	RegularGrid2TraceNSEData();

	/**
	 * Destructor. Typically does not implement any operation.
	 */
	virtual ~RegularGrid2TraceNSEData();
