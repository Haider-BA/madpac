...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SetZeroPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SetZeroPressureBoundary_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2SetZeroPressureBoundary {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2SetZeroPressureBoundary()
     */
    void beginIteration(
