...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2CorrectDensity4LB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2CorrectDensity4LB_H_
...
namespace lbf {
namespace mappings {
class RegularGrid2CorrectDensity4LB;
}
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2CorrectDensity4LB {
private:

	/**
	 * average extracted density
	 */
	double _avrDensity;
	...
	/**
	 * Correct density in each inner LB cell after data extration from NSE
	 */
	void correctDensity4LBCell(
...
public:
	 ...
	 * modification.
	 */
	RegularGrid2CorrectDensity4LB();

	/**
	 * Destructor. Typically does not implement any operation.
	 */
	virtual ~RegularGrid2CorrectDensity4LB();
 ...
 \endcode
	 ...
	 *
	 * @see RegularGrid2CorrectDensity4LB()
	 */
	void beginIteration(
