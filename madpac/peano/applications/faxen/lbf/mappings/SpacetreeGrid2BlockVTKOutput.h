...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2BlockVTKOutput_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2BlockVTKOutput_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2BlockVTKOutput {
  private:
    /**
     * Logging device.
     */
