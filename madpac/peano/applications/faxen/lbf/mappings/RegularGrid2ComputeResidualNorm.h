...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2ComputeResidualNorm_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2ComputeResidualNorm_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2ComputeResidualNorm {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see RegularGrid2ComputeResidualNorm()
     */
    void beginIteration(
