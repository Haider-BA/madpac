...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ComputeVelocities_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ComputeVelocities_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2ComputeVelocities {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ComputeVelocities()
     */
    void beginIteration(
