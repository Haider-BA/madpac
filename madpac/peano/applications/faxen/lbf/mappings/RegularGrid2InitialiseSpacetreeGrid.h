...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2InitialiseSpacetreeGrid_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2InitialiseSpacetreeGrid_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2InitialiseSpacetreeGrid {
  private:
    /**
     * Logging device.
     */
