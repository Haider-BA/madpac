...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SORStep_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SORStep_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2SORStep {
  private:
    /**
     * Logging device.
     */
