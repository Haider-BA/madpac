...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SetPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SetPressureBoundary_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2SetPressureBoundary {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2SetPressureBoundary()
     */
    void beginIteration(
