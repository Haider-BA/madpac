...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2ComputeRightHandSide_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2ComputeRightHandSide_H_
...
namespace lbf {
namespace mappings {
class RegularGrid2ComputeRightHandSide;
}
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2ComputeRightHandSide {
private:
	/**
	 * Logging device.
	 */
...
public:
	 ...
	 * modification.
	 */
	RegularGrid2ComputeRightHandSide();

	/**
	 * Destructor. Typically does not implement any operation.
	 */
	virtual ~RegularGrid2ComputeRightHandSide();
 ...
 \endcode
	 ...
	 *
	 * @see RegularGrid2ComputeRightHandSide()
	 */
	void beginIteration(
