...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2SetVelocitiesBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2SetVelocitiesBoundary_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2SetVelocitiesBoundary {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see RegularGrid2SetVelocitiesBoundary()
     */
    void beginIteration(
