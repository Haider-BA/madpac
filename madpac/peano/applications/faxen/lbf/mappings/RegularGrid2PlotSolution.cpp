#include "peano/applications/faxen/lbf/mappings/RegularGrid2PlotSolution.h"
#include <sstream>
#include "peano/utils/Loop.h"

tarch::logging::Log peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::_log( "peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution" );


peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::RegularGrid2PlotSolution():
																												  _vertex2IndexMap(),
																												  _vtkWriter(),
																												  _vertexWriter(0),
																												  _cellWriter(0),
...
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::createInnerVertex(
...
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::createBoundaryVertex(
		const tarch::la::Vector<DIMENSIONS,double>&  x,
		const tarch::la::Vector<DIMENSIONS,double>&  h,
		peano::applications::faxen::lbf::RegularGridBlockVertex&  vertex
) {
...
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::destroyVertex(
		const tarch::la::Vector<DIMENSIONS,double>&  x,
		const tarch::la::Vector<DIMENSIONS,double>&  h,
		peano::applications::faxen::lbf::RegularGridBlockVertex&  vertex
) {
...
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::createCell(
...
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::destroyCell(
		peano::applications::faxen::lbf::RegularGridBlockVertex const * const vertices,
		peano::applications::faxen::lbf::RegularGridBlockCell&  cell,
		const peano::kernel::gridinterface::VertexEnumerator&  enumerator
) {
...
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::handleCell(
...
#ifdef Parallel
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::mergeWithNeighbour(
		peano::applications::faxen::lbf::RegularGridBlockVertex& vertex,
...
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::touchVertexFirstTime(
		peano::applications::faxen::lbf::RegularGridBlockVertex&  vertex,
		const tarch::la::Vector<DIMENSIONS,double>&  x
) {
...
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::touchVertexLastTime(
		peano::applications::faxen::lbf::RegularGridBlockVertex&  vertex,
		const tarch::la::Vector<DIMENSIONS,double>&  x
) {
...
#ifdef Parallel
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::prepareSendToNeighbour(
		peano::applications::faxen::lbf::RegularGridBlockVertex& vertex
) {
	// @todo Insert your code here
}
...
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::beginIteration(
...
void peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution::endIteration(
		peano::applications::faxen::lbf::RegularGridBlockState&  solverState
) {
