...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SetScenarioBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SetScenarioBoundary_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2SetScenarioBoundary {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2SetScenarioBoundary()
     */
    void beginIteration(
