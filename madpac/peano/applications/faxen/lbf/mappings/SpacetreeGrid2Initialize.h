...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2Initialize_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2Initialize_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2Initialize {
  private:
    /**
     * Logging device.
     */
