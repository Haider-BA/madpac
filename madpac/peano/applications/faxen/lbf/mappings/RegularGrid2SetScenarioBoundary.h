...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2SetScenarioBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2SetScenarioBoundary_H_
...
namespace lbf {
namespace mappings {
class RegularGrid2SetScenarioBoundary;
}
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2SetScenarioBoundary {
private:
	/**
	 * Logging device.
	 */
	...
	/**
	 * Mesh sizes in horizontal and vertical directions
	 */
	tarch::la::Vector<DIMENSIONS, double> _meshSize;
...
public:
	 ...
	 * modification.
	 */
	RegularGrid2SetScenarioBoundary();

	/**
	 * Destructor. Typically does not implement any operation.
	 */
	virtual ~RegularGrid2SetScenarioBoundary();
 ...
 \endcode
	 ...
	 *
	 * @see RegularGrid2SetScenarioBoundary()
	 */
	void beginIteration(
