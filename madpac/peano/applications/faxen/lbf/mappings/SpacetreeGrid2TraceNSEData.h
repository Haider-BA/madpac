...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2TraceNSEData_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2TraceNSEData_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2TraceNSEData {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2TraceNSEData()
     */
    void beginIteration(
