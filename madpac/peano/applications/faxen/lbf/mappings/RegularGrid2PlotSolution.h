...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2PlotSolution_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2PlotSolution {
private:
	/**
	 * Logging device.
	 */
	...
	tarch::plotter::griddata::Writer::CellDataWriter*                               _cellPressureWriter;
	tarch::plotter::griddata::Writer::CellDataWriter*                               _cellRhsWriter;
	tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexFlagWriter;
	tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexPressureWriter;
	tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexUSpeedWriter;
	tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexVSpeedWriter;
	tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexVelocityWriter;
