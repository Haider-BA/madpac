...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2SwitchFromLB2NSE_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2SwitchFromLB2NSE_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace mappings {
        class RegularGrid2SwitchFromLB2NSE;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2SwitchFromLB2NSE {
  private:
	/**
	 * coefficient for transforming data from LB to NSE
	 * _dx/d_t
	 */
	double _dxbydt;
	 ...
	 */
	tarch::la::Vector<TWO_POWER_D,double> _p;
	tarch::la::Vector<TWO_POWER_D,double> _u;
	tarch::la::Vector<TWO_POWER_D,double> _v;
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2SwitchFromLB2NSE();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2SwitchFromLB2NSE();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2SwitchFromLB2NSE()
     */
    void beginIteration(
