...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2PlotSolution_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
