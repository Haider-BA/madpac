...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ComputeResidualNorm_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ComputeResidualNorm_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2ComputeResidualNorm {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ComputeResidualNorm()
     */
    void beginIteration(
