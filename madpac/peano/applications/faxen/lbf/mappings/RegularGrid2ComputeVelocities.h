...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2ComputeVelocities_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2ComputeVelocities_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2ComputeVelocities {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see RegularGrid2ComputeVelocities()
     */
    void beginIteration(
