...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2ExploreBoundaries_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2ExploreBoundaries_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace mappings {
        class RegularGrid2ExploreBoundaries;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2ExploreBoundaries {
  private:
    /**
     * Logging device.
     */
	...
	/**
	 * flag for setting fixed pressure node
	 */
	bool _isPressureNodeSet;
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2ExploreBoundaries();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2ExploreBoundaries();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2ExploreBoundaries()
     */
    void beginIteration(
