...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2RegularBlockSolver_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2RegularBlockSolver_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2RegularBlockSolver {
  private:
    /**
     * Logging device.
     */
