...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2BlockCCAOutput_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2BlockCCAOutput_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2BlockCCAOutput {
  private:
    /**
     * Logging device.
     */
