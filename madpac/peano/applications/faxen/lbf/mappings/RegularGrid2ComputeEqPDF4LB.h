...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2ComputeEqPDF4LB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2ComputeEqPDF4LB_H_
...
namespace lbf {
namespace mappings {
class RegularGrid2ComputeEqPDF4LB;
}
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2ComputeEqPDF4LB {
private:
	/**
	 * Logging device.
	 */
	...
	/**
	 * Compute equilibrium pdf after injection of velocities and densities from NSE
	 */
	void computeEqPDF4LBCell(
...
public:
	 ...
	 * modification.
	 */
	RegularGrid2ComputeEqPDF4LB();

	/**
	 * Destructor. Typically does not implement any operation.
	 */
	virtual ~RegularGrid2ComputeEqPDF4LB();
 ...
 \endcode
	 ...
	 *
	 * @see RegularGrid2ComputeEqPDF4LB()
	 */
	void beginIteration(
