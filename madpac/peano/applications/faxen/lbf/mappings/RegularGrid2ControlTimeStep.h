...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2ControlTimeStep_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2ControlTimeStep_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2ControlTimeStep {
private:
	/**
	 * Logging device.
	 */
...
public:
 ...
 \endcode
	 ...
	 *
	 * @see RegularGrid2ControlTimeStep()
	 */
	void beginIteration(
