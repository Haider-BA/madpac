...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2SwitchFromNSE2LB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2SwitchFromNSE2LB_H_
...
namespace lbf {
namespace mappings {
class RegularGrid2SwitchFromNSE2LB;
}
}
}
}
 ...
 *
 * @author Peano Prototyping Tool
 * @version $Revision: 1.10 $
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2SwitchFromNSE2LB {
private:
	/**
	 *  LB cell edge size
	 */
	...
	/**
	 * coefficient for transforming data from NSE to LB
	 * dt/dx
	 */
	double _dtbydx;
	...
	/**
	 * array with cell vertices (for interpolation)
	 */
	peano::applications::faxen::lbf::RegularGridBlockVertex** _cellVertices;
	...
	/**
	 * Inject velocities and pressures from NSE grid to LB cells
	 */
	void inject2LBCell(
...
public:
	 ...
	 * modification.
	 */
	RegularGrid2SwitchFromNSE2LB();

	/**
	 * Destructor. Typically does not implement any operation.
	 */
	virtual ~RegularGrid2SwitchFromNSE2LB();
 ...
 \endcode
	 ...
	 *
	 * @see RegularGrid2SwitchFromNSE2LB()
	 */
	void beginIteration(
