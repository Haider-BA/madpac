...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2RegularBlockSolver_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2RegularBlockSolver_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2RegularBlockSolver {
private:
	/**
	 * Logging device.
	 */
