...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2BlockVTKOutput_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2BlockVTKOutput_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2BlockVTKOutput {
  private:
    /**
     * Logging device.
     */
