...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2DynamicRefinementForSpacetreeGrid_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2DynamicRefinementForSpacetreeGrid_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2DynamicRefinementForSpacetreeGrid {
  private:
    /**
     * Logging device.
     */
