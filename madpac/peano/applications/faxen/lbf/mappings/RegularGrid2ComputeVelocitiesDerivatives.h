...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2ComputeVelocitiesDerivatives_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2ComputeVelocitiesDerivatives_H_
...
namespace lbf {
namespace mappings {
class RegularGrid2ComputeVelocitiesDerivatives;
}
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2ComputeVelocitiesDerivatives {
private:
	/**
	 * Logging device.
	 */
	...
	/**
	 * Gravity factors in horizontal and vertical directions
	 */
	double _gx, _gy;
...
public:
	 ...
	 * modification.
	 */
	RegularGrid2ComputeVelocitiesDerivatives();

	/**
	 * Destructor. Typically does not implement any operation.
	 */
	virtual ~RegularGrid2ComputeVelocitiesDerivatives();
 ...
 \endcode
	 ...
	 *
	 * @see RegularGrid2ComputeVelocitiesDerivatives()
	 */
	void beginIteration(
