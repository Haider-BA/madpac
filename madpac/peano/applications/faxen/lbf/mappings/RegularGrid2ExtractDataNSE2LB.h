...
namespace lbf {
namespace mappings {
class RegularGrid2ExtractDataNSE2LB;
}
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2ExtractDataNSE2LB {
private:
	/**
	 *  LB cell edge size
	 */
...
public:
	 ...
	 * modification.
	 */
	RegularGrid2ExtractDataNSE2LB();

	/**
	 * Destructor. Typically does not implement any operation.
	 */
	virtual ~RegularGrid2ExtractDataNSE2LB();
 ...
 \endcode
	 ...
	 *
	 * @see RegularGrid2ExtractDataNSE2LB()
	 */
	void beginIteration(
