...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2SetPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2SetPressureBoundary_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2SetPressureBoundary {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see RegularGrid2SetPressureBoundary()
     */
    void beginIteration(
