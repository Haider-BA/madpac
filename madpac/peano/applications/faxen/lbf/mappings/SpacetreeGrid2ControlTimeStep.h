...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ControlTimeStep_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ControlTimeStep_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2ControlTimeStep {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ControlTimeStep()
     */
    void beginIteration(
