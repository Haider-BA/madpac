...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ComputeEqPDF4LB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ComputeEqPDF4LB_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace mappings {
        class SpacetreeGrid2ComputeEqPDF4LB;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2ComputeEqPDF4LB {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2ComputeEqPDF4LB();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2ComputeEqPDF4LB();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ComputeEqPDF4LB()
     */
    void beginIteration(
