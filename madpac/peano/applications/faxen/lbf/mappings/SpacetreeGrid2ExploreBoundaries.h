...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ExploreBoundaries_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ExploreBoundaries_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace mappings {
        class SpacetreeGrid2ExploreBoundaries;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2ExploreBoundaries {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2ExploreBoundaries();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2ExploreBoundaries();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ExploreBoundaries()
     */
    void beginIteration(
