...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2InitialiseSpacetreeGrid_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2InitialiseSpacetreeGrid_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace mappings {
        class SpacetreeGrid2InitialiseSpacetreeGrid;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2InitialiseSpacetreeGrid {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2InitialiseSpacetreeGrid();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2InitialiseSpacetreeGrid();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2InitialiseSpacetreeGrid()
     */
    void beginIteration(
