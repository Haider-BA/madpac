...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2MoveParticles_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2MoveParticles_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2MoveParticles {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2MoveParticles()
     */
    void beginIteration(
