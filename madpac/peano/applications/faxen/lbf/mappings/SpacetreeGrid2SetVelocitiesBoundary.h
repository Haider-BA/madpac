...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SetVelocitiesBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SetVelocitiesBoundary_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2SetVelocitiesBoundary {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2SetVelocitiesBoundary()
     */
    void beginIteration(
