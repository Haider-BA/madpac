...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2BlockCCAOutput_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2BlockCCAOutput_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace mappings {
        class SpacetreeGrid2BlockCCAOutput;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2BlockCCAOutput {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2BlockCCAOutput();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2BlockCCAOutput();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2BlockCCAOutput()
     */
    void beginIteration(
