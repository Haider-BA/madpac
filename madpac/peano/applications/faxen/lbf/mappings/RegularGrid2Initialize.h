...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2Initialize_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2Initialize_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2Initialize {
private:
	/**
	 * Logging device.
	 */
	...
	/**
	 *  Initial values for pressure and velocities
	 */
	double _PI;
	double _UI;
	double _VI;
