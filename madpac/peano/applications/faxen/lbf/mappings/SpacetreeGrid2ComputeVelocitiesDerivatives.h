...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ComputeVelocitiesDerivatives_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2ComputeVelocitiesDerivatives_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2ComputeVelocitiesDerivatives {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ComputeVelocitiesDerivatives()
     */
    void beginIteration(
