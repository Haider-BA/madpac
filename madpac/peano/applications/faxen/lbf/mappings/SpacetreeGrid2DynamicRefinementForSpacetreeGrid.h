...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2DynamicRefinementForSpacetreeGrid_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2DynamicRefinementForSpacetreeGrid_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2DynamicRefinementForSpacetreeGrid {
  private:
    /**
     * Logging device.
     */
