...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2CorrectDensity4LB_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2CorrectDensity4LB_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace mappings {
        class SpacetreeGrid2CorrectDensity4LB;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2CorrectDensity4LB {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2CorrectDensity4LB();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2CorrectDensity4LB();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2CorrectDensity4LB()
     */
    void beginIteration(
