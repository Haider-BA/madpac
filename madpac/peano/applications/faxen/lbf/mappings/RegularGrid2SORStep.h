...
#ifndef PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2SORStep_H_
#define PEANO_APPLICATIONS_FAXEN_LBANDFAXEN_MAPPINGS_RegularGrid2SORStep_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2SORStep {
  private:
    /**
     * Logging device.
     */
