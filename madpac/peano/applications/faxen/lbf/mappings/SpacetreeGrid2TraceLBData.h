...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2TraceLBData_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2TraceLBData_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2TraceLBData {
  private:
    /**
     * Logging device.
     */
