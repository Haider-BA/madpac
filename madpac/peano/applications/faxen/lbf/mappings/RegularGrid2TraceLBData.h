...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2TraceLBData_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2TraceLBData_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2TraceLBData {
  private:
    /**
     * Logging device.
     */
