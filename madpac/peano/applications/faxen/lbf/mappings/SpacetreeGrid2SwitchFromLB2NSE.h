...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SwitchFromLB2NSE_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_SpacetreeGrid2SwitchFromLB2NSE_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::SpacetreeGrid2SwitchFromLB2NSE {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2SwitchFromLB2NSE()
     */
    void beginIteration(
