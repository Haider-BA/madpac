...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2SetZeroPressureBoundary_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2SetZeroPressureBoundary_H_
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2SetZeroPressureBoundary {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see RegularGrid2SetZeroPressureBoundary()
     */
    void beginIteration(
