...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2MoveParticles_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_MAPPINGS_RegularGrid2MoveParticles_H_
...
namespace peano { 
  namespace applications { 
    namespace faxen { 
      namespace lbf {
      namespace mappings {
        class RegularGrid2MoveParticles;
      } 
}
}
}
 ...
 */
class peano::applications::faxen::lbf::mappings::RegularGrid2MoveParticles {
  private:
	/**
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2MoveParticles();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2MoveParticles();
