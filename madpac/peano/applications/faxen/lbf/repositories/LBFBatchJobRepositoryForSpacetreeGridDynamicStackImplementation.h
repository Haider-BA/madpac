...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_REPOSITORIES_LBFBatchJobRepository_FOR_SPACETREE_GRID_DYNAMIC_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_REPOSITORIES_LBFBatchJobRepository_FOR_SPACETREE_GRID_DYNAMIC_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace faxen { 
      ...
      namespace repositories {
        class LBFBatchJobRepositoryForSpacetreeGridDynamicStackImplementation;  
      }
}
}
}
...
class peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridDynamicStackImplementation: public peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellDynamicStack<peano::applications::faxen::lbf::SpacetreeGridBlockCell>       CellStack;
    typedef peano::kernel::stacks::VertexDynamicStack<peano::applications::faxen::lbf::SpacetreeGridBlockVertex>   VertexStack;
  ...
  public:
    LBFBatchJobRepositoryForSpacetreeGridDynamicStackImplementation(
    ...
    virtual ~LBFBatchJobRepositoryForSpacetreeGridDynamicStackImplementation();
