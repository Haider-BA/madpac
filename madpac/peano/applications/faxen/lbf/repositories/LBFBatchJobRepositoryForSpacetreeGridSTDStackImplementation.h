...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_REPOSITORIES_LBFBatchJobRepository_FOR_SPACETREE_GRID_STD_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_REPOSITORIES_LBFBatchJobRepository_FOR_SPACETREE_GRID_STD_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace faxen { 
      ...
      namespace repositories {
        class LBFBatchJobRepositoryForSpacetreeGridSTDStackImplementation;  
      }
}
}
}
...
class peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDStackImplementation: public peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellSTDStack<peano::applications::faxen::lbf::SpacetreeGridBlockCell>       CellStack;
    typedef peano::kernel::stacks::VertexSTDStack<peano::applications::faxen::lbf::SpacetreeGridBlockVertex>   VertexStack;
  ...
  public:
    LBFBatchJobRepositoryForSpacetreeGridSTDStackImplementation(
    ...
    virtual ~LBFBatchJobRepositoryForSpacetreeGridSTDStackImplementation();
