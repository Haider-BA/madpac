...
tarch::logging::Log peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::_log( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation" );


peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation(...)" );
}
...
peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation(Geometry&)" );
  
  _repositoryState.setAction( LBFBatchJobRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(26 +3);
  
  logTraceOut( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation(Geometry&)" );
}
...
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::restart(
...
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::terminate() {
...
peano::applications::faxen::lbf::BlockState& peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::getState() {
  return _solverState;
}


peano::applications::faxen::lbf::SpacetreeGridBlockState&  peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::getSpacetreeGridState() {
  return _solverState;
}

   
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::iterate(bool reduceState) {
  tarch::utils::Watch watch( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation", "iterate(bool)", false);
 ...
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToInitialize() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterInitialize); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToInitializeAndSetBoundary() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterInitializeAndSetBoundary); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToPlotGrid() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterPlotGrid); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToControlTimeStep() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterControlTimeStep); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSetVelocitiesBoundary() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSetVelocitiesBoundary); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSetScenarioBoundary() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSetScenarioBoundary); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToComputeVelocitiesDerivatives() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterComputeVelocitiesDerivatives); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToComputeRightHandSide() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterComputeRightHandSide); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSetZeroPressureBoundary() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSetZeroPressureBoundary); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSetPressureBoundary() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSetPressureBoundary); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSORStep() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSORStep); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToComputeResidualNorm() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterComputeResidualNorm); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToComputeVelocities() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterComputeVelocities); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToPlotSolution() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterPlotSolution); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToMoveParticles() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterMoveParticles); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSwitchFromLB2NSE() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSwitchFromLB2NSE); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToExtractDataNSE2LB() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterExtractDataNSE2LB); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToCorrectDensityAndComputeEqPDF4LB() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterCorrectDensityAndComputeEqPDF4LB); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToRegularBlockSolverAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterRegularBlockSolverAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToInitialiseSpacetreeGridAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterInitialiseSpacetreeGridAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToBlockCCAOutputAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterBlockCCAOutputAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToDynamicRefinementForSpacetreeGridAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterDynamicRefinementForSpacetreeGridAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToBlockVTKOutputAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterBlockVTKOutputAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToRegularBlockSolverAndVTKOutputAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterRegularBlockSolverAndVTKOutputAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToTraceNSEData() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterTraceNSEData); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToTraceLBData() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterTraceLBData); }



 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterInitialize() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterInitialize; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterInitializeAndSetBoundary() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterInitializeAndSetBoundary; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterPlotGrid() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterPlotGrid; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterControlTimeStep() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterControlTimeStep; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSetVelocitiesBoundary() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSetVelocitiesBoundary; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSetScenarioBoundary() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSetScenarioBoundary; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterComputeVelocitiesDerivatives() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterComputeVelocitiesDerivatives; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterComputeRightHandSide() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterComputeRightHandSide; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSetZeroPressureBoundary() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSetZeroPressureBoundary; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSetPressureBoundary() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSetPressureBoundary; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSORStep() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSORStep; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterComputeResidualNorm() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterComputeResidualNorm; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterComputeVelocities() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterComputeVelocities; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterPlotSolution() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterPlotSolution; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterMoveParticles() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterMoveParticles; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSwitchFromLB2NSE() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSwitchFromLB2NSE; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterExtractDataNSE2LB() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterExtractDataNSE2LB; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterCorrectDensityAndComputeEqPDF4LB() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterCorrectDensityAndComputeEqPDF4LB; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterRegularBlockSolverAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterRegularBlockSolverAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterInitialiseSpacetreeGridAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterInitialiseSpacetreeGridAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterBlockCCAOutputAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterBlockCCAOutputAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterDynamicRefinementForSpacetreeGridAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterDynamicRefinementForSpacetreeGridAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterBlockVTKOutputAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterBlockVTKOutputAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterRegularBlockSolverAndVTKOutputAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterRegularBlockSolverAndVTKOutputAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterTraceNSEData() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterTraceNSEData; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterTraceLBData() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterTraceLBData; }



#ifdef CCA
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
...
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::logIterationStatistics() const {
...
peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::SpacetreeGridBlockVertex, peano::applications::faxen::lbf::SpacetreeGridBlockCell>* peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::createEmptyCheckpoint() {
...
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::SpacetreeGridBlockVertex, peano::applications::faxen::lbf::SpacetreeGridBlockCell> * const checkpoint) {
...
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::SpacetreeGridBlockVertex, peano::applications::faxen::lbf::SpacetreeGridBlockCell> const * const checkpoint ) {
...
#ifdef Parallel
bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation::continueToIterate() {
