...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_REPOSITORIES_LBFBatchJobRepository_FOR_SPACETREE_GRID_ARRAY_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_REPOSITORIES_LBFBatchJobRepository_FOR_SPACETREE_GRID_ARRAY_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace faxen { 
      ...
      namespace repositories {
        class LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation;  
      }
}
}
}
...
class peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation: public peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellArrayStack<peano::applications::faxen::lbf::SpacetreeGridBlockCell>       CellStack;
    typedef peano::kernel::stacks::VertexArrayStack<peano::applications::faxen::lbf::SpacetreeGridBlockVertex>   VertexStack;
  ...
  public:
    LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation(
    ...
    virtual ~LBFBatchJobRepositoryForSpacetreeGridArrayStackImplementation();
