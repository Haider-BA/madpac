...
tarch::logging::Log peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::_log( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation" );


peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(...)" );
}
...
peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(Geometry&)" );

  _repositoryState.setAction( LBFBatchJobRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(26 +3);
  
  logTraceOut( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(Geometry&)" );
}
...
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::restart(
...
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::terminate() {
...
peano::applications::faxen::lbf::BlockState& peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::getState() {
  return _solverState;
}


peano::applications::faxen::lbf::SpacetreeGridBlockState&  peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::getSpacetreeGridState() {
  return _solverState;
}
    
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::iterate(bool reduceState) {
  tarch::utils::Watch watch( "peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation", "iterate(bool)", false);
 ...
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToInitialize() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterInitialize); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToInitializeAndSetBoundary() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterInitializeAndSetBoundary); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPlotGrid() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterPlotGrid); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToControlTimeStep() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterControlTimeStep); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetVelocitiesBoundary() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSetVelocitiesBoundary); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetScenarioBoundary() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSetScenarioBoundary); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToComputeVelocitiesDerivatives() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterComputeVelocitiesDerivatives); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToComputeRightHandSide() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterComputeRightHandSide); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetZeroPressureBoundary() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSetZeroPressureBoundary); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetPressureBoundary() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSetPressureBoundary); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSORStep() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSORStep); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToComputeResidualNorm() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterComputeResidualNorm); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToComputeVelocities() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterComputeVelocities); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPlotSolution() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterPlotSolution); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToMoveParticles() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterMoveParticles); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSwitchFromLB2NSE() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterSwitchFromLB2NSE); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToExtractDataNSE2LB() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterExtractDataNSE2LB); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToCorrectDensityAndComputeEqPDF4LB() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterCorrectDensityAndComputeEqPDF4LB); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToRegularBlockSolverAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterRegularBlockSolverAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToInitialiseSpacetreeGridAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterInitialiseSpacetreeGridAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToBlockCCAOutputAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterBlockCCAOutputAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToDynamicRefinementForSpacetreeGridAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterDynamicRefinementForSpacetreeGridAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToBlockVTKOutputAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterBlockVTKOutputAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToRegularBlockSolverAndVTKOutputAdapter() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterRegularBlockSolverAndVTKOutputAdapter); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToTraceNSEData() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterTraceNSEData); }
 void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToTraceLBData() { _repositoryState.setAction(LBFBatchJobRepositoryState::UseAdapterTraceLBData); }



 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterInitialize() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterInitialize; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterInitializeAndSetBoundary() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterInitializeAndSetBoundary; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPlotGrid() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterPlotGrid; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterControlTimeStep() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterControlTimeStep; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetVelocitiesBoundary() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSetVelocitiesBoundary; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetScenarioBoundary() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSetScenarioBoundary; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterComputeVelocitiesDerivatives() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterComputeVelocitiesDerivatives; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterComputeRightHandSide() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterComputeRightHandSide; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetZeroPressureBoundary() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSetZeroPressureBoundary; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetPressureBoundary() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSetPressureBoundary; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSORStep() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSORStep; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterComputeResidualNorm() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterComputeResidualNorm; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterComputeVelocities() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterComputeVelocities; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPlotSolution() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterPlotSolution; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterMoveParticles() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterMoveParticles; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSwitchFromLB2NSE() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterSwitchFromLB2NSE; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterExtractDataNSE2LB() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterExtractDataNSE2LB; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterCorrectDensityAndComputeEqPDF4LB() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterCorrectDensityAndComputeEqPDF4LB; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterRegularBlockSolverAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterRegularBlockSolverAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterInitialiseSpacetreeGridAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterInitialiseSpacetreeGridAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterBlockCCAOutputAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterBlockCCAOutputAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterDynamicRefinementForSpacetreeGridAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterDynamicRefinementForSpacetreeGridAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterBlockVTKOutputAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterBlockVTKOutputAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterRegularBlockSolverAndVTKOutputAdapter() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterRegularBlockSolverAndVTKOutputAdapter; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterTraceNSEData() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterTraceNSEData; }
 bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterTraceLBData() const { return _repositoryState.getAction() == LBFBatchJobRepositoryState::UseAdapterTraceLBData; }



#ifdef CCA
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
...
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::logIterationStatistics() const {
...
peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::SpacetreeGridBlockVertex, peano::applications::faxen::lbf::SpacetreeGridBlockCell>* peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::createEmptyCheckpoint() {
...
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::SpacetreeGridBlockVertex, peano::applications::faxen::lbf::SpacetreeGridBlockCell> * const checkpoint) {
...
void peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::SpacetreeGridBlockVertex, peano::applications::faxen::lbf::SpacetreeGridBlockCell> const * const checkpoint ) {
...
#ifdef Parallel
bool peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::continueToIterate() {
