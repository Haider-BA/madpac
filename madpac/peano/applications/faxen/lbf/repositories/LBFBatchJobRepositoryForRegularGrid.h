...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_REPOSITORIES_LBFBatchJobRepository_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_REPOSITORIES_LBFBatchJobRepository_FOR_REGULAR_GRID_H_
 ...
 */
template class peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::RegularGridBlockVertex, peano::applications::faxen::lbf::RegularGridBlockCell>;


class peano::applications::faxen::lbf::repositories::LBFBatchJobRepositoryForRegularGrid: public peano::applications::faxen::lbf::repositories::LBFBatchJobRepository {
  public:
    /**
     * Create a checkpoint.
     *
     ...
     */
    virtual void writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::RegularGridBlockVertex, peano::applications::faxen::lbf::RegularGridBlockCell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::RegularGridBlockVertex, peano::applications::faxen::lbf::RegularGridBlockCell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::RegularGridBlockVertex, peano::applications::faxen::lbf::RegularGridBlockCell>* createEmptyCheckpoint() = 0;
    ...
    virtual peano::applications::faxen::lbf::RegularGridBlockState& getRegularGridState() = 0;
