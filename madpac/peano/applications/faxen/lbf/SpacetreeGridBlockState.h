...
#ifndef _PEANO_APPLICATIONS_FAXEN_LBF_SpacetreeGridBlockState_H_ 
#define _PEANO_APPLICATIONS_FAXEN_LBF_SpacetreeGridBlockState_H_
...
class peano::applications::faxen::lbf::SpacetreeGridBlockState: public peano::kernel::spacetreegrid::State< peano::applications::faxen::lbf::records::SpacetreeGridBlockState >, public peano::applications::faxen::lbf::BlockState{
private:
	typedef class peano::kernel::spacetreegrid::State< peano::applications::faxen::lbf::records::SpacetreeGridBlockState >  Base;
...
public:
	...
	void writeToCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::SpacetreeGridBlockVertex, peano::applications::faxen::lbf::SpacetreeGridBlockCell>& checkpoint ) const;
	void readFromCheckpoint( const peano::kernel::gridinterface::Checkpoint<peano::applications::faxen::lbf::SpacetreeGridBlockVertex, peano::applications::faxen::lbf::SpacetreeGridBlockCell>& checkpoint );
	...
	/**
	 * Lattice Boltzmann component State functions
	 */
