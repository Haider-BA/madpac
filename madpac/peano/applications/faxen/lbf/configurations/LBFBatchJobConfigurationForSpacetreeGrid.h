...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_CONFIGURATIONSLBFBatchJobConfiguration_FOR_SPACETREE_GRID_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_CONFIGURATIONSLBFBatchJobConfiguration_FOR_SPACETREE_GRID_H_
...
class peano::applications::faxen::lbf::configurations::LBFBatchJobConfigurationForSpacetreeGrid: public tarch::configuration::TopLevelConfiguration {
  public: 
    LBFBatchJobConfigurationForSpacetreeGrid(); 
    virtual ~LBFBatchJobConfigurationForSpacetreeGrid();
