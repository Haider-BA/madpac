...
#ifndef PEANO_APPLICATIONS_FAXEN_LBF_CONFIGURATIONSLBFBatchJobConfiguration_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_FAXEN_LBF_CONFIGURATIONSLBFBatchJobConfiguration_FOR_REGULAR_GRID_H_
...
class peano::applications::faxen::lbf::configurations::LBFBatchJobConfigurationForRegularGrid: public tarch::configuration::TopLevelConfiguration {
public:
	LBFBatchJobConfigurationForRegularGrid();
	virtual ~LBFBatchJobConfigurationForRegularGrid();
	...
	/** returns configuration for NSE simulations */
	const NSEConfiguration& getNSEConfiguration() const;
	...
	void initState(peano::applications::faxen::lbf::RegularGridBlockState& state) const;
...
private:
	...
	/** particle's configuration for Faxen correction */
	peano::applications::faxen::lbf::configurations::ParticlesConfiguration _particlesConfiguration;

	/** NSE solver configuration */
	peano::applications::faxen::lbf::configurations::NSEConfiguration _NSEConfiguration;
