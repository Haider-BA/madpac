...
#ifndef _PEANO_APPLICATIONS_PIC_DEMO2_SpacetreeGridState_H_ 
#define _PEANO_APPLICATIONS_PIC_DEMO2_SpacetreeGridState_H_
...
class peano::applications::pic::demo2::SpacetreeGridState: public peano::kernel::spacetreegrid::State< peano::applications::pic::demo2::records::SpacetreeGridState >, public peano::applications::pic::demo2::State { 
  private: 
    typedef class peano::kernel::spacetreegrid::State< peano::applications::pic::demo2::records::SpacetreeGridState >  Base;

    /**
     * Needed for checkpointing.
     */
    friend class peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation;
    friend class peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation;
    friend class peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation;
    friend class peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridSTDStackImplementation;
    friend class peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridDynamicStackImplementation;
  
    void writeToCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::SpacetreeGridVertex, peano::applications::pic::demo2::SpacetreeGridCell>& checkpoint ) const;    
    void readFromCheckpoint( const peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::SpacetreeGridVertex, peano::applications::pic::demo2::SpacetreeGridCell>& checkpoint );    
