...
peano::applications::pic::demo2::runners::PICBatchJobRunnerForRegularGrid::PICBatchJobRunnerForRegularGrid() {
...
int peano::applications::pic::demo2::runners::PICBatchJobRunnerForRegularGrid::run(const peano::applications::pic::demo2::configurations::PICBatchJobConfigurationForRegularGrid& configuration) {
  ...
  peano::geometry::builtin::Hexahedron geometry(
    ...
    peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForRegularGrid* repository =
    peano::applications::pic::demo2::repositories::PICBatchJobRepositoryFactory::getInstance().createRegularGridStandardImplementation(
        geometry,
        100,
        tarch::la::Vector<DIMENSIONS,double>(1.0),   // width, i.e. bounding box,
        tarch::la::Vector<DIMENSIONS,double>(0.0)    // computationalDomainOffset
