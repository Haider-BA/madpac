...
#ifndef PEANO_APPLICATIONS_PIC_DEMO2_MAPPINGS_SpacetreeGrid2SetupExperiment_H_
#define PEANO_APPLICATIONS_PIC_DEMO2_MAPPINGS_SpacetreeGrid2SetupExperiment_H_
 ...
 */
class peano::applications::pic::demo2::mappings::SpacetreeGrid2SetupExperiment {
  private:
    /**
     * Logging device.
     */
