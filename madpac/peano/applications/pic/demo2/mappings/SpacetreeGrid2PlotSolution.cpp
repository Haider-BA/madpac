...
tarch::logging::Log peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::_log( "peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution" );


peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::SpacetreeGrid2PlotSolution() {
...
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::createInnerVertex(
...
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::createHangingVertex(
      peano::applications::pic::demo2::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::createBoundaryVertex(
      peano::applications::pic::demo2::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::destroyVertex(
      const peano::applications::pic::demo2::SpacetreeGridVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::createCell(
...
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::destroyCell(
...
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::touchVertexFirstTime(
      peano::applications::pic::demo2::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::mergeWithNeighbour(
...
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::touchVertexLastTime(
      peano::applications::pic::demo2::SpacetreeGridVertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::prepareSendToNeighbour(
  peano::applications::pic::demo2::SpacetreeGridVertex& vertex
) {
  // @todo Insert your code here
}
...
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::endIteration(
  peano::applications::pic::demo2::SpacetreeGridState&  solverState
) {
...
void peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution::leaveCell(
      peano::applications::pic::demo2::SpacetreeGridCell&           fineGridCell,
      peano::applications::pic::demo2::SpacetreeGridVertex * const  fineGridVertices,
      const peano::kernel::gridinterface::VertexEnumerator&          fineGridVerticesEnumerator,
      peano::applications::pic::demo2::SpacetreeGridVertex * const  coarseGridVertices,
