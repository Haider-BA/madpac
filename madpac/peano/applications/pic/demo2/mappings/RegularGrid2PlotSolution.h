...
#ifndef PEANO_APPLICATIONS_PIC_DEMO2_MAPPINGS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_PIC_DEMO2_MAPPINGS_RegularGrid2PlotSolution_H_
 ...
 */
class peano::applications::pic::demo2::mappings::RegularGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
