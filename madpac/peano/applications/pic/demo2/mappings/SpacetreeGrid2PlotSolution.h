...
#ifndef PEANO_APPLICATIONS_PIC_DEMO2_MAPPINGS_SpacetreeGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_PIC_DEMO2_MAPPINGS_SpacetreeGrid2PlotSolution_H_
 ...
 */
class peano::applications::pic::demo2::mappings::SpacetreeGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
    ...
    std::map<tarch::la::Vector<DIMENSIONS,double> , int, tarch::la::VectorCompare<DIMENSIONS> >  _vertex2IndexMap;
        ...
        tarch::plotter::griddata::Writer::CellDataWriter*                               _cellPWriter;
