...
#ifndef _PEANO_APPLICATIONS_PIC_DEMO2REPOSITORIES_PICBatchJobRepository_FACTORY_H_ 
#define _PEANO_APPLICATIONS_PIC_DEMO2REPOSITORIES_PICBatchJobRepository_FACTORY_H_
 ...
 */
class peano::applications::pic::demo2::repositories::PICBatchJobRepositoryFactory {
  private:
  ...
  public:
     ...
     */
    PICBatchJobRepositoryForRegularGrid* createRegularGridStandardImplementation(
