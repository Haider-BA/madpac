...
tarch::logging::Log peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::_log( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation" );


peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation(...)" );
}
...
peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation(Geometry&)" );
  
  _repositoryState.setAction( PICBatchJobRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(2 +3);
  
  logTraceOut( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation(Geometry&)" );
}
...
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::restart(
...
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::terminate() {
...
peano::applications::pic::demo2::State& peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::getState() {
  return _solverState;
}


peano::applications::pic::demo2::SpacetreeGridState&  peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::getSpacetreeGridState() {
  return _solverState;
}

   
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::iterate() {
  tarch::utils::Watch watch( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation", "iterate()", false);
 ...
 void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSetupExperiment() { _repositoryState.setAction(PICBatchJobRepositoryState::UseAdapterSetupExperiment); }
 void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSetupExperimentAndPlot() { _repositoryState.setAction(PICBatchJobRepositoryState::UseAdapterSetupExperimentAndPlot); }



 bool peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSetupExperiment() const { return _repositoryState.getAction() == PICBatchJobRepositoryState::UseAdapterSetupExperiment; }
 bool peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSetupExperimentAndPlot() const { return _repositoryState.getAction() == PICBatchJobRepositoryState::UseAdapterSetupExperimentAndPlot; }



#ifdef CCA
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
...
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::logIterationStatistics() const {
...
peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::SpacetreeGridVertex, peano::applications::pic::demo2::SpacetreeGridCell>* peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::createEmptyCheckpoint() {
...
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::SpacetreeGridVertex, peano::applications::pic::demo2::SpacetreeGridCell> * const checkpoint) {
...
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::SpacetreeGridVertex, peano::applications::pic::demo2::SpacetreeGridCell> const * const checkpoint ) {
...
#ifdef Parallel
bool peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridArrayStackImplementation::continueToIterate() {
