...
#ifndef PEANO_APPLICATIONS_PIC_DEMO2_REPOSITORIES_PICBatchJobRepository_H_
#define PEANO_APPLICATIONS_PIC_DEMO2_REPOSITORIES_PICBatchJobRepository_H_
...
class peano::applications::pic::demo2::repositories::PICBatchJobRepository {
  public:
    virtual ~PICBatchJobRepository() {}
