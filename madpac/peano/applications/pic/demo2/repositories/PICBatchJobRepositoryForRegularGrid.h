...
#ifndef PEANO_APPLICATIONS_PIC_DEMO2_REPOSITORIES_PICBatchJobRepository_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_PIC_DEMO2_REPOSITORIES_PICBatchJobRepository_FOR_REGULAR_GRID_H_
 ...
 */
template class peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::RegularGridVertex, peano::applications::pic::demo2::RegularGridCell>;


class peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForRegularGrid: public peano::applications::pic::demo2::repositories::PICBatchJobRepository {
  public:
    /**
     * Create a checkpoint.
     *
     ...
     */
    virtual void writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::RegularGridVertex, peano::applications::pic::demo2::RegularGridCell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::RegularGridVertex, peano::applications::pic::demo2::RegularGridCell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::RegularGridVertex, peano::applications::pic::demo2::RegularGridCell>* createEmptyCheckpoint() = 0;
    ...
    virtual peano::applications::pic::demo2::RegularGridState& getRegularGridState() = 0;
