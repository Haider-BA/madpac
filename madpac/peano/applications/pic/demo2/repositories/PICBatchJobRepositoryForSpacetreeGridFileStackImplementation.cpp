...
tarch::logging::Log peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::_log( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation" );


peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation(...)" );
}
...
peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation(Geometry&)" );

  _repositoryState.setAction( PICBatchJobRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(2 +3);

  logTraceOut( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation(Geometry&)" );
}
...
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::restart(
...
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::terminate() {
...
peano::applications::pic::demo2::State& peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::getState() {
  return _solverState;
}


peano::applications::pic::demo2::SpacetreeGridState&  peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::getSpacetreeGridState() {
  return _solverState;
}
   

    
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::iterate() {
  tarch::utils::Watch watch( "peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation", "iterate()", false);
 ...
 void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToSetupExperiment() { _repositoryState.setAction(PICBatchJobRepositoryState::UseAdapterSetupExperiment); }
 void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToSetupExperimentAndPlot() { _repositoryState.setAction(PICBatchJobRepositoryState::UseAdapterSetupExperimentAndPlot); }



 bool peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterSetupExperiment() const { return _repositoryState.getAction() == PICBatchJobRepositoryState::UseAdapterSetupExperiment; }
 bool peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterSetupExperimentAndPlot() const { return _repositoryState.getAction() == PICBatchJobRepositoryState::UseAdapterSetupExperimentAndPlot; }



#ifdef CCA
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
...
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::logIterationStatistics() const {
...
peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::SpacetreeGridVertex, peano::applications::pic::demo2::SpacetreeGridCell>* peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::createEmptyCheckpoint() {
...
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::SpacetreeGridVertex, peano::applications::pic::demo2::SpacetreeGridCell> * const checkpoint) {
...
void peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo2::SpacetreeGridVertex, peano::applications::pic::demo2::SpacetreeGridCell> const * const checkpoint ) {
...
#ifdef Parallel
bool peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation::continueToIterate() {
