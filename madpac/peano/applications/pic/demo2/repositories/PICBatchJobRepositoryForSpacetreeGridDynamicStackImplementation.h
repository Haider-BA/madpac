...
#ifndef PEANO_APPLICATIONS_PIC_DEMO2_REPOSITORIES_PICBatchJobRepository_FOR_SPACETREE_GRID_DYNAMIC_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_PIC_DEMO2_REPOSITORIES_PICBatchJobRepository_FOR_SPACETREE_GRID_DYNAMIC_STACK_IMPLEMENTATION_H_
...
class peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridDynamicStackImplementation: public peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellDynamicStack<peano::applications::pic::demo2::SpacetreeGridCell>       CellStack;
    typedef peano::kernel::stacks::VertexDynamicStack<peano::applications::pic::demo2::SpacetreeGridVertex>   VertexStack;
  ...
  public:
    PICBatchJobRepositoryForSpacetreeGridDynamicStackImplementation(
    ...
    virtual ~PICBatchJobRepositoryForSpacetreeGridDynamicStackImplementation();
