...
#ifndef PEANO_APPLICATIONS_PIC_DEMO2_REPOSITORIES_PICBatchJobRepository_FOR_SPACETREE_GRID_FILE_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_PIC_DEMO2_REPOSITORIES_PICBatchJobRepository_FOR_SPACETREE_GRID_FILE_STACK_IMPLEMENTATION_H_
...
class peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGridFileStackImplementation: public peano::applications::pic::demo2::repositories::PICBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellFileStack<peano::applications::pic::demo2::SpacetreeGridCell>       CellStack;
    typedef peano::kernel::stacks::VertexFileStack<peano::applications::pic::demo2::SpacetreeGridVertex>   VertexStack;
  ...
  public:
    PICBatchJobRepositoryForSpacetreeGridFileStackImplementation(
    ...
    virtual ~PICBatchJobRepositoryForSpacetreeGridFileStackImplementation();
