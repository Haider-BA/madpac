...
int peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::_snapshotCounter = 0;


tarch::logging::Log peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::_log( "peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot" );


peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::SpacetreeGrid2SetupExperimentAndPlot():
  _vertex2IndexMap(),
  _vtkWriter(),
  _vertexWriter(0),
  _cellWriter(0),
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::plotVertex(
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::createInnerVertex(
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::createBoundaryVertex(
      peano::applications::pic::demo2::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::createHangingVertex(
      peano::applications::pic::demo2::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::destroyHangingVertex(
      const peano::applications::pic::demo2::SpacetreeGridVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::destroyVertex(
      const peano::applications::pic::demo2::SpacetreeGridVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::createCell(
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::destroyCell(
...
#ifdef Parallel
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::mergeWithNeighbour(
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::touchVertexFirstTime(
      peano::applications::pic::demo2::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::touchVertexLastTime(
      peano::applications::pic::demo2::SpacetreeGridVertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::prepareSendToNeighbour(
  peano::applications::pic::demo2::SpacetreeGridVertex& vertex
) {
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::beginIteration(
  ...
  _vertexTypeWriter               = _vtkWriter.createVertexDataWriter(peano::applications::pic::demo2::SpacetreeGridVertex::Records::getInsideOutsideDomainMapping() ,1);
  _vertexRefinementControlWriter  = _vtkWriter.createVertexDataWriter(peano::applications::pic::demo2::SpacetreeGridVertex::Records::getRefinementControlMapping() ,1);
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::endIteration(
  peano::applications::pic::demo2::SpacetreeGridState&  solverState
) {
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::enterCell(
      peano::applications::pic::demo2::SpacetreeGridCell&                 fineGridCell,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperimentAndPlot::leaveCell(
      peano::applications::pic::demo2::SpacetreeGridCell&           fineGridCell,
      peano::applications::pic::demo2::SpacetreeGridVertex * const  fineGridVertices,
      const peano::kernel::gridinterface::VertexEnumerator&          fineGridVerticesEnumerator,
      peano::applications::pic::demo2::SpacetreeGridVertex * const  coarseGridVertices,
