...
peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::SpacetreeGrid2SetupExperiment() {
}
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::createHangingVertex(
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::destroyHangingVertex(
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::createInnerVertex(
      peano::applications::pic::demo2::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::createBoundaryVertex(
      peano::applications::pic::demo2::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::destroyVertex(
      const peano::applications::pic::demo2::SpacetreeGridVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::createCell(
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::destroyCell(
...
#ifdef Parallel
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::mergeWithNeighbour(
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::touchVertexFirstTime(
      peano::applications::pic::demo2::SpacetreeGridVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex const * const  coarseGridVertices,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::touchVertexLastTime(
      peano::applications::pic::demo2::SpacetreeGridVertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::pic::demo2::SpacetreeGridVertex * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::prepareSendToNeighbour(
  peano::applications::pic::demo2::SpacetreeGridVertex& vertex
) {
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::beginIteration(
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::endIteration(
  peano::applications::pic::demo2::SpacetreeGridState&  solverState
) {
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::enterCell(
      peano::applications::pic::demo2::SpacetreeGridCell&                 fineGridCell,
...
void peano::applications::pic::demo2::adapters::SpacetreeGrid2SetupExperiment::leaveCell(
      peano::applications::pic::demo2::SpacetreeGridCell&           fineGridCell,
      peano::applications::pic::demo2::SpacetreeGridVertex * const  fineGridVertices,
      const peano::kernel::gridinterface::VertexEnumerator&          fineGridVerticesEnumerator,
      peano::applications::pic::demo2::SpacetreeGridVertex * const  coarseGridVertices,
