...
#ifndef PEANO_APPLICATIONS_PIC_DEMO2_CONFIGURATIONSPICBatchJobConfiguration_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_PIC_DEMO2_CONFIGURATIONSPICBatchJobConfiguration_FOR_REGULAR_GRID_H_
...
namespace peano { 
  namespace applications { 
    namespace pic { 
      ...
      class PICBatchJobConfigurationForRegularGrid;
      } 
}
}
}
...
class peano::applications::pic::demo2::configurations::PICBatchJobConfigurationForRegularGrid: public tarch::configuration::TopLevelConfiguration {
  public: 
    PICBatchJobConfigurationForRegularGrid(); 
    virtual ~PICBatchJobConfigurationForRegularGrid();
