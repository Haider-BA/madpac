...
#ifndef PEANO_APPLICATIONS_PIC_DEMO2_CONFIGURATIONSPICBatchJobConfiguration_FOR_SPACETREE_GRID_H_
#define PEANO_APPLICATIONS_PIC_DEMO2_CONFIGURATIONSPICBatchJobConfiguration_FOR_SPACETREE_GRID_H_
...
class peano::applications::pic::demo2::configurations::PICBatchJobConfigurationForSpacetreeGrid: public tarch::configuration::TopLevelConfiguration {
  public: 
