...
#ifndef PEANO_APPLICATIONS_PIC_DEMO_ADAPTERS_SpacetreeGrid2SetupExperimentAndPlot_H_
#define PEANO_APPLICATIONS_PIC_DEMO_ADAPTERS_SpacetreeGrid2SetupExperimentAndPlot_H_
 ...
 */
class peano::applications::pic::demo::adapters::SpacetreeGrid2SetupExperimentAndPlot {
  private:
    peano::applications::pic::demo::mappings::SpacetreeGrid2SetupExperiment _map2SetupExperiment;
    peano::applications::pic::demo::mappings::SpacetreeGrid2PlotSolution _map2PlotSolution;
