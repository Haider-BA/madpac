...
peano::applications::pic::demo::runners::PICBatchJobRunnerForSpacetreeGrid::PICBatchJobRunnerForSpacetreeGrid() {
...
int peano::applications::pic::demo::runners::PICBatchJobRunnerForSpacetreeGrid::run(const peano::applications::pic::demo::configurations::PICBatchJobConfigurationForSpacetreeGrid& configuration) {
  ...
  peano::applications::pic::demo::repositories::PICBatchJobRepositoryForSpacetreeGrid* repository = 
    peano::applications::pic::demo::repositories::PICBatchJobRepositoryFactory::getInstance().createSpacetreeGridSTDStackImplementation(
      geometry,
      tarch::la::Vector<DIMENSIONS,double>(1.0),   // width, i.e. bounding box,
      tarch::la::Vector<DIMENSIONS,double>(0.0)    // computationalDomainOffset
    );
...
int peano::applications::pic::demo::runners::PICBatchJobRunnerForSpacetreeGrid::runAsMaster(peano::applications::pic::demo::repositories::PICBatchJobRepositoryForSpacetreeGrid& repository) {
