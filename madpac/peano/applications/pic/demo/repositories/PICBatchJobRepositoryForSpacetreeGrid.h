...
#ifndef PEANO_APPLICATIONS_PIC_DEMO_REPOSITORIES_PICBatchJobRepository_FOR_SPACETREE_GRID_H_
#define PEANO_APPLICATIONS_PIC_DEMO_REPOSITORIES_PICBatchJobRepository_FOR_SPACETREE_GRID_H_


#include "peano/applications/pic/demo/repositories/PICBatchJobRepository.h"
 ...
 */
template class peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo::SpacetreeGridVertex, peano::applications::pic::demo::SpacetreeGridCell>;


class peano::applications::pic::demo::repositories::PICBatchJobRepositoryForSpacetreeGrid: public peano::applications::pic::demo::repositories::PICBatchJobRepository {
  public:
    virtual peano::applications::pic::demo::State& getState() = 0;
     ...
     */
    virtual void writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo::SpacetreeGridVertex, peano::applications::pic::demo::SpacetreeGridCell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo::SpacetreeGridVertex, peano::applications::pic::demo::SpacetreeGridCell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::kernel::gridinterface::Checkpoint<peano::applications::pic::demo::SpacetreeGridVertex, peano::applications::pic::demo::SpacetreeGridCell>* createEmptyCheckpoint() = 0;
    ...
    virtual peano::applications::pic::demo::SpacetreeGridState& getSpacetreeGridState() = 0;
