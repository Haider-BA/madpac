...
#ifndef PEANO_APPLICATIONS_PIC_DEMO_REPOSITORIES_PICBatchJobRepository_H_
#define PEANO_APPLICATIONS_PIC_DEMO_REPOSITORIES_PICBatchJobRepository_H_
...
class peano::applications::pic::demo::repositories::PICBatchJobRepository {
  public:
