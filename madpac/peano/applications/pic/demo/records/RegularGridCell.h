#ifndef _PEANO_APPLICATIONS_PIC_DEMO_RECORDS_REGULARGRIDCELL_H
#define _PEANO_APPLICATIONS_PIC_DEMO_RECORDS_REGULARGRIDCELL_H
 ...
 */
class peano::applications::pic::demo::records::RegularGridCell { 
   
   public:
      
      typedef peano::applications::pic::demo::records::RegularGridCellPacked Packed;
    ...
    * @date   14/06/2011 15:46
    */
   class peano::applications::pic::demo::records::RegularGridCellPacked { 
