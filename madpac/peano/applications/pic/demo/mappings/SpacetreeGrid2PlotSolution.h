...
#ifndef PEANO_APPLICATIONS_PIC_DEMO_MAPPINGS_SpacetreeGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_PIC_DEMO_MAPPINGS_SpacetreeGrid2PlotSolution_H_
 ...
 */
class peano::applications::pic::demo::mappings::SpacetreeGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
