...
#ifndef _PEANO_APPLICATIONS_POISSON_VHHJACOBI_CCA_JacobiBatchJobFOR_REGULAR_GRID_H_ 
#define _PEANO_APPLICATIONS_POISSON_VHHJACOBI_CCA_JacobiBatchJobFOR_REGULAR_GRID_H_

#if defined(CCA)
#include "peano/applications/poisson/vhhjacobi/cca/scicode/AbstractJacobiBatchJobForRegularGrid.h"
#endif
 ...
 * CCA component. 
 */
class peano::applications::poisson::vhhjacobi::cca::JacobiBatchJobForRegularGridImplementation
#if defined(CCA)
...
#endif
{
  private:
    ...
    peano::applications::poisson::vhhjacobi::repositories::JacobiBatchJobRepositoryForRegularGrid*            _repository;
