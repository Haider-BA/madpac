...
#ifndef PEANO_APPLICATIONS_POISSON_VHHJACOBI_CONFIGURATIONSJacobiBatchJobConfiguration_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_POISSON_VHHJACOBI_CONFIGURATIONSJacobiBatchJobConfiguration_FOR_REGULAR_GRID_H_
...
class peano::applications::poisson::vhhjacobi::configurations::JacobiBatchJobConfigurationForRegularGrid: public tarch::configuration::TopLevelConfiguration {
  private:
