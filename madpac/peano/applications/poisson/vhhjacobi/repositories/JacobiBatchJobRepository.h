...
#ifndef PEANO_APPLICATIONS_POISSON_VHHJACOBI_REPOSITORIES_JacobiBatchJobRepository_H_
#define PEANO_APPLICATIONS_POISSON_VHHJACOBI_REPOSITORIES_JacobiBatchJobRepository_H_
...
class peano::applications::poisson::vhhjacobi::repositories::JacobiBatchJobRepository {
  public:
    ...
    virtual peano::applications::poisson::vhhjacobi::State& getState() = 0;
