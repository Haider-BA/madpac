...
#ifndef PEANO_APPLICATIONS_POISSON_VHHJACOBI_MAPPINGS_RegularGrid2JacobiStep_H_
#define PEANO_APPLICATIONS_POISSON_VHHJACOBI_MAPPINGS_RegularGrid2JacobiStep_H_
 ...
 */
class peano::applications::poisson::vhhjacobi::mappings::RegularGrid2JacobiStep {
  private:
    /**
     * Logging device.
     */
    ...
    peano::toolbox::solver::VirtualHierarchicalHRefinement* _vhhRefinement;
