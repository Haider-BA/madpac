...
#ifndef PEANO_APPLICATIONS_POISSON_VHHJACOBI_MAPPINGS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_POISSON_VHHJACOBI_MAPPINGS_RegularGrid2PlotSolution_H_
 ...
 */
class peano::applications::poisson::vhhjacobi::mappings::RegularGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
