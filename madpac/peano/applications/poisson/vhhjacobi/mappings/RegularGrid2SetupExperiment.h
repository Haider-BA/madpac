...
#ifndef PEANO_APPLICATIONS_POISSON_VHHJACOBI_MAPPINGS_RegularGrid2SetupExperiment_H_
#define PEANO_APPLICATIONS_POISSON_VHHJACOBI_MAPPINGS_RegularGrid2SetupExperiment_H_
 ...
 */
class peano::applications::poisson::vhhjacobi::mappings::RegularGrid2SetupExperiment {
  private:
    /**
     * Logging device.
     */
