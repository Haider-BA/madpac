...
#ifndef PEANO_APPLICATIONS_POISSON_VHHJACOBI_ADAPTERS_RegularGrid2JacobiStepAndPlotSolution_H_
#define PEANO_APPLICATIONS_POISSON_VHHJACOBI_ADAPTERS_RegularGrid2JacobiStepAndPlotSolution_H_
 ...
 */
class peano::applications::poisson::vhhjacobi::adapters::RegularGrid2JacobiStepAndPlotSolution {
  private:
