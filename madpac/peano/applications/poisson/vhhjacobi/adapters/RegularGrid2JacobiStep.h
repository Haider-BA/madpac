...
#ifndef PEANO_APPLICATIONS_POISSON_VHHJACOBI_ADAPTERS_RegularGrid2JacobiStep_H_
#define PEANO_APPLICATIONS_POISSON_VHHJACOBI_ADAPTERS_RegularGrid2JacobiStep_H_
 ...
 */
class peano::applications::poisson::vhhjacobi::adapters::RegularGrid2JacobiStep {
  private:
    peano::applications::poisson::vhhjacobi::mappings::RegularGrid2JacobiStep _map2JacobiStep;
