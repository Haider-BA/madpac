...
#ifndef _PEANO_APPLICATIONS_POISSON_VHHJACOBI_RegularGridState_H_ 
#define _PEANO_APPLICATIONS_POISSON_VHHJACOBI_RegularGridState_H_
...
#include "peano/applications/poisson/vhhjacobi/State.h"
...
class peano::applications::poisson::vhhjacobi::RegularGridState: public peano::kernel::regulargrid::State< peano::applications::poisson::vhhjacobi::records::RegularGridState >, public peano::applications::poisson::vhhjacobi::State { 
  private: 
    typedef class peano::kernel::regulargrid::State< peano::applications::poisson::vhhjacobi::records::RegularGridState >  Base;

    /**
     * Needed for checkpointing.
     */
    friend class peano::applications::poisson::vhhjacobi::repositories::JacobiBatchJobRepositoryForRegularGridStandardImplementation;
    
    void writeToCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::vhhjacobi::RegularGridVertex, peano::applications::poisson::vhhjacobi::RegularGridCell>& checkpoint ) const;    
    void readFromCheckpoint( const peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::vhhjacobi::RegularGridVertex, peano::applications::poisson::vhhjacobi::RegularGridCell>& checkpoint );    
