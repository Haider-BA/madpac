#ifndef _PEANO_APPLICATIONS_POISSON_VHHJACOBI_RECORDS_REGULARGRIDCELL_H
#define _PEANO_APPLICATIONS_POISSON_VHHJACOBI_RECORDS_REGULARGRIDCELL_H
 ...
 */
class peano::applications::poisson::vhhjacobi::records::RegularGridCell { 
   
   public:
      
      typedef peano::applications::poisson::vhhjacobi::records::RegularGridCellPacked Packed;
    ...
    * @date   28/06/2011 13:48
    */
   class peano::applications::poisson::vhhjacobi::records::RegularGridCellPacked { 
