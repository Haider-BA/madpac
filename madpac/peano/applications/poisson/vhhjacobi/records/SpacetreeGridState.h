#ifndef _PEANO_APPLICATIONS_POISSON_VHHJACOBI_RECORDS_SPACETREEGRIDSTATE_H
#define _PEANO_APPLICATIONS_POISSON_VHHJACOBI_RECORDS_SPACETREEGRIDSTATE_H
...
namespace peano {
    ...
    */
   class peano::applications::poisson::vhhjacobi::records::SpacetreeGridState { 
      
      public:
         
         typedef peano::applications::poisson::vhhjacobi::records::SpacetreeGridStatePacked Packed;
      ...
      public:
          ...
          * Generated
          */
         SpacetreeGridState(const int& fileNumber, const tarch::la::Vector<DIMENSIONS,double>& minMeshWidth, const tarch::la::Vector<DIMENSIONS,double>& maxMeshWidth, const double& numberOfInnerVertices, const double& numberOfBoundaryVertices, const double& numberOfOuterVertices, const double& numberOfInnerCells, const double& numberOfOuterCells, const int& maxLevel, const bool& hasRefined, const bool& hasTriggeredRefinementForNextIteration, const bool& hasErased, const bool& hasTriggeredEraseForNextIteration, const bool& hasChangedVertexOrCellState, const bool& isTraversalInverted, const bool& deriveAdjacencyInformation);
       ...
       * @date   28/06/2011 13:48
       */
      class peano::applications::poisson::vhhjacobi::records::SpacetreeGridStatePacked { 
