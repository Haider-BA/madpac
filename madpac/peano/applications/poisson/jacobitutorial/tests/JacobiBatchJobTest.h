...
#ifndef _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_TESTS_JacobiBatchJobTest_H_
#define _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_TESTS_JacobiBatchJobTest_H_
 ...
 */ 
class peano::applications::poisson::jacobitutorial::tests::JacobiBatchJobTest: public tarch::tests::TestCase {
  private:
    /**
