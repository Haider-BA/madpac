#ifndef _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_REPOSITORIES_JACOBIBATCHJOBREPOSITORYSTATE_H
#define _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_REPOSITORIES_JACOBIBATCHJOBREPOSITORYSTATE_H
 ...
 */
class peano::applications::poisson::jacobitutorial::repositories::JacobiBatchJobRepositoryState { 
   
   public:
      
      typedef peano::applications::poisson::jacobitutorial::repositories::JacobiBatchJobRepositoryStatePacked Packed;
      
      enum Action {
         WriteCheckpoint = 0, ReadCheckpoint = 1, Terminate = 2, UseAdapterSetupExperiment = 3, UseAdapterSetupExperimentAndPlotGrid = 4, UseAdapterSetupExperimentAndPlotStartSolution = 5, UseAdapterJacobiStep = 6, UseAdapterJacobiStepAndPlotSolution = 7, UseAdapterPlotSolution = 8
      };
    ...
    * @date   28/06/2011 13:51
    */
   class peano::applications::poisson::jacobitutorial::repositories::JacobiBatchJobRepositoryStatePacked { 
      
      public:
         
         typedef peano::applications::poisson::jacobitutorial::repositories::JacobiBatchJobRepositoryState::Action Action;
