...
#ifndef PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_REPOSITORIES_JacobiBatchJobRepository_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_REPOSITORIES_JacobiBatchJobRepository_FOR_REGULAR_GRID_H_


#include "peano/applications/poisson/jacobitutorial/repositories/JacobiBatchJobRepository.h"
 ...
 */
template class peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::jacobitutorial::RegularGridVertex, peano::applications::poisson::jacobitutorial::RegularGridCell>;


class peano::applications::poisson::jacobitutorial::repositories::JacobiBatchJobRepositoryForRegularGrid: public peano::applications::poisson::jacobitutorial::repositories::JacobiBatchJobRepository {
  public:
    /**
     * Create a checkpoint.
     *
     ...
     */
    virtual void writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::jacobitutorial::RegularGridVertex, peano::applications::poisson::jacobitutorial::RegularGridCell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::jacobitutorial::RegularGridVertex, peano::applications::poisson::jacobitutorial::RegularGridCell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::jacobitutorial::RegularGridVertex, peano::applications::poisson::jacobitutorial::RegularGridCell>* createEmptyCheckpoint() = 0;
    ...
    virtual peano::applications::poisson::jacobitutorial::RegularGridState& getRegularGridState() = 0;
