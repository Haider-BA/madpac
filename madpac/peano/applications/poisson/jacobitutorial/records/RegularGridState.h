#ifndef _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_RECORDS_REGULARGRIDSTATE_H
#define _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_RECORDS_REGULARGRIDSTATE_H
 ...
 */
class peano::applications::poisson::jacobitutorial::records::RegularGridState { 
   
   public:
      
      typedef peano::applications::poisson::jacobitutorial::records::RegularGridStatePacked Packed;
   ...
   public:
       ...
       * Generated
       */
      RegularGridState(const double& omega, const int& fileNumber, const tarch::la::Vector<DIMENSIONS,double>& meshWidth, const double& numberOfInnerVertices, const double& numberOfBoundaryVertices, const double& numberOfOuterVertices, const double& numberOfInnerCells, const double& numberOfOuterCells, const bool& gridIsStationary);
    ...
    * @date   28/06/2011 13:51
    */
   class peano::applications::poisson::jacobitutorial::records::RegularGridStatePacked { 
