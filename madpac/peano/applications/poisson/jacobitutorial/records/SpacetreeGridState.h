#ifndef _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_RECORDS_SPACETREEGRIDSTATE_H
#define _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_RECORDS_SPACETREEGRIDSTATE_H
...
namespace peano {
    ...
    */
   class peano::applications::poisson::jacobitutorial::records::SpacetreeGridState { 
      
      public:
         
         typedef peano::applications::poisson::jacobitutorial::records::SpacetreeGridStatePacked Packed;
      ...
      public:
          ...
          * Generated
          */
         SpacetreeGridState(const double& omega, const int& fileNumber, const tarch::la::Vector<DIMENSIONS,double>& minMeshWidth, const tarch::la::Vector<DIMENSIONS,double>& maxMeshWidth, const double& numberOfInnerVertices, const double& numberOfBoundaryVertices, const double& numberOfOuterVertices, const double& numberOfInnerCells, const double& numberOfOuterCells, const int& maxLevel, const bool& hasRefined, const bool& hasTriggeredRefinementForNextIteration, const bool& hasErased, const bool& hasTriggeredEraseForNextIteration, const bool& hasChangedVertexOrCellState, const bool& isTraversalInverted, const bool& deriveAdjacencyInformation);
       ...
       * @date   28/06/2011 13:51
       */
      class peano::applications::poisson::jacobitutorial::records::SpacetreeGridStatePacked { 
