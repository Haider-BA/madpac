#ifndef _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_RECORDS_REGULARGRIDCELL_H
#define _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_RECORDS_REGULARGRIDCELL_H
 ...
 */
class peano::applications::poisson::jacobitutorial::records::RegularGridCell { 
   
   public:
      
      typedef peano::applications::poisson::jacobitutorial::records::RegularGridCellPacked Packed;
    ...
    * @date   28/06/2011 13:51
    */
   class peano::applications::poisson::jacobitutorial::records::RegularGridCellPacked { 
