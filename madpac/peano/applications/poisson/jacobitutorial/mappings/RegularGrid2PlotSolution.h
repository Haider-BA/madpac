...
#ifndef PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_MAPPINGS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_MAPPINGS_RegularGrid2PlotSolution_H_
 ...
 * --- inserted manually ---
 *
 * I need a plotter to write something into a file. If you are searching for a
 * template how to plot things in Peano, propably this file or a generated
 * plotter in the adapter directory might be a good starting point.
 */
...
class peano::applications::poisson::jacobitutorial::mappings::RegularGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
     ...
     * --- inserted manually ---
     *
     * The following seven lines, I inserted manually.
     */
    ...
    tarch::multicore::BooleanSemaphore                                              _outputStreamSemaphore;
