...
#ifndef PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_MAPPINGS_RegularGrid2SetupExperiment_H_
#define PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_MAPPINGS_RegularGrid2SetupExperiment_H_
 ...
 */
class peano::applications::poisson::jacobitutorial::mappings::RegularGrid2SetupExperiment {
  private:
    /**
     * Logging device.
     */
