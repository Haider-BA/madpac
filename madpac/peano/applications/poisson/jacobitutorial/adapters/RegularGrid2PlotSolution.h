...
#ifndef PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_ADAPTERS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_ADAPTERS_RegularGrid2PlotSolution_H_
 ...
 */
class peano::applications::poisson::jacobitutorial::adapters::RegularGrid2PlotSolution {
  private:
