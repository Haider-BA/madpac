...
#ifndef PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_ADAPTERS_RegularGrid2SetupExperimentAndPlotStartSolution_H_
#define PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_ADAPTERS_RegularGrid2SetupExperimentAndPlotStartSolution_H_
...
namespace peano { 
  namespace applications { 
    namespace poisson { 
      ...
      namespace adapters {
        class RegularGrid2SetupExperimentAndPlotStartSolution;
      } 
}
}
}
 ...
 */
class peano::applications::poisson::jacobitutorial::adapters::RegularGrid2SetupExperimentAndPlotStartSolution {
  private:
  ...
  public:
    RegularGrid2SetupExperimentAndPlotStartSolution();

    virtual ~RegularGrid2SetupExperimentAndPlotStartSolution();
