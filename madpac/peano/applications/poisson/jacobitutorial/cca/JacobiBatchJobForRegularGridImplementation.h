...
#ifndef _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_CCA_JacobiBatchJobFOR_REGULAR_GRID_H_ 
#define _PEANO_APPLICATIONS_POISSON_JACOBITUTORIAL_CCA_JacobiBatchJobFOR_REGULAR_GRID_H_

#if defined(CCA)
#include "peano/applications/poisson/jacobitutorial/cca/scicode/AbstractJacobiBatchJobForRegularGrid.h"
#endif
...
namespace peano { 
  namespace applications { 
    namespace poisson { 
      ...
      namespace cca {
        class JacobiBatchJobForRegularGridImplementation;
      }
}
}
}
...
/**
 * CCA Component of JacobiBatchJob
 *
 * This is the blueprint of JacobiBatchJob acting as 
 * CCA component. 
 */
class peano::applications::poisson::jacobitutorial::cca::JacobiBatchJobForRegularGridImplementation
#if defined(CCA)
  : public AbstractJacobiBatchJobForRegularGrid
#endif
{
  private:
    /**
    ...
    peano::applications::poisson::jacobitutorial::repositories::JacobiBatchJobRepositoryForRegularGrid*            _repository;
    
  public:
    JacobiBatchJobForRegularGridImplementation();
    virtual ~JacobiBatchJobForRegularGridImplementation();
