...
#ifndef PEANO_APPLICATIONS_POISSON_MULTIGRID_ADAPTERS_SpacetreeGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_POISSON_MULTIGRID_ADAPTERS_SpacetreeGrid2PlotSolution_H_
 ...
 */
class peano::applications::poisson::multigrid::adapters::SpacetreeGrid2PlotSolution {
  private:
