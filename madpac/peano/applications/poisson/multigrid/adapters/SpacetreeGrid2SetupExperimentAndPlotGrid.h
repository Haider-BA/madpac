...
#ifndef PEANO_APPLICATIONS_POISSON_MULTIGRID_ADAPTERS_SpacetreeGrid2SetupExperimentAndPlotGrid_H_
#define PEANO_APPLICATIONS_POISSON_MULTIGRID_ADAPTERS_SpacetreeGrid2SetupExperimentAndPlotGrid_H_
...
namespace peano { 
  namespace applications { 
    namespace poisson { 
      namespace multigrid {
      namespace adapters {
        class SpacetreeGrid2SetupExperimentAndPlotGrid;
      } 
}
}
}
 ...
 */
class peano::applications::poisson::multigrid::adapters::SpacetreeGrid2SetupExperimentAndPlotGrid {
  private:
  ...
  public:
    SpacetreeGrid2SetupExperimentAndPlotGrid();

    virtual ~SpacetreeGrid2SetupExperimentAndPlotGrid();
