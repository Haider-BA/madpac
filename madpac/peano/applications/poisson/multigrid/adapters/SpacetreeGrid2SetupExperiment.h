...
#ifndef PEANO_APPLICATIONS_POISSON_MULTIGRID_ADAPTERS_SpacetreeGrid2SetupExperiment_H_
#define PEANO_APPLICATIONS_POISSON_MULTIGRID_ADAPTERS_SpacetreeGrid2SetupExperiment_H_
 ...
 */
class peano::applications::poisson::multigrid::adapters::SpacetreeGrid2SetupExperiment {
  private:
