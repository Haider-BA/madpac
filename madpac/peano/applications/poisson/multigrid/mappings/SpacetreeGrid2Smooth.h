...
#ifndef PEANO_APPLICATIONS_POISSON_MULTIGRID_MAPPINGS_SpacetreeGrid2Smooth_H_
#define PEANO_APPLICATIONS_POISSON_MULTIGRID_MAPPINGS_SpacetreeGrid2Smooth_H_
 ...
 */
class peano::applications::poisson::multigrid::mappings::SpacetreeGrid2Smooth {
  private:
    /**
     * Logging device.
     */
