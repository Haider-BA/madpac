...
#ifndef PEANO_APPLICATIONS_POISSON_MULTIGRID_MAPPINGS_SpacetreeGrid2ComputeGalerkinCoarseGridOperator_H_
#define PEANO_APPLICATIONS_POISSON_MULTIGRID_MAPPINGS_SpacetreeGrid2ComputeGalerkinCoarseGridOperator_H_
...
namespace peano { 
  namespace applications { 
    namespace poisson { 
      namespace multigrid {
      namespace mappings {
        class SpacetreeGrid2ComputeGalerkinCoarseGridOperator;
      } 
}
}
}
 ...
 */
class peano::applications::poisson::multigrid::mappings::SpacetreeGrid2ComputeGalerkinCoarseGridOperator {
  private:
    /**
     * Logging device.
     */
    ...
    /**
     * This is the converted from a sequence/vector of stencils into an
     * element-wise assembly matrix.
     */
    peano::toolbox::stencil::ElementMatrix _elementMatrix;

    peano::toolbox::solver::PetrovGalerkin _galerkin;
  
    void validateCoarseGridVertex(
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2ComputeGalerkinCoarseGridOperator();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2ComputeGalerkinCoarseGridOperator();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ComputeGalerkinCoarseGridOperator()
     */
    void beginIteration(
