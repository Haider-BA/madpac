...
#ifndef PEANO_APPLICATIONS_POISSON_MULTIGRID_MAPPINGS_SpacetreeGrid2SetupExperiment_H_
#define PEANO_APPLICATIONS_POISSON_MULTIGRID_MAPPINGS_SpacetreeGrid2SetupExperiment_H_
 ...
 */
class peano::applications::poisson::multigrid::mappings::SpacetreeGrid2SetupExperiment {
  private:
    /**
     * Logging device.
     */
