...
#ifndef PEANO_APPLICATIONS_POISSON_MULTIGRID_MAPPINGS_SpacetreeGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_POISSON_MULTIGRID_MAPPINGS_SpacetreeGrid2PlotSolution_H_
 ...
 */
class peano::applications::poisson::multigrid::mappings::SpacetreeGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
    ...
    /**
     * Is called by both touchVertexFirstTime() and createTemporaryVertex().
     */
    void plotVertex(
