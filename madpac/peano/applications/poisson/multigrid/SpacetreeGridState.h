...
#ifndef _PEANO_APPLICATIONS_POISSON_MULTIGRID_SpacetreeGridState_H_ 
#define _PEANO_APPLICATIONS_POISSON_MULTIGRID_SpacetreeGridState_H_


#include "peano/kernel/spacetreegrid/State.h"

#include "peano/applications/poisson/multigrid/records/SpacetreeGridState.h"
#include "peano/applications/poisson/multigrid/State.h"
 ...
 * \author RaPeP
 */
class peano::applications::poisson::multigrid::SpacetreeGridState: public peano::kernel::spacetreegrid::State< peano::applications::poisson::multigrid::records::SpacetreeGridState >, public peano::applications::poisson::multigrid::State {
  private: 
    typedef class peano::kernel::spacetreegrid::State< peano::applications::poisson::multigrid::records::SpacetreeGridState >  Base;
  ...
  public:
    ...
    void writeToCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::multigrid::SpacetreeGridVertex, peano::applications::poisson::multigrid::SpacetreeGridCell>& checkpoint ) const;    
    void readFromCheckpoint( const peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::multigrid::SpacetreeGridVertex, peano::applications::poisson::multigrid::SpacetreeGridCell>& checkpoint );    
