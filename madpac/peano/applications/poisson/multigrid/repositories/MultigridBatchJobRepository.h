...
#ifndef PEANO_APPLICATIONS_POISSON_MULTIGRID_REPOSITORIES_MultigridBatchJobRepository_H_
#define PEANO_APPLICATIONS_POISSON_MULTIGRID_REPOSITORIES_MultigridBatchJobRepository_H_
  ...
  namespace applications { 
    namespace poisson { 
      ...
      namespace repositories {
        class MultigridBatchJobRepository;  
      }
      /**
       * Forward declaration.
       */
...
class peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepository {
  public:
    virtual ~MultigridBatchJobRepository() {}
     ...
     */
     ...
     virtual void switchToSmoothAndComputeGalerkinCoarseGridOperator() = 0;    
     ...
     virtual bool isActiveAdapterSmoothAndComputeGalerkinCoarseGridOperator() const = 0;
