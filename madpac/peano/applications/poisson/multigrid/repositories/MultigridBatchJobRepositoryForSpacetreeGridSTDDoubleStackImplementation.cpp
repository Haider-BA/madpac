...
tarch::logging::Log peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::_log( "peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation" );


peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(...)" );
}
...
peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(Geometry&)" );

  _repositoryState.setAction( MultigridBatchJobRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(5 +3);
  
  logTraceOut( "peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(Geometry&)" );
}
...
void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::restart(
...
void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::terminate() {
...
peano::applications::poisson::multigrid::State& peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::getState() {
  return _solverState;
}


peano::applications::poisson::multigrid::SpacetreeGridState&  peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::getSpacetreeGridState() {
  return _solverState;
}
...
void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::iterate() {
  tarch::utils::Watch watch( "peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation", "iterate()", false);
...
void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::iterate(bool reduceState) {

}


 void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetupExperiment() { _repositoryState.setAction(MultigridBatchJobRepositoryState::UseAdapterSetupExperiment); }
 void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetupExperimentAndPlotGrid() { _repositoryState.setAction(MultigridBatchJobRepositoryState::UseAdapterSetupExperimentAndPlotGrid); }
 void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetupExperimentAndPlotStartSolution() { _repositoryState.setAction(MultigridBatchJobRepositoryState::UseAdapterSetupExperimentAndPlotStartSolution); }
 void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSmoothAndComputeGalerkinCoarseGridOperator() { _repositoryState.setAction(MultigridBatchJobRepositoryState::UseAdapterSmoothAndComputeGalerkinCoarseGridOperator); }
 void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPlotSolution() { _repositoryState.setAction(MultigridBatchJobRepositoryState::UseAdapterPlotSolution); }



 bool peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetupExperiment() const { return _repositoryState.getAction() == MultigridBatchJobRepositoryState::UseAdapterSetupExperiment; }
 bool peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetupExperimentAndPlotGrid() const { return _repositoryState.getAction() == MultigridBatchJobRepositoryState::UseAdapterSetupExperimentAndPlotGrid; }
 bool peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetupExperimentAndPlotStartSolution() const { return _repositoryState.getAction() == MultigridBatchJobRepositoryState::UseAdapterSetupExperimentAndPlotStartSolution; }
 bool peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSmoothAndComputeGalerkinCoarseGridOperator() const { return _repositoryState.getAction() == MultigridBatchJobRepositoryState::UseAdapterSmoothAndComputeGalerkinCoarseGridOperator; }
 bool peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPlotSolution() const { return _repositoryState.getAction() == MultigridBatchJobRepositoryState::UseAdapterPlotSolution; }



#ifdef CCA
void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
...
void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::logIterationStatistics() const {
...
peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::multigrid::SpacetreeGridVertex, peano::applications::poisson::multigrid::SpacetreeGridCell>* peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::createEmptyCheckpoint() {
...
void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::multigrid::SpacetreeGridVertex, peano::applications::poisson::multigrid::SpacetreeGridCell> * const checkpoint) {
...
void peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::multigrid::SpacetreeGridVertex, peano::applications::poisson::multigrid::SpacetreeGridCell> const * const checkpoint ) {
...
#ifdef Parallel
bool peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::continueToIterate() {
