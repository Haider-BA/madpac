...
#ifndef PEANO_APPLICATIONS_POISSON_MULTIGRID_REPOSITORIES_MultigridBatchJobRepository_FOR_SPACETREE_GRID_ARRAY_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_POISSON_MULTIGRID_REPOSITORIES_MultigridBatchJobRepository_FOR_SPACETREE_GRID_ARRAY_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace poisson { 
      ...
      namespace repositories {
        class MultigridBatchJobRepositoryForSpacetreeGridArrayStackImplementation;  
      }
}
}
}
...
class peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGridArrayStackImplementation: public peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellArrayStack<peano::applications::poisson::multigrid::SpacetreeGridCell>       CellStack;
    typedef peano::kernel::stacks::VertexArrayStack<peano::applications::poisson::multigrid::SpacetreeGridVertex>   VertexStack;
  ...
  public:
    MultigridBatchJobRepositoryForSpacetreeGridArrayStackImplementation(
    ...
    virtual ~MultigridBatchJobRepositoryForSpacetreeGridArrayStackImplementation();
