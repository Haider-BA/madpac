...
#ifndef PEANO_APPLICATIONS_POISSON_MULTIGRID_REPOSITORIES_MultigridBatchJobRepository_FOR_SPACETREE_GRID_H_
#define PEANO_APPLICATIONS_POISSON_MULTIGRID_REPOSITORIES_MultigridBatchJobRepository_FOR_SPACETREE_GRID_H_


#include "peano/applications/poisson/multigrid/repositories/MultigridBatchJobRepository.h"
 ...
 */
template class peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::multigrid::SpacetreeGridVertex, peano::applications::poisson::multigrid::SpacetreeGridCell>;


class peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepositoryForSpacetreeGrid: public peano::applications::poisson::multigrid::repositories::MultigridBatchJobRepository {
  public:
    virtual peano::applications::poisson::multigrid::State& getState() = 0;
     ...
     */
    virtual void writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::multigrid::SpacetreeGridVertex, peano::applications::poisson::multigrid::SpacetreeGridCell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::multigrid::SpacetreeGridVertex, peano::applications::poisson::multigrid::SpacetreeGridCell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::kernel::gridinterface::Checkpoint<peano::applications::poisson::multigrid::SpacetreeGridVertex, peano::applications::poisson::multigrid::SpacetreeGridCell>* createEmptyCheckpoint() = 0;
    ...
    virtual peano::applications::poisson::multigrid::SpacetreeGridState& getSpacetreeGridState() = 0;
