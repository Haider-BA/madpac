#ifndef _PEANO_APPLICATIONS_POISSON_MULTIGRID_RECORDS_REGULARGRIDCELL_H
#define _PEANO_APPLICATIONS_POISSON_MULTIGRID_RECORDS_REGULARGRIDCELL_H
 ...
 */
class peano::applications::poisson::multigrid::records::RegularGridCell { 
   
   public:
      
      typedef peano::applications::poisson::multigrid::records::RegularGridCellPacked Packed;
    ...
    * @date   28/06/2011 13:44
    */
   class peano::applications::poisson::multigrid::records::RegularGridCellPacked { 
