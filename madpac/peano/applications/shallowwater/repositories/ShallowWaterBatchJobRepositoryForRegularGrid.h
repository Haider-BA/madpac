...
#ifndef PEANO_APPLICATIONS_SHALLOWWATER_REPOSITORIES_ShallowWaterBatchJobRepository_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_SHALLOWWATER_REPOSITORIES_ShallowWaterBatchJobRepository_FOR_REGULAR_GRID_H_


#include "peano/applications/shallowwater/repositories/ShallowWaterBatchJobRepository.h"
 ...
 */
template class peano::kernel::gridinterface::Checkpoint<peano::applications::shallowwater::RegularGridVertex, peano::applications::shallowwater::RegularGridCell>;


class peano::applications::shallowwater::repositories::ShallowWaterBatchJobRepositoryForRegularGrid: public peano::applications::shallowwater::repositories::ShallowWaterBatchJobRepository {
  public:
    /**
     * Create a checkpoint.
     *
     ...
     */
    virtual void writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::shallowwater::RegularGridVertex, peano::applications::shallowwater::RegularGridCell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::shallowwater::RegularGridVertex, peano::applications::shallowwater::RegularGridCell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::kernel::gridinterface::Checkpoint<peano::applications::shallowwater::RegularGridVertex, peano::applications::shallowwater::RegularGridCell>* createEmptyCheckpoint() = 0;
    ...
    virtual peano::applications::shallowwater::RegularGridState& getRegularGridState() = 0;
