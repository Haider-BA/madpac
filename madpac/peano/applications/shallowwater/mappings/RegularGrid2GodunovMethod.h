...
#ifndef PEANO_APPLICATIONS_SHALLOWWATER_MAPPINGS_RegularGrid2GodunovMethod_H_
#define PEANO_APPLICATIONS_SHALLOWWATER_MAPPINGS_RegularGrid2GodunovMethod_H_
 ...
 */
class peano::applications::shallowwater::mappings::RegularGrid2GodunovMethod {
  private:
    /**
     * Logging device.
     */
