...
#ifndef PEANO_APPLICATIONS_SHALLOWWATER_MAPPINGS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_SHALLOWWATER_MAPPINGS_RegularGrid2PlotSolution_H_
 ...
 */
class peano::applications::shallowwater::mappings::RegularGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
    ...
    std::map<tarch::la::Vector<DIMENSIONS,double> , int, tarch::la::VectorCompare<DIMENSIONS> > _cell2IndexMap;
    tarch::plotter::griddata::unstructured::vtk::VTKTextFileWriter _vtkWriter;
    tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexWriter* _vertexWriter;
    tarch::plotter::griddata::unstructured::UnstructuredGridWriter::CellWriter* _cellWriter;
    tarch::plotter::griddata::Writer::CellDataWriter* _cellHeightWaterWriter;
    tarch::plotter::griddata::Writer::CellDataWriter* _cellHeightSeabedWriter;
