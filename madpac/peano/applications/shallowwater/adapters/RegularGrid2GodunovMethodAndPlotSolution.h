...
#ifndef PEANO_APPLICATIONS_SHALLOWWATER_ADAPTERS_RegularGrid2GodunovMethodAndPlotSolution_H_
#define PEANO_APPLICATIONS_SHALLOWWATER_ADAPTERS_RegularGrid2GodunovMethodAndPlotSolution_H_
...
namespace peano { 
  namespace applications { 
    namespace shallowwater {
      namespace adapters {
        class RegularGrid2GodunovMethodAndPlotSolution;
      } 
}
}
}
 ...
 */
class peano::applications::shallowwater::adapters::RegularGrid2GodunovMethodAndPlotSolution {
  private:
  ...
  public:
    RegularGrid2GodunovMethodAndPlotSolution();

    virtual ~RegularGrid2GodunovMethodAndPlotSolution();
