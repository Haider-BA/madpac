...
int peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::_snapshotCounter = 0;


tarch::logging::Log peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::_log( "peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid" );


peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::RegularGrid2SetupExperimentAndPlotGrid():
  _vertex2IndexMap(),
  _vtkWriter(),
  _vertexWriter(0),
  _cellWriter(0),
...
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::createInnerVertex(
...
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::createBoundaryVertex(
  const tarch::la::Vector<DIMENSIONS,double>&  x,
  const tarch::la::Vector<DIMENSIONS,double>&  h,
  peano::applications::shallowwater::RegularGridVertex&  vertex
) {
...
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::destroyVertex(
  const tarch::la::Vector<DIMENSIONS,double>&  x,
  const tarch::la::Vector<DIMENSIONS,double>&  h,
  peano::applications::shallowwater::RegularGridVertex&  vertex
) {
...
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::createCell(
...
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::destroyCell(
  peano::applications::shallowwater::RegularGridVertex const * const vertices,
  peano::applications::shallowwater::RegularGridCell&  cell,
  const peano::kernel::gridinterface::VertexEnumerator&  enumerator
) {
...
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::handleCell(
...
#ifdef Parallel
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::mergeWithNeighbour(
  peano::applications::shallowwater::RegularGridVertex& vertex,
...
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::touchVertexFirstTime(
  peano::applications::shallowwater::RegularGridVertex&  vertex,
  const tarch::la::Vector<DIMENSIONS,double>&  x
) {
...
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::touchVertexLastTime(
  peano::applications::shallowwater::RegularGridVertex&  vertex,
  const tarch::la::Vector<DIMENSIONS,double>&  x
) {
...
#ifdef Parallel
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::prepareSendToNeighbour(
  peano::applications::shallowwater::RegularGridVertex& vertex
) {
...
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::beginIteration(
  ...
  _vertexTypeWriter = _vtkWriter.createVertexDataWriter(peano::applications::shallowwater::RegularGridVertex::Records::getInsideOutsideDomainMapping() ,1);
...
void peano::applications::shallowwater::adapters::RegularGrid2SetupExperimentAndPlotGrid::endIteration(
  peano::applications::shallowwater::RegularGridState&  solverState
) {
