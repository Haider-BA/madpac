#ifndef _PEANO_APPLICATIONS_DIFFUSIONEQUATION_EXPLICITTIMESTEPPING_RECORDS_SPACETREEGRIDSTATE_H
#define _PEANO_APPLICATIONS_DIFFUSIONEQUATION_EXPLICITTIMESTEPPING_RECORDS_SPACETREEGRIDSTATE_H
...
namespace peano {
    ...
    */
   class peano::applications::diffusionequation::explicittimestepping::records::SpacetreeGridState { 
      
      public:
         
         typedef peano::applications::diffusionequation::explicittimestepping::records::SpacetreeGridStatePacked Packed;
      ...
      public:
          ...
          * Generated
          */
         SpacetreeGridState(const double& updateUMax, const double& updateUH, const double& uMax, const double& uH, const double& uGlobalMax, const double& uGlobalH, const int& timeStep, const double& timeStepSize, const double& time, const double& numberOfStencilUpdates, const double& minimalAllowedMeshSize, const double& maximalAllowedMeshSize, const tarch::la::Vector<DIMENSIONS,double>& minMeshWidth, const tarch::la::Vector<DIMENSIONS,double>& maxMeshWidth, const double& numberOfInnerVertices, const double& numberOfBoundaryVertices, const double& numberOfOuterVertices, const double& numberOfInnerCells, const double& numberOfOuterCells, const int& maxLevel, const bool& hasRefined, const bool& hasTriggeredRefinementForNextIteration, const bool& hasErased, const bool& hasTriggeredEraseForNextIteration, const bool& hasChangedVertexOrCellState, const bool& isTraversalInverted, const int& loadBalancingFlag);
       ...
       * @date   21/07/2011 14:26
       */
      class peano::applications::diffusionequation::explicittimestepping::records::SpacetreeGridStatePacked { 
