...
#ifndef PEANO_APPLICATIONS_DIFFUSION_EQUATION_EXPLICITTIMESTEPPING_MAPPINGS_RegularGrid2PerformExplitEulerTimeStep_H_
#define PEANO_APPLICATIONS_DIFFUSION_EQUATION_EXPLICITTIMESTEPPING_MAPPINGS_RegularGrid2PerformExplitEulerTimeStep_H_
  ...
  namespace applications { 
    namespace diffusionequation {
      namespace explicittimestepping {
        namespace mappings {
          class RegularGrid2PerformExplitEulerTimeStep;
        }
      }
    }
  }
 ...
 */
class peano::applications::diffusionequation::explicittimestepping::mappings::RegularGrid2PerformExplitEulerTimeStep {
  private:
    /**
     * Logging device.
     */
    ...
    peano::applications::diffusionequation::Solver  _solver;
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2PerformExplitEulerTimeStep();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2PerformExplitEulerTimeStep();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2PerformExplitEulerTimeStep()
     */
    void beginIteration(
