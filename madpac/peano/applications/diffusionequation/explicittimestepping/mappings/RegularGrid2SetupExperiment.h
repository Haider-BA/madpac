...
#ifndef PEANO_APPLICATIONS_DIFFUSION_EQUATION_EXPLICITTIMESTEPPING_MAPPINGS_RegularGrid2SetupExperiment_H_
#define PEANO_APPLICATIONS_DIFFUSION_EQUATION_EXPLICITTIMESTEPPING_MAPPINGS_RegularGrid2SetupExperiment_H_
 ...
 */
class peano::applications::diffusionequation::explicittimestepping::mappings::RegularGrid2SetupExperiment {
  private:
    /**
     * Logging device.
     */
