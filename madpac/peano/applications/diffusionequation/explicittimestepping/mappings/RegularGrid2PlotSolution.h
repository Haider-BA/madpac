...
#ifndef PEANO_APPLICATIONS_DIFFUSION_EQUATION_EXPLICITTIMESTEPPING_MAPPINGS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_DIFFUSION_EQUATION_EXPLICITTIMESTEPPING_MAPPINGS_RegularGrid2PlotSolution_H_
 ...
 */
class peano::applications::diffusionequation::explicittimestepping::mappings::RegularGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
