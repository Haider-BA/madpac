...
#ifndef PEANO_APPLICATIONS_DIFFUSION_EQUATION_EXPLICITTIMESTEPPING_MAPPINGS_RegularGrid2ApplyRefineDeleteCriterion_H_
#define PEANO_APPLICATIONS_DIFFUSION_EQUATION_EXPLICITTIMESTEPPING_MAPPINGS_RegularGrid2ApplyRefineDeleteCriterion_H_
 ...
 */
class peano::applications::diffusionequation::explicittimestepping::mappings::RegularGrid2ApplyRefineDeleteCriterion {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see RegularGrid2ApplyRefineDeleteCriterion()
     */
    void beginIteration(
