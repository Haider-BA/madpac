...
#ifndef PEANO_APPLICATIONS_DIFFUSIONEQUATION_EXPLICITTIMESTEPPING_ADAPTERS_RegularGrid2SetupExperiment_H_
#define PEANO_APPLICATIONS_DIFFUSIONEQUATION_EXPLICITTIMESTEPPING_ADAPTERS_RegularGrid2SetupExperiment_H_
 ...
 */
class peano::applications::diffusionequation::explicittimestepping::adapters::RegularGrid2SetupExperiment {
  private:
