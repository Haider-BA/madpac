...
#ifndef PEANO_APPLICATIONS_DIFFUSIONEQUATION_EXPLICITTIMESTEPPING_ADAPTERS_RegularGrid2SetupExperimentAndPlot_H_
#define PEANO_APPLICATIONS_DIFFUSIONEQUATION_EXPLICITTIMESTEPPING_ADAPTERS_RegularGrid2SetupExperimentAndPlot_H_
 ...
 */
class peano::applications::diffusionequation::explicittimestepping::adapters::RegularGrid2SetupExperimentAndPlot {
  private:
    peano::applications::diffusionequation::explicittimestepping::mappings::RegularGrid2SetupExperiment _map2SetupExperiment;
