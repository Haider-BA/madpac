...
#ifndef _PEANO_APPLICATIONS_DIFFUSION_EQUATION_USER_INTERFACE_H_
#define _PEANO_APPLICATIONS_DIFFUSION_EQUATION_USER_INTERFACE_H_
...
class peano::applications::diffusionequation::UserInterface: public peano::UserInterface {
  private:
