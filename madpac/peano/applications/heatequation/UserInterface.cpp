...
void peano::applications::heatequation::UserInterface::printIterationInfoForImplicitTimeStepping(
...
void peano::applications::heatequation::UserInterface::printIterationInfoForExplicitTimeStepping(
    double t,
    double dt,
    double solutionInMaximumNorm,
    double solutionInMaximumNormOfGlobalSimulation,
...
double peano::applications::heatequation::UserInterface::getTotalStencilEvaluations() const {
