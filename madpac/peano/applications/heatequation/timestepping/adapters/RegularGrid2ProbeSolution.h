...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2ProbeSolution_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2ProbeSolution_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace adapters {
        class RegularGrid2ProbeSolution;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::adapters::RegularGrid2ProbeSolution {
  private:
    peano::applications::heatequation::timestepping::mappings::RegularGrid2ProbeSolution _map2ProbeSolution;

  public:
    RegularGrid2ProbeSolution();

    virtual ~RegularGrid2ProbeSolution();
