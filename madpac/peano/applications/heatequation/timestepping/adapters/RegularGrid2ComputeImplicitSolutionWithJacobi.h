...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2ComputeImplicitSolutionWithJacobi_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2ComputeImplicitSolutionWithJacobi_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace adapters {
        class RegularGrid2ComputeImplicitSolutionWithJacobi;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::adapters::RegularGrid2ComputeImplicitSolutionWithJacobi {
  private:
    peano::applications::heatequation::timestepping::mappings::RegularGrid2ComputeImplicitSolutionWithJacobi _map2ComputeImplicitSolutionWithJacobi;
    peano::applications::heatequation::timestepping::mappings::RegularGrid2CoarseSolution _map2CoarseSolution;

  public:
    RegularGrid2ComputeImplicitSolutionWithJacobi();

    virtual ~RegularGrid2ComputeImplicitSolutionWithJacobi();
