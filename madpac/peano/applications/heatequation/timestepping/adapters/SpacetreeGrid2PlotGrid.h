...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2PlotGrid_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2PlotGrid_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PlotGrid {
  private:
