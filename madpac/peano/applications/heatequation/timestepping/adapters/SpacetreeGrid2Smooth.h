...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2Smooth_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2Smooth_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2Smooth {
  private:
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2Smooth _map2Smooth;
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2CoarseSolution _map2CoarseSolution;

  public:
    SpacetreeGrid2Smooth();

    virtual ~SpacetreeGrid2Smooth();
