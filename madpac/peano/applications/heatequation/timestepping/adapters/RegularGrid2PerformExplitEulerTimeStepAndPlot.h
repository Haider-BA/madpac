...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2PerformExplitEulerTimeStepAndPlot_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2PerformExplitEulerTimeStepAndPlot_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::RegularGrid2PerformExplitEulerTimeStepAndPlot {
  private:
