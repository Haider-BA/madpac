...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2PerformImplicitTimeStep_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2PerformImplicitTimeStep_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace adapters {
        class SpacetreeGrid2PerformImplicitTimeStep;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStep {
  private:
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2PerformImplicitTimeStep _map2PerformImplicitTimeStep;

  public:
    SpacetreeGrid2PerformImplicitTimeStep();

    virtual ~SpacetreeGrid2PerformImplicitTimeStep();
