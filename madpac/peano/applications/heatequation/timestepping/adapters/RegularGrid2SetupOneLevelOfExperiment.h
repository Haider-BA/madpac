...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2SetupOneLevelOfExperiment_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2SetupOneLevelOfExperiment_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace adapters {
        class RegularGrid2SetupOneLevelOfExperiment;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::adapters::RegularGrid2SetupOneLevelOfExperiment {
  private:
    peano::applications::heatequation::timestepping::mappings::RegularGrid2SetupOneLevelOfExperiment _map2SetupOneLevelOfExperiment;

  public:
    RegularGrid2SetupOneLevelOfExperiment();

    virtual ~RegularGrid2SetupOneLevelOfExperiment();
