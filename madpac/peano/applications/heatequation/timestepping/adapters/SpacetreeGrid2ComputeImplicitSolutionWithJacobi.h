...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2ComputeImplicitSolutionWithJacobi_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2ComputeImplicitSolutionWithJacobi_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2ComputeImplicitSolutionWithJacobi {
  private:
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2ComputeImplicitSolutionWithJacobi _map2ComputeImplicitSolutionWithJacobi;
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2CoarseSolution _map2CoarseSolution;
