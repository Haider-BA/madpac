...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2SetupExperimentAndPlot_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2SetupExperimentAndPlot_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::RegularGrid2SetupExperimentAndPlot {
  private:
    peano::applications::heatequation::timestepping::mappings::RegularGrid2SetupExperiment _map2SetupExperiment;
