...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2SetupExperimentAndPlot_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2SetupExperimentAndPlot_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot {
  private:
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2SetupExperiment _map2SetupExperiment;
