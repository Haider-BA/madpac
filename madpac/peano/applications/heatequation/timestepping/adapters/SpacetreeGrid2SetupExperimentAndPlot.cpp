...
peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::SpacetreeGrid2SetupExperimentAndPlot() {
}
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::createHangingVertex(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::destroyHangingVertex(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::createInnerVertex(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::createBoundaryVertex(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::destroyVertex(
      const peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::createCell(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::destroyCell(
...
#ifdef Parallel
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::mergeWithNeighbour(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::touchVertexFirstTime(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::touchVertexLastTime(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::prepareSendToNeighbour(
  peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex& vertex
) {
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::beginIteration(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::endIteration(
  peano::applications::heatequation::timestepping::SpacetreeGridState&  solverState
) {
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::enterCell(
      peano::applications::heatequation::timestepping::SpacetreeGridCell&                 fineGridCell,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperimentAndPlot::leaveCell(
      peano::applications::heatequation::timestepping::SpacetreeGridCell&           fineGridCell,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex * const  fineGridVertices,
      const peano::kernel::gridinterface::VertexEnumerator&          fineGridVerticesEnumerator,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex * const  coarseGridVertices,
