...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2PerformImplicitTimeStepAndPlot_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2PerformImplicitTimeStepAndPlot_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace adapters {
        class SpacetreeGrid2PerformImplicitTimeStepAndPlot;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot {
  private:
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2PerformImplicitTimeStep _map2PerformImplicitTimeStep;
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2PlotSolution _map2PlotSolution;

  public:
    SpacetreeGrid2PerformImplicitTimeStepAndPlot();

    virtual ~SpacetreeGrid2PerformImplicitTimeStepAndPlot();
