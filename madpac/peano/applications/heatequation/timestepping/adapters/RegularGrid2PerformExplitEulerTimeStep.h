...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2PerformExplitEulerTimeStep_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2PerformExplitEulerTimeStep_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::RegularGrid2PerformExplitEulerTimeStep {
  private:
    peano::applications::heatequation::timestepping::mappings::RegularGrid2PerformExplitEulerTimeStep _map2PerformExplitEulerTimeStep;
