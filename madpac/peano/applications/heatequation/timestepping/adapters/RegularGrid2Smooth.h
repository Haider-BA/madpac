...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2Smooth_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2Smooth_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::RegularGrid2Smooth {
  private:
