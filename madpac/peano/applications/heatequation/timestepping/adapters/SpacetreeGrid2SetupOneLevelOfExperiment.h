...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2SetupOneLevelOfExperiment_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2SetupOneLevelOfExperiment_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace adapters {
        class SpacetreeGrid2SetupOneLevelOfExperiment;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupOneLevelOfExperiment {
  private:
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2SetupOneLevelOfExperiment _map2SetupOneLevelOfExperiment;

  public:
    SpacetreeGrid2SetupOneLevelOfExperiment();

    virtual ~SpacetreeGrid2SetupOneLevelOfExperiment();
