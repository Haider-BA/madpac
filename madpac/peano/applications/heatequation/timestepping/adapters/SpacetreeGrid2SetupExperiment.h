...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2SetupExperiment_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2SetupExperiment_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2SetupExperiment {
  private:
