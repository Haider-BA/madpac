...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2ApplyRefineDeleteCriterion_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2ApplyRefineDeleteCriterion_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace adapters {
        class SpacetreeGrid2ApplyRefineDeleteCriterion;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2ApplyRefineDeleteCriterion {
  private:
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2ApplyRefineDeleteCriterion _map2ApplyRefineDeleteCriterion;

  public:
    SpacetreeGrid2ApplyRefineDeleteCriterion();

    virtual ~SpacetreeGrid2ApplyRefineDeleteCriterion();
