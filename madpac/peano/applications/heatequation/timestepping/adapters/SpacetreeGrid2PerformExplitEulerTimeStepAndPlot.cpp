...
peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot() {
}
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::createHangingVertex(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::destroyHangingVertex(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::createInnerVertex(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::createBoundaryVertex(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::destroyVertex(
      const peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::createCell(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::destroyCell(
...
#ifdef Parallel
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::mergeWithNeighbour(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::touchVertexFirstTime(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::touchVertexLastTime(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::prepareSendToNeighbour(
  peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex& vertex
) {
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::beginIteration(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::endIteration(
  peano::applications::heatequation::timestepping::SpacetreeGridState&  solverState
) {
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::enterCell(
      peano::applications::heatequation::timestepping::SpacetreeGridCell&                 fineGridCell,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformExplitEulerTimeStepAndPlot::leaveCell(
      peano::applications::heatequation::timestepping::SpacetreeGridCell&           fineGridCell,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex * const  fineGridVertices,
      const peano::kernel::gridinterface::VertexEnumerator&          fineGridVerticesEnumerator,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex * const  coarseGridVertices,
