...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2Prolong_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2Prolong_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2Prolong {
  private:
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2Prolong _map2Prolong;
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2Smooth _map2Smooth;

  public:
    SpacetreeGrid2Prolong();

    virtual ~SpacetreeGrid2Prolong();
