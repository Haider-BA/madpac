...
peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::SpacetreeGrid2PerformImplicitTimeStepAndPlot() {
}
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::createHangingVertex(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::destroyHangingVertex(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::createInnerVertex(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::createBoundaryVertex(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::destroyVertex(
      const peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::createCell(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::destroyCell(
...
#ifdef Parallel
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::mergeWithNeighbour(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::touchVertexFirstTime(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex const * const  coarseGridVertices,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::touchVertexLastTime(
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex * const  coarseGridVertices,
...
#ifdef Parallel
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::prepareSendToNeighbour(
  peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex& vertex
) {
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::beginIteration(
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::endIteration(
  peano::applications::heatequation::timestepping::SpacetreeGridState&  solverState
) {
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::enterCell(
      peano::applications::heatequation::timestepping::SpacetreeGridCell&                 fineGridCell,
...
void peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2PerformImplicitTimeStepAndPlot::leaveCell(
      peano::applications::heatequation::timestepping::SpacetreeGridCell&           fineGridCell,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex * const  fineGridVertices,
      const peano::kernel::gridinterface::VertexEnumerator&          fineGridVerticesEnumerator,
      peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex * const  coarseGridVertices,
