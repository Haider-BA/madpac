...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2Coarse_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_SpacetreeGrid2Coarse_H_
...
#include "peano/applications/heatequation/timestepping/SpacetreeGridState.h"
 ...
 #include "peano/applications/heatequation/timestepping/mappings/SpacetreeGrid2ComputeHierarchicalSurplus.h"
 ...
 */
class peano::applications::heatequation::timestepping::adapters::SpacetreeGrid2Coarse {
  private:
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2ComputeHierarchicalSurplus _map2ComputeHierarchicalSurplus;
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2ComputeHierarchicalResidual _map2ComputeHierarchicalResidual;
    peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2RestrictRhs _map2RestrictRhs;

  public:
    SpacetreeGrid2Coarse();

    virtual ~SpacetreeGrid2Coarse();
