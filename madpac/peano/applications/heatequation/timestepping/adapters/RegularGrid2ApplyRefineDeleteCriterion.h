...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2ApplyRefineDeleteCriterion_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_ADAPTERS_RegularGrid2ApplyRefineDeleteCriterion_H_
 ...
 */
class peano::applications::heatequation::timestepping::adapters::RegularGrid2ApplyRefineDeleteCriterion {
  private:
    peano::applications::heatequation::timestepping::mappings::RegularGrid2ApplyRefineDeleteCriterion _map2ApplyRefineDeleteCriterion;
