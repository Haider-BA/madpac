#ifndef _PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_RECORDS_REGULARGRIDCELL_H
#define _PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_RECORDS_REGULARGRIDCELL_H
 ...
 */
class peano::applications::heatequation::timestepping::records::RegularGridCell { 
   
   public:
      
      typedef peano::applications::heatequation::timestepping::records::RegularGridCellPacked Packed;
    ...
    * @date   28/06/2011 13:55
    */
   class peano::applications::heatequation::timestepping::records::RegularGridCellPacked { 
