...
#ifndef _PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_RegularGridSingleStepVertex_H_ 
#define _PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_RegularGridSingleStepVertex_H_
 ...
 */
class peano::applications::heatequation::timestepping::RegularGridSingleStepVertex: public peano::kernel::regulargrid::Vertex< peano::applications::heatequation::timestepping::records::RegularGridSingleStepVertex > { 
  private: 
    typedef class peano::kernel::regulargrid::Vertex< peano::applications::heatequation::timestepping::records::RegularGridSingleStepVertex >  Base;
  public:
    /**
     * Default Constructor
     *
     ...
     */
    RegularGridSingleStepVertex(const Base::PersistentVertex& argument);
    ...
    void incResidual( const RegularGridSingleStepVertex& vertex );

    static tarch::la::Vector<TWO_POWER_D,double>  readRhs(const peano::kernel::gridinterface::VertexEnumerator& enumerator, const RegularGridSingleStepVertex* const vertices);
    static tarch::la::Vector<TWO_POWER_D,double>  readOldU(const peano::kernel::gridinterface::VertexEnumerator& enumerator, const RegularGridSingleStepVertex* const vertices);
    static tarch::la::Vector<TWO_POWER_D,double>  readU(const peano::kernel::gridinterface::VertexEnumerator& enumerator, const RegularGridSingleStepVertex* const vertices);
    static tarch::la::Vector<TWO_POWER_D,double>  readResidual(const peano::kernel::gridinterface::VertexEnumerator& enumerator, const RegularGridSingleStepVertex* const vertices);


    static tarch::la::Vector<TWO_POWER_D_TIMES_TWO_POWER_D,double> readTempP(const peano::kernel::gridinterface::VertexEnumerator& enumerator, const RegularGridSingleStepVertex* const vertices);

    static tarch::la::Vector<TWO_POWER_D_TIMES_THREE_POWER_D,double> readStencil(const peano::kernel::gridinterface::VertexEnumerator& enumerator, const RegularGridSingleStepVertex* const vertices);

    static void writeResidual(const peano::kernel::gridinterface::VertexEnumerator& enumerator, RegularGridSingleStepVertex* const vertices, const tarch::la::Vector<TWO_POWER_D,double>& values );


    static void writeTempAP(const peano::kernel::gridinterface::VertexEnumerator& enumerator, RegularGridSingleStepVertex* const vertices, const tarch::la::Vector<TWO_POWER_D_TIMES_TWO_POWER_D,double>& values);

    static void writeStencil(const peano::kernel::gridinterface::VertexEnumerator& enumerator, RegularGridSingleStepVertex* const vertices, const tarch::la::Vector<TWO_POWER_D_TIMES_THREE_POWER_D,double>& values);
