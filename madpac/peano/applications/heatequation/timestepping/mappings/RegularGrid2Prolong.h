...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2Prolong_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2Prolong_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2Prolong {
  private:
    /**
     * Logging device.
     */
