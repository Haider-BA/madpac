...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2PerformImplicitTimeStep_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2PerformImplicitTimeStep_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2PerformImplicitTimeStep {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see RegularGrid2PerformImplicitTimeStep()
     */
    void beginIteration(
