...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2SetupOneLevelOfExperiment_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2SetupOneLevelOfExperiment_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2SetupOneLevelOfExperiment {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2SetupOneLevelOfExperiment()
     */
    void beginIteration(
