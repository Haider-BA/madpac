...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2ComputeHierarchicalResidual_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2ComputeHierarchicalResidual_H_
  ...
  namespace applications { 
    namespace heatequation { 
      namespace timestepping {
        namespace mappings {
          class SpacetreeGrid2ComputeHierarchicalResidual;
        }
      }
    }
  }
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2ComputeHierarchicalResidual {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2ComputeHierarchicalResidual();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2ComputeHierarchicalResidual();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ComputeHierarchicalResidual()
     */
    void beginIteration(
