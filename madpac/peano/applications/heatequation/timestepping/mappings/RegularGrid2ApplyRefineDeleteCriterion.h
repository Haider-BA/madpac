...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2ApplyRefineDeleteCriterion_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2ApplyRefineDeleteCriterion_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2ApplyRefineDeleteCriterion {
  private:
    /**
     * Logging device.
     */
