...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2ComputeHierarchicalSurplus_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2ComputeHierarchicalSurplus_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace mappings {
        class SpacetreeGrid2ComputeHierarchicalSurplus;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2ComputeHierarchicalSurplus {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2ComputeHierarchicalSurplus();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2ComputeHierarchicalSurplus();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ComputeHierarchicalSurplus()
     */
    void beginIteration(
