...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2SetupExperiment_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2SetupExperiment_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2SetupExperiment {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2SetupExperiment()
     */
    void beginIteration(
