...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2ProbeSolution_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2ProbeSolution_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2ProbeSolution {
  private:
    /**
     * Logging device.
     */
