...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2RestrictRhs_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2RestrictRhs_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2RestrictRhs {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2RestrictRhs();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2RestrictRhs();
