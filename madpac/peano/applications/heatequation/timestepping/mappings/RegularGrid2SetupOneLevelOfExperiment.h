...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2SetupOneLevelOfExperiment_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2SetupOneLevelOfExperiment_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2SetupOneLevelOfExperiment {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see RegularGrid2SetupOneLevelOfExperiment()
     */
    void beginIteration(
