...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2RestrictRhs_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2RestrictRhs_H_
  ...
  namespace applications { 
    namespace heatequation { 
      namespace timestepping {
        namespace mappings {
          class SpacetreeGrid2RestrictRhs;
        }
      }
    }
  }
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2RestrictRhs {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2RestrictRhs();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2RestrictRhs();
