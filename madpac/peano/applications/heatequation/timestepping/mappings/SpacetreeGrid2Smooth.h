...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2Smooth_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2Smooth_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2Smooth {
  private:
    /**
     * Logging device.
     */
