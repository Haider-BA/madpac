...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2PlotSolution_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
