...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2PerformExplitEulerTimeStep_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2PerformExplitEulerTimeStep_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2PerformExplitEulerTimeStep {
  private:
    /**
     * Logging device.
     */
