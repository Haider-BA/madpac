...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2PerformExplitEulerTimeStep_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2PerformExplitEulerTimeStep_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace mappings {
        class SpacetreeGrid2PerformExplitEulerTimeStep;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2PerformExplitEulerTimeStep {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2PerformExplitEulerTimeStep();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2PerformExplitEulerTimeStep();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2PerformExplitEulerTimeStep()
     */
    void beginIteration(
