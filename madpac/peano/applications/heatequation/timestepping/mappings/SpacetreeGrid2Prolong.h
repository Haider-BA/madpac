...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2Prolong_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2Prolong_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2Prolong {
  private:
    /**
     * Logging device.
     */
