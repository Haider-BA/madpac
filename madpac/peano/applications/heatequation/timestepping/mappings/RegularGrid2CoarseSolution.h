...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2CoarseSolution_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2CoarseSolution_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace mappings {
        class RegularGrid2CoarseSolution;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2CoarseSolution {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2CoarseSolution();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2CoarseSolution();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2CoarseSolution()
     */
    void beginIteration(
