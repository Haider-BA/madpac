...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2PerformImplicitTimeStep_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2PerformImplicitTimeStep_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2PerformImplicitTimeStep {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2PerformImplicitTimeStep()
     */
    void beginIteration(
