...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2Smooth_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2Smooth_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2Smooth {
  private:
    /**
     * Logging device.
     */
