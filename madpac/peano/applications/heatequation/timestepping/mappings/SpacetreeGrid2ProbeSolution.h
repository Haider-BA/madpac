...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2ProbeSolution_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2ProbeSolution_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace mappings {
        class SpacetreeGrid2ProbeSolution;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2ProbeSolution {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2ProbeSolution();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2ProbeSolution();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ProbeSolution()
     */
    void beginIteration(
