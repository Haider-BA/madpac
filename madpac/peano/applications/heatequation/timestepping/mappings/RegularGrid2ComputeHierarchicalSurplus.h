...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2ComputeHierarchicalSurplus_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2ComputeHierarchicalSurplus_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace mappings {
        class RegularGrid2ComputeHierarchicalSurplus;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2ComputeHierarchicalSurplus {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2ComputeHierarchicalSurplus();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2ComputeHierarchicalSurplus();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2ComputeHierarchicalSurplus()
     */
    void beginIteration(
