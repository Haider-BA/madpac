...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2ComputeHierarchicalResidual_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2ComputeHierarchicalResidual_H_
...
namespace peano { 
  namespace applications { 
    namespace heatequation { 
      ...
      namespace mappings {
        class RegularGrid2ComputeHierarchicalResidual;
      } 
}
}
}
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2ComputeHierarchicalResidual {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2ComputeHierarchicalResidual();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2ComputeHierarchicalResidual();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2ComputeHierarchicalResidual()
     */
    void beginIteration(
