...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2SetupExperiment_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2SetupExperiment_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2SetupExperiment {
  private:
    /**
     * Logging device.
     */
