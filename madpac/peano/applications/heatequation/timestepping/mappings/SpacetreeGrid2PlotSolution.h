...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2PlotSolution_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2PlotSolution_H_
  ...
  namespace applications { 
    namespace heatequation { 
      namespace timestepping {
        namespace mappings {
          class SpacetreeGrid2PlotSolution;
        }
      }
    }
  }
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2PlotSolution {
  private:
    /**
     * Logging device.
     */
    ...
    tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexTemperatureWriter;
    tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexOldTemperatureWriter;
    tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexRhsWriter;
    tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexResidualWriter;
    tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexDiagonalElementWriter;
    tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexSurplusWriter;
    tarch::plotter::griddata::Writer::VertexDataWriter*                             _vertexLevelWriter;
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2PlotSolution();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2PlotSolution();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2PlotSolution()
     */
    void beginIteration(
