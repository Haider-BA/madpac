...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2ComputeImplicitSolutionWithJacobi_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_RegularGrid2ComputeImplicitSolutionWithJacobi_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::RegularGrid2ComputeImplicitSolutionWithJacobi {
  private:
    /**
     * Logging device.
     */
    ...
    peano::applications::heatequation::Solver _solver;
 ...
 \endcode
     ...
     *
     * @see RegularGrid2ComputeImplicitSolutionWithJacobi()
     */
    void beginIteration(
