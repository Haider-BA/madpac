...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2CoarseSolution_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2CoarseSolution_H_
  ...
  namespace applications { 
    namespace heatequation { 
      namespace timestepping {
        namespace mappings {
          class SpacetreeGrid2CoarseSolution;
        }
      }
    }
  }
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2CoarseSolution {
  private:
    /**
     * Logging device.
     */
    ...
    /**
     * If the mapping receives a touch last time event, it may not modify the
     * coarse grid vertices if we use TBBs or OpenMP. Instead, we first have to
     * make the modification a criticial section.
     */
    #ifdef SharedTBB
    typedef tbb::spin_mutex CoarseGridAccessSemaphore;
    CoarseGridAccessSemaphore _coarseGridAccessSemaphore;
    #endif
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2CoarseSolution();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2CoarseSolution();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2CoarseSolution()
     */
    void beginIteration(
