...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2ApplyRefineDeleteCriterion_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_MAPPINGS_SpacetreeGrid2ApplyRefineDeleteCriterion_H_
 ...
 */
class peano::applications::heatequation::timestepping::mappings::SpacetreeGrid2ApplyRefineDeleteCriterion {
  private:
    /**
     * Logging device.
     */
    ...
    peano::toolbox::solver::SurplusCalculator  _surplusCalculator;
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2ApplyRefineDeleteCriterion()
     */
    void beginIteration(
