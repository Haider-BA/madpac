...
tarch::logging::Log peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::_log( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation" );


peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation(
  ...
  _gridWithPerformExplitEulerTimeStep(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  _gridWithPerformImplicitTimeStep(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  _gridWithPerformImplicitTimeStepAndPlot(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  _gridWithComputeImplicitSolutionWithJacobi(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  _gridWithPerformExplitEulerTimeStepAndPlot(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  ...
  _gridWithSmooth(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  _gridWithCoarse(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  _gridWithProlong(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  _gridWithApplyRefineDeleteCriterion(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  _gridWithSetupOneLevelOfExperiment(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  _gridWithProbeSolution(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset),
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation(...)" );
}
...
peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation(Geometry&)" );

  _repositoryState.setAction( TimeSteppingBatchJobRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(15 +3);

  logTraceOut( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation(Geometry&)" );
}
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::restart(
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::terminate() {
...
peano::applications::heatequation::timestepping::State& peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::getState() {
  return _solverState;
}


peano::applications::heatequation::timestepping::SpacetreeGridState&  peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::getSpacetreeGridState() {
  return _solverState;
}
   

    
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::iterate() {
  tarch::utils::Watch watch( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation", "iterate()", false);
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::iterate(bool reduceState) {

}

 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToSetupExperiment() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperiment); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToSetupExperimentAndPlot() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperimentAndPlot); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToPerformExplitEulerTimeStep() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStep); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToPerformImplicitTimeStep() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStep); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToPerformImplicitTimeStepAndPlot() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStepAndPlot); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToComputeImplicitSolutionWithJacobi() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterComputeImplicitSolutionWithJacobi); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToPerformExplitEulerTimeStepAndPlot() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStepAndPlot); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToPlotSolution() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPlotSolution); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToPlotGrid() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPlotGrid); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToSmooth() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSmooth); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToCoarse() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterCoarse); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToProlong() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterProlong); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToApplyRefineDeleteCriterion() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterApplyRefineDeleteCriterion); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToSetupOneLevelOfExperiment() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSetupOneLevelOfExperiment); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::switchToProbeSolution() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterProbeSolution); }



 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterSetupExperiment() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperiment; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterSetupExperimentAndPlot() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperimentAndPlot; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterPerformExplitEulerTimeStep() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStep; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterPerformImplicitTimeStep() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStep; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterPerformImplicitTimeStepAndPlot() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStepAndPlot; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterComputeImplicitSolutionWithJacobi() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterComputeImplicitSolutionWithJacobi; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterPerformExplitEulerTimeStepAndPlot() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStepAndPlot; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterPlotSolution() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPlotSolution; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterPlotGrid() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPlotGrid; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterSmooth() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSmooth; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterCoarse() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterCoarse; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterProlong() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterProlong; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterApplyRefineDeleteCriterion() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterApplyRefineDeleteCriterion; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterSetupOneLevelOfExperiment() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSetupOneLevelOfExperiment; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterProbeSolution() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterProbeSolution; }



#ifdef CCA
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
   ...
   logInfo( "logIterationStatistics()", "| Smooth \t |  " << _countSmoothRuns << " \t |  " << _measureSmoothCPUTime << " \t |  " << _measureSmoothCPUTime / static_cast<double>(_countSmoothRuns)  << " \t |  " << _measureSmoothCalendarTime << " \t |  " << (_countSmoothRuns==0 ? 0 : _measureSmoothCalendarTime / static_cast<double>(_countSmoothRuns))  );  
   logInfo( "logIterationStatistics()", "| Coarse \t |  " << _countCoarseRuns << " \t |  " << _measureCoarseCPUTime << " \t |  " << _measureCoarseCPUTime / static_cast<double>(_countCoarseRuns)  << " \t |  " << _measureCoarseCalendarTime << " \t |  " << (_countCoarseRuns==0 ? 0 : _measureCoarseCalendarTime / static_cast<double>(_countCoarseRuns))  );  
   logInfo( "logIterationStatistics()", "| Prolong \t |  " << _countProlongRuns << " \t |  " << _measureProlongCPUTime << " \t |  " << _measureProlongCPUTime / static_cast<double>(_countProlongRuns)  << " \t |  " << _measureProlongCalendarTime << " \t |  " << (_countProlongRuns==0 ? 0 : _measureProlongCalendarTime / static_cast<double>(_countProlongRuns))  );  
   logInfo( "logIterationStatistics()", "| ApplyRefineDeleteCriterion \t |  " << _countApplyRefineDeleteCriterionRuns << " \t |  " << _measureApplyRefineDeleteCriterionCPUTime << " \t |  " << _measureApplyRefineDeleteCriterionCPUTime / static_cast<double>(_countApplyRefineDeleteCriterionRuns)  << " \t |  " << _measureApplyRefineDeleteCriterionCalendarTime << " \t |  " << (_countApplyRefineDeleteCriterionRuns==0 ? 0 : _measureApplyRefineDeleteCriterionCalendarTime / static_cast<double>(_countApplyRefineDeleteCriterionRuns))  );  
   logInfo( "logIterationStatistics()", "| SetupOneLevelOfExperiment \t |  " << _countSetupOneLevelOfExperimentRuns << " \t |  " << _measureSetupOneLevelOfExperimentCPUTime << " \t |  " << _measureSetupOneLevelOfExperimentCPUTime / static_cast<double>(_countSetupOneLevelOfExperimentRuns)  << " \t |  " << _measureSetupOneLevelOfExperimentCalendarTime << " \t |  " << (_countSetupOneLevelOfExperimentRuns==0 ? 0 : _measureSetupOneLevelOfExperimentCalendarTime / static_cast<double>(_countSetupOneLevelOfExperimentRuns))  );  
   logInfo( "logIterationStatistics()", "| ProbeSolution \t |  " << _countProbeSolutionRuns << " \t |  " << _measureProbeSolutionCPUTime << " \t |  " << _measureProbeSolutionCPUTime / static_cast<double>(_countProbeSolutionRuns)  << " \t |  " << _measureProbeSolutionCalendarTime << " \t |  " << (_countProbeSolutionRuns==0 ? 0 : _measureProbeSolutionCalendarTime / static_cast<double>(_countProbeSolutionRuns))  );  

}
#endif


void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::logIterationStatistics() const {
...
peano::kernel::gridinterface::Checkpoint<peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex, peano::applications::heatequation::timestepping::SpacetreeGridCell>* peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::createEmptyCheckpoint() {
...
#ifdef Parallel
bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridFileStackImplementation::continueToIterate() {
