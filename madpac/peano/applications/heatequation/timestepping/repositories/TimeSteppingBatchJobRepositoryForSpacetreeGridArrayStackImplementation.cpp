...
tarch::logging::Log peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::_log( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation" );


peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation(...)" );
}
...
peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation(Geometry&)" );
  
  _repositoryState.setAction( TimeSteppingBatchJobRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(15 +3);
  
  logTraceOut( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation(Geometry&)" );
}
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::restart(
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::terminate() {
...
peano::applications::heatequation::timestepping::State& peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::getState() {
  return _solverState;
}


peano::applications::heatequation::timestepping::SpacetreeGridState&  peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::getSpacetreeGridState() {
  return _solverState;
}

   
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::iterate() {
  tarch::utils::Watch watch( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation", "iterate()", false);
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::iterate(bool reduceState) {

}


 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSetupExperiment() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperiment); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSetupExperimentAndPlot() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperimentAndPlot); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToPerformExplitEulerTimeStep() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStep); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToPerformImplicitTimeStep() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStep); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToPerformImplicitTimeStepAndPlot() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStepAndPlot); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToComputeImplicitSolutionWithJacobi() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterComputeImplicitSolutionWithJacobi); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToPerformExplitEulerTimeStepAndPlot() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStepAndPlot); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToPlotSolution() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPlotSolution); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToPlotGrid() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPlotGrid); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSmooth() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSmooth); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToCoarse() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterCoarse); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToProlong() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterProlong); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToApplyRefineDeleteCriterion() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterApplyRefineDeleteCriterion); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToSetupOneLevelOfExperiment() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSetupOneLevelOfExperiment); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::switchToProbeSolution() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterProbeSolution); }



 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSetupExperiment() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperiment; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSetupExperimentAndPlot() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperimentAndPlot; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterPerformExplitEulerTimeStep() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStep; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterPerformImplicitTimeStep() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStep; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterPerformImplicitTimeStepAndPlot() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStepAndPlot; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterComputeImplicitSolutionWithJacobi() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterComputeImplicitSolutionWithJacobi; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterPerformExplitEulerTimeStepAndPlot() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStepAndPlot; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterPlotSolution() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPlotSolution; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterPlotGrid() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPlotGrid; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSmooth() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSmooth; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterCoarse() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterCoarse; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterProlong() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterProlong; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterApplyRefineDeleteCriterion() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterApplyRefineDeleteCriterion; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterSetupOneLevelOfExperiment() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSetupOneLevelOfExperiment; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterProbeSolution() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterProbeSolution; }



#ifdef CCA
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::logIterationStatistics() const {
...
peano::kernel::gridinterface::Checkpoint<peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex, peano::applications::heatequation::timestepping::SpacetreeGridCell>* peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::createEmptyCheckpoint() {
...
#ifdef Parallel
bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridArrayStackImplementation::continueToIterate() {
