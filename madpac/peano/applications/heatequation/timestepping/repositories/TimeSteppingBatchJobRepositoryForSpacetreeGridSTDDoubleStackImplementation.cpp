...
tarch::logging::Log peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::_log( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation" );


peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(...)" );
}
...
peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(Geometry&)" );

  _repositoryState.setAction( TimeSteppingBatchJobRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(15 +3);
  
  logTraceOut( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(Geometry&)" );
}
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::restart(
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::terminate() {
...
peano::applications::heatequation::timestepping::State& peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::getState() {
  return _solverState;
}


peano::applications::heatequation::timestepping::SpacetreeGridState&  peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::getSpacetreeGridState() {
  return _solverState;
}
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::iterate() {
  tarch::utils::Watch watch( "peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation", "iterate()", false);
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::iterate(bool reduceState) {

}


 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetupExperiment() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperiment); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetupExperimentAndPlot() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperimentAndPlot); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPerformExplitEulerTimeStep() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStep); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPerformImplicitTimeStep() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStep); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPerformImplicitTimeStepAndPlot() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStepAndPlot); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToComputeImplicitSolutionWithJacobi() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterComputeImplicitSolutionWithJacobi); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPerformExplitEulerTimeStepAndPlot() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStepAndPlot); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPlotSolution() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPlotSolution); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToPlotGrid() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterPlotGrid); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSmooth() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSmooth); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToCoarse() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterCoarse); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToProlong() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterProlong); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToApplyRefineDeleteCriterion() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterApplyRefineDeleteCriterion); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToSetupOneLevelOfExperiment() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterSetupOneLevelOfExperiment); }
 void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::switchToProbeSolution() { _repositoryState.setAction(TimeSteppingBatchJobRepositoryState::UseAdapterProbeSolution); }



 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetupExperiment() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperiment; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetupExperimentAndPlot() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSetupExperimentAndPlot; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPerformExplitEulerTimeStep() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStep; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPerformImplicitTimeStep() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStep; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPerformImplicitTimeStepAndPlot() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformImplicitTimeStepAndPlot; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterComputeImplicitSolutionWithJacobi() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterComputeImplicitSolutionWithJacobi; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPerformExplitEulerTimeStepAndPlot() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPerformExplitEulerTimeStepAndPlot; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPlotSolution() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPlotSolution; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterPlotGrid() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterPlotGrid; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSmooth() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSmooth; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterCoarse() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterCoarse; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterProlong() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterProlong; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterApplyRefineDeleteCriterion() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterApplyRefineDeleteCriterion; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterSetupOneLevelOfExperiment() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterSetupOneLevelOfExperiment; }
 bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::isActiveAdapterProbeSolution() const { return _repositoryState.getAction() == TimeSteppingBatchJobRepositoryState::UseAdapterProbeSolution; }



#ifdef CCA
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
...
void peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::logIterationStatistics() const {
...
peano::kernel::gridinterface::Checkpoint<peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex, peano::applications::heatequation::timestepping::SpacetreeGridCell>* peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::createEmptyCheckpoint() {
...
#ifdef Parallel
bool peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation::continueToIterate() {
