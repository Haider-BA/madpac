...
#ifndef PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_REPOSITORIES_TimeSteppingBatchJobRepository_FOR_SPACETREE_GRID_STD_DOUBLE_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_HEATEQUATION_TIMESTEPPING_REPOSITORIES_TimeSteppingBatchJobRepository_FOR_SPACETREE_GRID_STD_DOUBLE_STACK_IMPLEMENTATION_H_
...
class peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation: public peano::applications::heatequation::timestepping::repositories::TimeSteppingBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellSTDDoubleStack<peano::applications::heatequation::timestepping::SpacetreeGridCell>       CellStack;
    typedef peano::kernel::stacks::VertexSTDDoubleStack<peano::applications::heatequation::timestepping::SpacetreeGridSingleStepVertex>   VertexStack;
  ...
  public:
    TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
    ...
    virtual ~TimeSteppingBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation();
