...
#ifndef PEANO_APPLICATIONS_PUREGRID_ADAPTERS_SpacetreeGrid2SetupGrid_H_
#define PEANO_APPLICATIONS_PUREGRID_ADAPTERS_SpacetreeGrid2SetupGrid_H_
 ...
 */
class peano::applications::puregrid::adapters::SpacetreeGrid2SetupGrid {
  private:
    peano::applications::puregrid::mappings::SpacetreeGrid2SetupGrid _map2SetupGrid;
  ...
  public:
    SpacetreeGrid2SetupGrid();

    virtual ~SpacetreeGrid2SetupGrid();
