...
#ifndef _PEANO_APPLICATIONS_PUREGRID_RegularGridState_H_ 
#define _PEANO_APPLICATIONS_PUREGRID_RegularGridState_H_
 ...
 * \author RaPeP
 */
class peano::applications::puregrid::RegularGridState: public peano::kernel::regulargrid::State< peano::applications::puregrid::records::RegularGridState >, public peano::applications::puregrid::State {
  private: 
    typedef class peano::kernel::regulargrid::State< peano::applications::puregrid::records::RegularGridState >  Base;
  ...
  public:
    ...
    void writeToCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::puregrid::RegularGridVertex, peano::applications::puregrid::RegularGridCell>& checkpoint ) const;    
    void readFromCheckpoint( const peano::kernel::gridinterface::Checkpoint<peano::applications::puregrid::RegularGridVertex, peano::applications::puregrid::RegularGridCell>& checkpoint );    
