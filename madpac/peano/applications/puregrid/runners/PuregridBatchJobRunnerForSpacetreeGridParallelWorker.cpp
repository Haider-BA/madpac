...
int peano::applications::puregrid::runners::PuregridBatchJobRunnerForSpacetreeGrid::runAsClient(peano::applications::puregrid::repositories::PuregridBatchJobRepositoryForSpacetreeGrid& repository) {
