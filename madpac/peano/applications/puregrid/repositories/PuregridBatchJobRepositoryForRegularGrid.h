...
#ifndef PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_PuregridBatchJobRepository_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_PuregridBatchJobRepository_FOR_REGULAR_GRID_H_
...
class peano::applications::puregrid::repositories::PuregridBatchJobRepositoryForRegularGrid: public peano::applications::puregrid::repositories::PuregridBatchJobRepository {
  public:
    /**
     * Create a checkpoint.
     *
