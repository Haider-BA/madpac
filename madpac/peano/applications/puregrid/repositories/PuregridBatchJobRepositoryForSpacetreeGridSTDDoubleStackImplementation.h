...
#ifndef PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_PuregridBatchJobRepository_FOR_SPACETREE_GRID_STD_DOUBLE_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_PuregridBatchJobRepository_FOR_SPACETREE_GRID_STD_DOUBLE_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace puregrid {
      namespace repositories {
        class PuregridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation;  
      }
}
}
}
...
class peano::applications::puregrid::repositories::PuregridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation: public peano::applications::puregrid::repositories::PuregridBatchJobRepositoryForSpacetreeGrid {
  private:
  ...
  public:
    PuregridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
    ...
    virtual ~PuregridBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation();
