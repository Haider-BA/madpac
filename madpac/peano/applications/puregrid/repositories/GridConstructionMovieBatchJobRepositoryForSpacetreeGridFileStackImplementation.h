...
#ifndef PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_GridConstructionMovieBatchJobRepository_FOR_SPACETREE_GRID_FILE_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_GridConstructionMovieBatchJobRepository_FOR_SPACETREE_GRID_FILE_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace puregrid {
      namespace repositories {
        class GridConstructionMovieBatchJobRepositoryForSpacetreeGridFileStackImplementation;  
      }
}
}
}
...
class peano::applications::puregrid::repositories::GridConstructionMovieBatchJobRepositoryForSpacetreeGridFileStackImplementation: public peano::applications::puregrid::repositories::GridConstructionMovieBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellFileStack<peano::applications::puregrid::SpacetreeGridCell>       CellStack;
    typedef peano::kernel::stacks::VertexFileStack<peano::applications::puregrid::SpacetreeGridVertex>   VertexStack;
  ...
  public:
    GridConstructionMovieBatchJobRepositoryForSpacetreeGridFileStackImplementation(
    ...
    virtual ~GridConstructionMovieBatchJobRepositoryForSpacetreeGridFileStackImplementation();
