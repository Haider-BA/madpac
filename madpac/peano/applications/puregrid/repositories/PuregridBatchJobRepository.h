...
#ifndef PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_PuregridBatchJobRepository_H_
#define PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_PuregridBatchJobRepository_H_
  ...
  namespace applications { 
    namespace puregrid {
      namespace repositories {
        class PuregridBatchJobRepository;  
      }
      /**
       * Forward declaration.
       */
...
class peano::applications::puregrid::repositories::PuregridBatchJobRepository {
  public:
    virtual ~PuregridBatchJobRepository() {}
     ...
     */
     virtual void switchToSetupGrid() = 0;    

     virtual bool isActiveAdapterSetupGrid() const = 0;
