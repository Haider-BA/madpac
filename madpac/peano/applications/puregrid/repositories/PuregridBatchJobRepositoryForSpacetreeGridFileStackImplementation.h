...
#ifndef PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_PuregridBatchJobRepository_FOR_SPACETREE_GRID_FILE_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_PuregridBatchJobRepository_FOR_SPACETREE_GRID_FILE_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace puregrid {
      namespace repositories {
        class PuregridBatchJobRepositoryForSpacetreeGridFileStackImplementation;  
      }
}
}
}
...
class peano::applications::puregrid::repositories::PuregridBatchJobRepositoryForSpacetreeGridFileStackImplementation: public peano::applications::puregrid::repositories::PuregridBatchJobRepositoryForSpacetreeGrid {
  private:
  ...
  public:
    PuregridBatchJobRepositoryForSpacetreeGridFileStackImplementation(
    ...
    virtual ~PuregridBatchJobRepositoryForSpacetreeGridFileStackImplementation();
