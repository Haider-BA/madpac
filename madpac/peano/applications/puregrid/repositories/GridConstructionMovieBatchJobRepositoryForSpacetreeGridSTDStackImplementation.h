...
#ifndef PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_GridConstructionMovieBatchJobRepository_FOR_SPACETREE_GRID_STD_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_GridConstructionMovieBatchJobRepository_FOR_SPACETREE_GRID_STD_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace puregrid {
      namespace repositories {
        class GridConstructionMovieBatchJobRepositoryForSpacetreeGridSTDStackImplementation;  
      }
}
}
}
...
class peano::applications::puregrid::repositories::GridConstructionMovieBatchJobRepositoryForSpacetreeGridSTDStackImplementation: public peano::applications::puregrid::repositories::GridConstructionMovieBatchJobRepositoryForSpacetreeGrid {
  private:
  ...
  public:
    GridConstructionMovieBatchJobRepositoryForSpacetreeGridSTDStackImplementation(
    ...
    virtual ~GridConstructionMovieBatchJobRepositoryForSpacetreeGridSTDStackImplementation();
