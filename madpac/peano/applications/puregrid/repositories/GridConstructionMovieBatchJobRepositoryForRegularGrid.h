...
#ifndef PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_GridConstructionMovieBatchJobRepository_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_PUREGRID_REPOSITORIES_GridConstructionMovieBatchJobRepository_FOR_REGULAR_GRID_H_
 ...
 */
template class peano::kernel::gridinterface::Checkpoint<peano::applications::puregrid::RegularGridVertex, peano::applications::puregrid::RegularGridCell>;


class peano::applications::puregrid::repositories::GridConstructionMovieBatchJobRepositoryForRegularGrid: public peano::applications::puregrid::repositories::GridConstructionMovieBatchJobRepository {
  public:
    /**
     * Create a checkpoint.
     *
     ...
     */
    virtual void writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::puregrid::RegularGridVertex, peano::applications::puregrid::RegularGridCell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::puregrid::RegularGridVertex, peano::applications::puregrid::RegularGridCell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::kernel::gridinterface::Checkpoint<peano::applications::puregrid::RegularGridVertex, peano::applications::puregrid::RegularGridCell>* createEmptyCheckpoint() = 0;
    ...
    virtual peano::applications::puregrid::RegularGridState& getRegularGridState() = 0;
