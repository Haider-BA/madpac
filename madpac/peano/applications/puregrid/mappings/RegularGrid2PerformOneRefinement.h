...
#ifndef PEANO_APPLICATIONS_PUREGRID_MAPPINGS_RegularGrid2PerformOneRefinement_H_
#define PEANO_APPLICATIONS_PUREGRID_MAPPINGS_RegularGrid2PerformOneRefinement_H_
 ...
 */
class peano::applications::puregrid::mappings::RegularGrid2PerformOneRefinement {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see RegularGrid2PerformOneRefinement()
     */
    void beginIteration(
