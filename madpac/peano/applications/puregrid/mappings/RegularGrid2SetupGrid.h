...
#ifndef PEANO_APPLICATIONS_PUREGRID_MAPPINGS_RegularGrid2SetupGrid_H_
#define PEANO_APPLICATIONS_PUREGRID_MAPPINGS_RegularGrid2SetupGrid_H_
 ...
 */
class peano::applications::puregrid::mappings::RegularGrid2SetupGrid {
  private:
    /**
     * Logging device.
     */
