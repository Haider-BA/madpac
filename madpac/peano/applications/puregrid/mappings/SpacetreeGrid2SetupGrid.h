...
#ifndef PEANO_APPLICATIONS_PUREGRID_MAPPINGS_SpacetreeGrid2SetupGrid_H_
#define PEANO_APPLICATIONS_PUREGRID_MAPPINGS_SpacetreeGrid2SetupGrid_H_
 ...
 */
class peano::applications::puregrid::mappings::SpacetreeGrid2SetupGrid {
  private:
    /**
     * Logging device.
     */
