...
#ifndef PEANO_APPLICATIONS_PUREGRID_CONFIGURATIONSPuregridBatchJobConfiguration_FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_PUREGRID_CONFIGURATIONSPuregridBatchJobConfiguration_FOR_REGULAR_GRID_H_
...
class peano::applications::puregrid::configurations::PuregridBatchJobConfigurationForRegularGrid: public tarch::configuration::TopLevelConfiguration {
  private:
    tarch::logging::configurations::LogFilterConfiguration _logFilterConfiguration;
  public: 
    PuregridBatchJobConfigurationForRegularGrid(); 
    virtual ~PuregridBatchJobConfigurationForRegularGrid();
