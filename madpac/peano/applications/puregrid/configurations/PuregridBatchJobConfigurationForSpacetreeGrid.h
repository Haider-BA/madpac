...
#ifndef PEANO_APPLICATIONS_PUREGRID_CONFIGURATIONSPuregridBatchJobConfiguration_FOR_SPACETREE_GRID_H_
#define PEANO_APPLICATIONS_PUREGRID_CONFIGURATIONSPuregridBatchJobConfiguration_FOR_SPACETREE_GRID_H_
...
class peano::applications::puregrid::configurations::PuregridBatchJobConfigurationForSpacetreeGrid: public tarch::configuration::TopLevelConfiguration {
  public: 
    PuregridBatchJobConfigurationForSpacetreeGrid(); 
    virtual ~PuregridBatchJobConfigurationForSpacetreeGrid();
