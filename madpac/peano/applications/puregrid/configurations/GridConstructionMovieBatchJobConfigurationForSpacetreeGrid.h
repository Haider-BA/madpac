...
#ifndef PEANO_APPLICATIONS_PUREGRID_CONFIGURATIONSGridConstructionMovieBatchJobConfiguration_FOR_SPACETREE_GRID_H_
#define PEANO_APPLICATIONS_PUREGRID_CONFIGURATIONSGridConstructionMovieBatchJobConfiguration_FOR_SPACETREE_GRID_H_
...
namespace peano { 
  namespace applications { 
    namespace puregrid {
      ...
      class GridConstructionMovieBatchJobConfigurationForSpacetreeGrid;
      } 
}
}
}
...
class peano::applications::puregrid::configurations::GridConstructionMovieBatchJobConfigurationForSpacetreeGrid: public tarch::configuration::TopLevelConfiguration {
  public: 
    GridConstructionMovieBatchJobConfigurationForSpacetreeGrid(); 
    virtual ~GridConstructionMovieBatchJobConfigurationForSpacetreeGrid();
