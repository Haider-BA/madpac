#ifndef _PEANO_APPLICATIONS_PUREGRID_RECORDS_REGULARGRIDSTATE_H
#define _PEANO_APPLICATIONS_PUREGRID_RECORDS_REGULARGRIDSTATE_H
 ...
 */
class peano::applications::puregrid::records::RegularGridState { 
   
   public:
      
      typedef peano::applications::puregrid::records::RegularGridStatePacked Packed;
   ...
   public:
       ...
       * Generated
       */
      RegularGridState(const int& maxRefinementsPerIteration, const tarch::la::Vector<DIMENSIONS,double>& meshWidth, const double& numberOfInnerVertices, const double& numberOfBoundaryVertices, const double& numberOfOuterVertices, const double& numberOfInnerCells, const double& numberOfOuterCells, const bool& gridIsStationary);
    ...
    * @date   28/06/2011 13:47
    */
   class peano::applications::puregrid::records::RegularGridStatePacked { 
