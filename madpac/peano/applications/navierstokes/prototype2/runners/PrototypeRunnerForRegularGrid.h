...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE2_RUNNERS_PrototypeRunner__FOR_REGULAR_GRID_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE2_RUNNERS_PrototypeRunner__FOR_REGULAR_GRID_H_ 
 ...
 */
class peano::applications::navierstokes::prototype2::runners::PrototypeRunnerForRegularGrid {
  private:
    int runAsMaster(peano::applications::navierstokes::prototype2::repositories::PrototypeRepositoryForRegularGrid& repository);
    
    #ifdef Parallel
    int runAsClient(peano::applications::navierstokes::prototype2::repositories::PrototypeRepositoryForRegularGrid& repository);
    #endif
  public:
     ...
     */
    int run(const peano::applications::navierstokes::prototype2::configurations::PrototypeConfigurationForRegularGrid& configuration); 
};
