...
peano::applications::navierstokes::prototype2::runners::PrototypeRunnerForSpacetreeGrid::PrototypeRunnerForSpacetreeGrid() {
...
int peano::applications::navierstokes::prototype2::runners::PrototypeRunnerForSpacetreeGrid::run(const peano::applications::navierstokes::prototype2::configurations::PrototypeConfigurationForSpacetreeGrid& configuration) {
  ...
  peano::applications::navierstokes::prototype2::repositories::PrototypeRepositoryForSpacetreeGrid* repository = 
    peano::applications::navierstokes::prototype2::repositories::PrototypeRepositoryFactory::getInstance().createSpacetreeGridSTDStackImplementation(
      geometry,
...
int peano::applications::navierstokes::prototype2::runners::PrototypeRunnerForSpacetreeGrid::runAsMaster(peano::applications::navierstokes::prototype2::repositories::PrototypeRepositoryForSpacetreeGrid& repository) {
