...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2MergeF_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2MergeF_H_
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2MergeF {
  private:
    /**
     * Logging device.
     */
