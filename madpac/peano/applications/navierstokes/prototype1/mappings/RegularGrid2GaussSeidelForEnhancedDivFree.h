...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2GaussSeidelForEnhancedDivFree_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2GaussSeidelForEnhancedDivFree_H_
  ...
  namespace applications { 
    namespace navierstokes {
      namespace prototype1 {
        namespace mappings {
          class RegularGrid2GaussSeidelForEnhancedDivFree;
        }
      }
    }
  }
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::RegularGrid2GaussSeidelForEnhancedDivFree {
  private:
    /**
     * Logging device.
     */
     ...
     */
    fluidnumerics::ElementMatrices _elementMatrices;

    int _activeLevel;

    /**
     * Time step size (necessary for correct scaling of pressure contributions).
     */
    double _tau;

    /**
     * Gobally accumulated residual of the current iteration. Is reset to zero
     * in beginTraversal().
     */
    double _residual;

    double _initResidual;

    bool _computeInitResidual;

    /**
     * Setter for time step size.
     *
     * @param newTau New time step size (>0).
     */
    void setNewTimeStepSizeTau(
      const double newTau
    );
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2GaussSeidelForEnhancedDivFree();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2GaussSeidelForEnhancedDivFree();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2GaussSeidelForEnhancedDivFree()
     */
    void beginIteration(
    ...
    /**
     * Getter for _residual.
     */
    double getResidual() const;
    /**
     * Getter for _initResidual.
     */
    double getInitResidual() const;
    /**
     * Method for triggering measurement of initial residual if adapter is used
     * for several solutions in different timesteps.
     */
    void prepareForInitResidual();
};
