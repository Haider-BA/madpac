...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2MergeF_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2MergeF_H_
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::RegularGrid2MergeF {
  private:
    /**
     * Logging device.
     */
