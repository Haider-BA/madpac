...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2MergeA_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2MergeA_H_
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2MergeA {
  private:
    /**
     * Logging device.
     */
