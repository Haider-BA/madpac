...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2CalculatePPERHS_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2CalculatePPERHS_H_
...
namespace peano { 
  namespace applications { 
    namespace navierstokes { 
      ...
      namespace mappings {
        class SpacetreeGrid2CalculatePPERHS;
      } 
}
}
}
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2CalculatePPERHS {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2CalculatePPERHS();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2CalculatePPERHS();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2CalculatePPERHS()
     */
    void beginIteration(
