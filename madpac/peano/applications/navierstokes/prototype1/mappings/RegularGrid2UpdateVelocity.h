...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2UpdateVelocity_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2UpdateVelocity_H_
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::RegularGrid2UpdateVelocity {
  private:
    /**
     * Logging device.
     */
     ...
     * Used element type.
     */
    peano::applications::navierstokes::prototype1::ElementType _elementType;

    /**
     * HACK: Cell size stored in the handleCell to be used in the
     * touchVertexLastTime
     */
    Vector _h;
 ...
 \endcode
     ...
     *
     * @see RegularGrid2UpdateVelocity()
     */
    void beginIteration(
