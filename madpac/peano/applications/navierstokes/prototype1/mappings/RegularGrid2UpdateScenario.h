...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2UpdateScenario_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2UpdateScenario_H_
...
#include "peano/applications/navierstokes/prototype1/SetScenario.h"
  ...
  namespace applications { 
    namespace navierstokes {
      namespace prototype1 {
        namespace mappings {
          class RegularGrid2UpdateScenario;
        }
      }
    }
  }
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::RegularGrid2UpdateScenario {
  private:
    /**
     * Logging device.
     */
    ...
    /**
     * Handler for performing all setup of vertices and cells
     */
    std::auto_ptr<SetScenario> _scenarioHandler;

    /**
     * Handler for doing the calculation of the support size A.
     */
    std::auto_ptr<peano::applications::navierstokes::prototype1::fluidnumerics::CalculateA> _calculateA;
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2UpdateScenario();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2UpdateScenario();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2UpdateScenario()
     */
    void beginIteration(
