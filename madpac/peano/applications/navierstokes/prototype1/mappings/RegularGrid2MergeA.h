...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2MergeA_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2MergeA_H_
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::RegularGrid2MergeA {
  private:
    /**
     * Logging device.
     */
