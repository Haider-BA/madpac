...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2CalculatePPERHS_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2CalculatePPERHS_H_
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::RegularGrid2CalculatePPERHS {
  private:
    /**
     * Logging device.
     */
    ...
    std::auto_ptr<peano::applications::navierstokes::prototype1::fluidnumerics::AbstractCalculatePPERHS> _adaptee;
 ...
 \endcode
     ...
     *
     * @see RegularGrid2CalculatePPERHS()
     */
    void beginIteration(
