...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2CalculateF_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2CalculateF_H_
 ...
 *
 * @author Michael Lieb, Kristof Unterweger, Tobias Weinzierl
 * @version $Revision: 1.10 $
 */
class peano::applications::navierstokes::prototype1::mappings::RegularGrid2CalculateF {
  private:
    /**
     * Logging device.
     */
  ...
  /**
   * Instance of CalculateF.
   */
  std::auto_ptr<peano::applications::navierstokes::prototype1::fluidnumerics::AbstractCalculateF> _calculateF;
