...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2MergePressureGradientUpdate_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2MergePressureGradientUpdate_H_
  ...
  namespace applications { 
    namespace navierstokes {
      namespace prototype1 {
        namespace mappings {
          class RegularGrid2MergePressureGradientUpdate;
        }
      }
    }
  }
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::RegularGrid2MergePressureGradientUpdate {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     */
    virtual ~RegularGrid2MergePressureGradientUpdate();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2MergePressureGradientUpdate()
     */
    void beginIteration(
