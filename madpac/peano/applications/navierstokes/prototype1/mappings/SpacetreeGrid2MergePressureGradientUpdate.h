...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2MergePressureGradientUpdate_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2MergePressureGradientUpdate_H_
...
namespace peano { 
  namespace applications { 
    namespace navierstokes { 
      ...
      namespace mappings {
        class SpacetreeGrid2MergePressureGradientUpdate;
      } 
}
}
}
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2MergePressureGradientUpdate {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2MergePressureGradientUpdate();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2MergePressureGradientUpdate();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2MergePressureGradientUpdate()
     */
    void beginIteration(
