...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2CalculateF_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2CalculateF_H_
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2CalculateF {
  private:
    /**
     * Logging device.
     */
