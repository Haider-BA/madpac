...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2UpdateVelocity_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2UpdateVelocity_H_
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2UpdateVelocity {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2UpdateVelocity()
     */
    void beginIteration(
