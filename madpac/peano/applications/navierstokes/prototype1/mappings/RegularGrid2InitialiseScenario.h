...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2InitialiseScenario_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_MAPPINGS_RegularGrid2InitialiseScenario_H_
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::RegularGrid2InitialiseScenario {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see RegularGrid2InitialiseScenario()
     */
    void beginIteration(
