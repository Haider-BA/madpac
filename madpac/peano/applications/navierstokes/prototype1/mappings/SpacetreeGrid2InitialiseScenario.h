...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2InitialiseScenario_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2InitialiseScenario_H_
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2InitialiseScenario {
  private:
    /**
     * Logging device.
     */
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2InitialiseScenario()
     */
    void beginIteration(
