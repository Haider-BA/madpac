...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2UpdateScenario_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_MAPPINGS_SpacetreeGrid2UpdateScenario_H_
...
namespace peano { 
  namespace applications { 
    namespace navierstokes { 
      ...
      namespace mappings {
        class SpacetreeGrid2UpdateScenario;
      } 
}
}
}
 ...
 */
class peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2UpdateScenario {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2UpdateScenario();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2UpdateScenario();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2UpdateScenario()
     */
    void beginIteration(
