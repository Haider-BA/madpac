...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_REPOSITORIES_PrototypeRepository_FOR_SPACETREE_GRID_STD_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_REPOSITORIES_PrototypeRepository_FOR_SPACETREE_GRID_STD_STACK_IMPLEMENTATION_H_
...
class peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridSTDStackImplementation: public peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellSTDStack<peano::applications::navierstokes::prototype1::SpacetreeGridFluidCellEnhancedDivFreeEulerExplicit>       CellStack;
    typedef peano::kernel::stacks::VertexSTDStack<peano::applications::navierstokes::prototype1::SpacetreeGridFluidVertexEnhancedDivFreeEulerExplicit>   VertexStack;
