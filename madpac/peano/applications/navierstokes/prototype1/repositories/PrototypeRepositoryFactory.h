...
#ifndef _PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1REPOSITORIES_PrototypeRepository_FACTORY_H_ 
#define _PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1REPOSITORIES_PrototypeRepository_FACTORY_H_
 ...
 */
class peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryFactory {
  private:
  ...
  public:
     ...
     * @return New Repository.
     */
    PrototypeRepositoryForSpacetreeGrid* createSpacetreeGridDynamicStackImplementation(
      peano::geometry::Geometry&                   geometry,
      const tarch::la::Vector<DIMENSIONS,double>&  domainSize,
      const tarch::la::Vector<DIMENSIONS,double>&  computationalDomainOffset
    );    
