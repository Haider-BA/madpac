...
tarch::logging::Log peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::_log( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation" );


peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::PrototypeRepositoryForSpacetreeGridArrayStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation(...)" );
}
...
peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::PrototypeRepositoryForSpacetreeGridArrayStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation(Geometry&)" );
  
  _repositoryState.setAction( PrototypeRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(9 +3);
  
  logTraceOut( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation(Geometry&)" );
}
...
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::restart(
...
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::terminate() {
...
peano::applications::navierstokes::prototype1::FluidStateEnhancedDivFreeEulerExplicit& peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::getState() {
  return _solverState;
}


peano::applications::navierstokes::prototype1::SpacetreeGridFluidStateEnhancedDivFreeEulerExplicit&  peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::getSpacetreeGridState() {
  return _solverState;
}

   
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::iterate(bool reduceState) {
  tarch::utils::Watch watch( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation", "iterate(bool)", false);
 ...
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::switchToInitialiseScenario() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterInitialiseScenario); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::switchToMergeA() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterMergeA); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::switchToCalculateF() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterCalculateF); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::switchToCalculatePPERHS() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterCalculatePPERHS); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::switchToGaussSeidelForEnhancedDivFree() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterGaussSeidelForEnhancedDivFree); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::switchToUpdateVelocity() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterUpdateVelocity); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::switchToPlotSolutionVTK() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterPlotSolutionVTK); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::switchToPlotRegularSolutionVTK() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterPlotRegularSolutionVTK); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::switchToUpdateScenario() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterUpdateScenario); }



 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterInitialiseScenario() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterInitialiseScenario; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterMergeA() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterMergeA; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterCalculateF() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterCalculateF; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterCalculatePPERHS() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterCalculatePPERHS; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterGaussSeidelForEnhancedDivFree() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterGaussSeidelForEnhancedDivFree; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterUpdateVelocity() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterUpdateVelocity; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterPlotSolutionVTK() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterPlotSolutionVTK; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterPlotRegularSolutionVTK() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterPlotRegularSolutionVTK; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::isActiveAdapterUpdateScenario() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterUpdateScenario; }



#ifdef CCA
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
...
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::logIterationStatistics() const {
...
#ifdef Parallel
bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridArrayStackImplementation::continueToIterate() {
