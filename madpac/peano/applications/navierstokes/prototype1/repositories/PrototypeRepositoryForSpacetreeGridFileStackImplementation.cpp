...
tarch::logging::Log peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::_log( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation" );


peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::PrototypeRepositoryForSpacetreeGridFileStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation(...)" );
  ...
  logTraceOut( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation(...)" );
}
...
peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::PrototypeRepositoryForSpacetreeGridFileStackImplementation(
  ...
  _repositoryState() {
  logTraceIn( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation(Geometry&)" );

  _repositoryState.setAction( PrototypeRepositoryState::Terminate );

  peano::kernel::datatraversal::autotuning::Oracle::getInstance().setNumberOfOracles(9 +3);

  logTraceOut( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation(Geometry&)" );
}
...
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::restart(
...
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::terminate() {
...
peano::applications::navierstokes::prototype1::FluidStateEnhancedDivFreeEulerExplicit& peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::getState() {
  return _solverState;
}


peano::applications::navierstokes::prototype1::SpacetreeGridFluidStateEnhancedDivFreeEulerExplicit&  peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::getSpacetreeGridState() {
  return _solverState;
}
   

    
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::iterate(bool reduceState) {
  tarch::utils::Watch watch( "peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation", "iterate(bool)", false);
 ...
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::switchToInitialiseScenario() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterInitialiseScenario); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::switchToMergeA() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterMergeA); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::switchToCalculateF() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterCalculateF); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::switchToCalculatePPERHS() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterCalculatePPERHS); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::switchToGaussSeidelForEnhancedDivFree() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterGaussSeidelForEnhancedDivFree); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::switchToUpdateVelocity() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterUpdateVelocity); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::switchToPlotSolutionVTK() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterPlotSolutionVTK); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::switchToPlotRegularSolutionVTK() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterPlotRegularSolutionVTK); }
 void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::switchToUpdateScenario() { _repositoryState.setAction(PrototypeRepositoryState::UseAdapterUpdateScenario); }



 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterInitialiseScenario() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterInitialiseScenario; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterMergeA() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterMergeA; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterCalculateF() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterCalculateF; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterCalculatePPERHS() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterCalculatePPERHS; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterGaussSeidelForEnhancedDivFree() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterGaussSeidelForEnhancedDivFree; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterUpdateVelocity() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterUpdateVelocity; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterPlotSolutionVTK() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterPlotSolutionVTK; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterPlotRegularSolutionVTK() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterPlotRegularSolutionVTK; }
 bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::isActiveAdapterUpdateScenario() const { return _repositoryState.getAction() == PrototypeRepositoryState::UseAdapterUpdateScenario; }



#ifdef CCA
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::logIterationStatistics(peano::integration::cca::ports::grid::Statistics& writeToPort) const {
   logInfo( "logIterationStatistics()", "| InitialiseScenario \t |  " << _countInitialiseScenarioRuns << " \t |  " << _measureInitialiseScenarioCPUTime << " \t |  " << _measureInitialiseScenarioCPUTime / static_cast<double>(_countInitialiseScenarioRuns)  << " \t |  " << _measureInitialiseScenarioCalendarTime << " \t |  " << (_countInitialiseScenarioRuns==0 ? 0 : _measureInitialiseScenarioCalendarTime / static_cast<double>(_countInitialiseScenarioRuns))  );  
   logInfo( "logIterationStatistics()", "| MergeA \t |  " << _countMergeARuns << " \t |  " << _measureMergeACPUTime << " \t |  " << _measureMergeACPUTime / static_cast<double>(_countMergeARuns)  << " \t |  " << _measureMergeACalendarTime << " \t |  " << (_countMergeARuns==0 ? 0 : _measureMergeACalendarTime / static_cast<double>(_countMergeARuns))  );  
   logInfo( "logIterationStatistics()", "| CalculateF \t |  " << _countCalculateFRuns << " \t |  " << _measureCalculateFCPUTime << " \t |  " << _measureCalculateFCPUTime / static_cast<double>(_countCalculateFRuns)  << " \t |  " << _measureCalculateFCalendarTime << " \t |  " << (_countCalculateFRuns==0 ? 0 : _measureCalculateFCalendarTime / static_cast<double>(_countCalculateFRuns))  );  
   logInfo( "logIterationStatistics()", "| CalculatePPERHS \t |  " << _countCalculatePPERHSRuns << " \t |  " << _measureCalculatePPERHSCPUTime << " \t |  " << _measureCalculatePPERHSCPUTime / static_cast<double>(_countCalculatePPERHSRuns)  << " \t |  " << _measureCalculatePPERHSCalendarTime << " \t |  " << (_countCalculatePPERHSRuns==0 ? 0 : _measureCalculatePPERHSCalendarTime / static_cast<double>(_countCalculatePPERHSRuns))  );  
   logInfo( "logIterationStatistics()", "| GaussSeidelForEnhancedDivFree \t |  " << _countGaussSeidelForEnhancedDivFreeRuns << " \t |  " << _measureGaussSeidelForEnhancedDivFreeCPUTime << " \t |  " << _measureGaussSeidelForEnhancedDivFreeCPUTime / static_cast<double>(_countGaussSeidelForEnhancedDivFreeRuns)  << " \t |  " << _measureGaussSeidelForEnhancedDivFreeCalendarTime << " \t |  " << (_countGaussSeidelForEnhancedDivFreeRuns==0 ? 0 : _measureGaussSeidelForEnhancedDivFreeCalendarTime / static_cast<double>(_countGaussSeidelForEnhancedDivFreeRuns))  );  
   logInfo( "logIterationStatistics()", "| UpdateVelocity \t |  " << _countUpdateVelocityRuns << " \t |  " << _measureUpdateVelocityCPUTime << " \t |  " << _measureUpdateVelocityCPUTime / static_cast<double>(_countUpdateVelocityRuns)  << " \t |  " << _measureUpdateVelocityCalendarTime << " \t |  " << (_countUpdateVelocityRuns==0 ? 0 : _measureUpdateVelocityCalendarTime / static_cast<double>(_countUpdateVelocityRuns))  );  
   logInfo( "logIterationStatistics()", "| PlotSolutionVTK \t |  " << _countPlotSolutionVTKRuns << " \t |  " << _measurePlotSolutionVTKCPUTime << " \t |  " << _measurePlotSolutionVTKCPUTime / static_cast<double>(_countPlotSolutionVTKRuns)  << " \t |  " << _measurePlotSolutionVTKCalendarTime << " \t |  " << (_countPlotSolutionVTKRuns==0 ? 0 : _measurePlotSolutionVTKCalendarTime / static_cast<double>(_countPlotSolutionVTKRuns))  );  
   logInfo( "logIterationStatistics()", "| PlotRegularSolutionVTK \t |  " << _countPlotRegularSolutionVTKRuns << " \t |  " << _measurePlotRegularSolutionVTKCPUTime << " \t |  " << _measurePlotRegularSolutionVTKCPUTime / static_cast<double>(_countPlotRegularSolutionVTKRuns)  << " \t |  " << _measurePlotRegularSolutionVTKCalendarTime << " \t |  " << (_countPlotRegularSolutionVTKRuns==0 ? 0 : _measurePlotRegularSolutionVTKCalendarTime / static_cast<double>(_countPlotRegularSolutionVTKRuns))  );  
   logInfo( "logIterationStatistics()", "| UpdateScenario \t |  " << _countUpdateScenarioRuns << " \t |  " << _measureUpdateScenarioCPUTime << " \t |  " << _measureUpdateScenarioCPUTime / static_cast<double>(_countUpdateScenarioRuns)  << " \t |  " << _measureUpdateScenarioCalendarTime << " \t |  " << (_countUpdateScenarioRuns==0 ? 0 : _measureUpdateScenarioCalendarTime / static_cast<double>(_countUpdateScenarioRuns))  );  

}
#endif


void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::logIterationStatistics() const {
...
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::writeCheckpoint(peano::kernel::gridinterface::Checkpoint<peano::applications::navierstokes::prototype1::SpacetreeGridFluidVertexEnhancedDivFreeEulerExplicit, peano::applications::navierstokes::prototype1::SpacetreeGridFluidCellEnhancedDivFreeEulerExplicit> * const checkpoint) {
...
void peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::readCheckpoint( peano::kernel::gridinterface::Checkpoint<peano::applications::navierstokes::prototype1::SpacetreeGridFluidVertexEnhancedDivFreeEulerExplicit, peano::applications::navierstokes::prototype1::SpacetreeGridFluidCellEnhancedDivFreeEulerExplicit> const * const checkpoint ) {
...
#ifdef Parallel
bool peano::applications::navierstokes::prototype1::repositories::PrototypeRepositoryForSpacetreeGridFileStackImplementation::continueToIterate() {
