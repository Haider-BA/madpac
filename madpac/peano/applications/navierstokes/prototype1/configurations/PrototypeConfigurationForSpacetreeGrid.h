...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_CONFIGURATIONSPrototypeConfiguration_FOR_SPACETREE_GRID_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_CONFIGURATIONSPrototypeConfiguration_FOR_SPACETREE_GRID_H_
...
class peano::applications::navierstokes::prototype1::configurations::PrototypeConfigurationForSpacetreeGrid: public tarch::configuration::TopLevelConfiguration {
  public: 
