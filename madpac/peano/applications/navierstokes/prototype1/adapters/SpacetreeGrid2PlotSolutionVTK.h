...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_SpacetreeGrid2PlotSolutionVTK_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_SpacetreeGrid2PlotSolutionVTK_H_
...
#include "peano/applications/navierstokes/prototype1/SpacetreeGridFluidStateEnhancedDivFreeEulerExplicit.h"
 ...
 #include "peano/applications/navierstokes/prototype1/mappings/SpacetreeGrid2PlotSolutionVTK.h"
...
namespace peano { 
  namespace applications { 
    namespace navierstokes { 
      ...
      namespace adapters {
        class SpacetreeGrid2PlotSolutionVTK;
      } 
}
}
}
 ...
 */
class peano::applications::navierstokes::prototype1::adapters::SpacetreeGrid2PlotSolutionVTK {
  private:
    peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2PlotSolutionVTK _map2PlotSolutionVTK;

  public:
    SpacetreeGrid2PlotSolutionVTK();

    virtual ~SpacetreeGrid2PlotSolutionVTK();
