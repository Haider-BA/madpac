...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_SpacetreeGrid2InitialiseScenario_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_SpacetreeGrid2InitialiseScenario_H_
...
#include "peano/applications/navierstokes/prototype1/SpacetreeGridFluidStateEnhancedDivFreeEulerExplicit.h"
 ...
 #include "peano/applications/navierstokes/prototype1/mappings/SpacetreeGrid2InitialiseScenario.h"
...
namespace peano { 
  namespace applications { 
    namespace navierstokes { 
      ...
      namespace adapters {
        class SpacetreeGrid2InitialiseScenario;
      } 
}
}
}
 ...
 */
class peano::applications::navierstokes::prototype1::adapters::SpacetreeGrid2InitialiseScenario {
  private:
    peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2InitialiseScenario _map2InitialiseScenario;

  public:
    SpacetreeGrid2InitialiseScenario();

    virtual ~SpacetreeGrid2InitialiseScenario();
