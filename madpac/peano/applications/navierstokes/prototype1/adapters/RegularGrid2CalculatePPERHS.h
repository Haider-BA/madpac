...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_RegularGrid2CalculatePPERHS_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_RegularGrid2CalculatePPERHS_H_
...
namespace peano { 
  namespace applications { 
    namespace navierstokes { 
      ...
      namespace adapters {
        class RegularGrid2CalculatePPERHS;
      } 
}
}
}
 ...
 */
class peano::applications::navierstokes::prototype1::adapters::RegularGrid2CalculatePPERHS {
  private:
    peano::applications::navierstokes::prototype1::mappings::RegularGrid2MergeF _map2MergeF;
    peano::applications::navierstokes::prototype1::mappings::RegularGrid2CalculatePPERHS _map2CalculatePPERHS;

  public:
    RegularGrid2CalculatePPERHS();

    virtual ~RegularGrid2CalculatePPERHS();
