...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_SpacetreeGrid2MergeA_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_SpacetreeGrid2MergeA_H_
 ...
 */
class peano::applications::navierstokes::prototype1::adapters::SpacetreeGrid2MergeA {
  private:
    peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2MergeA _map2MergeA;

  public:
    SpacetreeGrid2MergeA();

    virtual ~SpacetreeGrid2MergeA();
