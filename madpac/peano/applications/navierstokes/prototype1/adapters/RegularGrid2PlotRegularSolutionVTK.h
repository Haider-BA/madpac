...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_RegularGrid2PlotRegularSolutionVTK_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_RegularGrid2PlotRegularSolutionVTK_H_
...
namespace peano { 
  namespace applications { 
    namespace navierstokes { 
      ...
      namespace adapters {
        class RegularGrid2PlotRegularSolutionVTK;
      } 
}
}
}
 ...
 */
class peano::applications::navierstokes::prototype1::adapters::RegularGrid2PlotRegularSolutionVTK {
  private:
    peano::applications::navierstokes::prototype1::mappings::RegularGrid2PlotRegularSolutionVTK _map2PlotRegularSolutionVTK;

  public:
    RegularGrid2PlotRegularSolutionVTK();

    virtual ~RegularGrid2PlotRegularSolutionVTK();
