...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_RegularGrid2MergeA_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_RegularGrid2MergeA_H_
 ...
 */
class peano::applications::navierstokes::prototype1::adapters::RegularGrid2MergeA {
  private:
    peano::applications::navierstokes::prototype1::mappings::RegularGrid2MergeA _map2MergeA;

  public:
    RegularGrid2MergeA();

    virtual ~RegularGrid2MergeA();
