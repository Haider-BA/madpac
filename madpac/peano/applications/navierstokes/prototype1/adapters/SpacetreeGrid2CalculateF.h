...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_SpacetreeGrid2CalculateF_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_SpacetreeGrid2CalculateF_H_
...
namespace peano { 
  namespace applications { 
    namespace navierstokes { 
      ...
      namespace adapters {
        class SpacetreeGrid2CalculateF;
      } 
}
}
}
 ...
 */
class peano::applications::navierstokes::prototype1::adapters::SpacetreeGrid2CalculateF {
  private:
    peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2CalculateF _map2CalculateF;

  public:
    SpacetreeGrid2CalculateF();

    virtual ~SpacetreeGrid2CalculateF();
