...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_SpacetreeGrid2UpdateVelocity_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_SpacetreeGrid2UpdateVelocity_H_
...
namespace peano { 
  namespace applications { 
    namespace navierstokes { 
      ...
      namespace adapters {
        class SpacetreeGrid2UpdateVelocity;
      } 
}
}
}
 ...
 */
class peano::applications::navierstokes::prototype1::adapters::SpacetreeGrid2UpdateVelocity {
  private:
    ...
    peano::applications::navierstokes::prototype1::mappings::SpacetreeGrid2UpdateVelocity _map2UpdateVelocity;

  public:
    SpacetreeGrid2UpdateVelocity();

    virtual ~SpacetreeGrid2UpdateVelocity();
