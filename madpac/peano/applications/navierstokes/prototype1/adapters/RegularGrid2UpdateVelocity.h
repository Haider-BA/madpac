...
#ifndef PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_RegularGrid2UpdateVelocity_H_
#define PEANO_APPLICATIONS_NAVIERSTOKES_PROTOTYPE1_ADAPTERS_RegularGrid2UpdateVelocity_H_
...
namespace peano { 
  namespace applications { 
    namespace navierstokes { 
      ...
      namespace adapters {
        class RegularGrid2UpdateVelocity;
      } 
}
}
}
 ...
 */
class peano::applications::navierstokes::prototype1::adapters::RegularGrid2UpdateVelocity {
  private:
    ...
    peano::applications::navierstokes::prototype1::mappings::RegularGrid2UpdateVelocity _map2UpdateVelocity;

  public:
    RegularGrid2UpdateVelocity();

    virtual ~RegularGrid2UpdateVelocity();
