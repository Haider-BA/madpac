...
registerTopLevelConfiguration( peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid )


const int peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::
BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::_numberOfVariables =
  20
...
tarch::logging::Log
peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::
_log(
  "peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid"
);


peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid():
...
std::string peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::getTag() const {
  return "run-blocklatticeboltzmann-on-regular-grid";
}


void peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::parseSubtag( tarch::irr::io::IrrXMLReader* xmlReader ) {
...
#ifdef MADPAC
      } else if (xmlReader->getNodeName() == madpac::configurations::MDCouplingConfiguration::TAG){
		 logInfo("parseSubtag()", "Parse " << madpac::configurations::MDCouplingConfiguration::TAG);
		 _mdCouplingConfiguration.parseSubtag(xmlReader);
#endif
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::
BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::computeUndefinedValues(){
...
bool peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::isValid() const {
  bool isValid = true;
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::toXML(std::ostream& out) const {
  out << "<!--" << std::endl
      << "  This is the configuration tag corresponding to peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid. " << std::endl
...
tarch::configuration::TopLevelConfiguration* peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::clone() const {
  return new peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid();
}


int peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::interpreteConfiguration() {
  // determine mesh size
  ...
  for (int d = 1; d < DIMENSIONS; d++){
    if (!tarch::la::equals(meshSize, (_regularGridConfiguration.getDomainSize()(d) / (_regularGridConfiguration.getNumberOfGridPoints()(d)) )) ){
      logError("interpreteConfiguration()", "Domain-size and number of vertices do not match in dimension " << d << "! No common meshsize in all dimensions!");
      assertion(false);
    }
  }
  setDx(meshSize);
  ...
  peano::applications::latticeboltzmann::blocklatticeboltzmann::runners::BlockLatticeBoltzmannBatchJobRunnerForRegularGrid runner;
#ifdef MADPAC
  _mdCouplingConfiguration.initCoupling();
#endif
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::configurations::BlockLatticeBoltzmannBatchJobConfigurationForRegularGrid::initState(peano::applications::latticeboltzmann::blocklatticeboltzmann::RegularGridBlockState& state) const{
  peano::applications::latticeboltzmann::blocklatticeboltzmann::RegularGridBlockState myState = getStateForReferenceGridLevel();
