...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_ADAPTERS_SpacetreeGrid2RegularBlockSolverAndVTKOutputAdapter_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_ADAPTERS_SpacetreeGrid2RegularBlockSolverAndVTKOutputAdapter_H_
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::adapters::SpacetreeGrid2RegularBlockSolverAndVTKOutputAdapter {
  private:
    peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::SpacetreeGrid2BlockVTKOutput _map2BlockVTKOutput;
    peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::SpacetreeGrid2RegularBlockSolver _map2RegularBlockSolver;
    peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::SpacetreeGrid2BlockCCAOutput _map2BlockCCAOutput;
