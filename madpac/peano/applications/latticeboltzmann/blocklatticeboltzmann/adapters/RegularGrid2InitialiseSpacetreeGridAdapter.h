...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_ADAPTERS_RegularGrid2InitialiseSpacetreeGridAdapter_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_ADAPTERS_RegularGrid2InitialiseSpacetreeGridAdapter_H_
...
namespace peano { 
  namespace applications { 
    namespace latticeboltzmann { 
      ...
      namespace adapters {
        class RegularGrid2InitialiseSpacetreeGridAdapter;
      } 
}
}
}
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::adapters::RegularGrid2InitialiseSpacetreeGridAdapter {
  private:
    peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2InitialiseSpacetreeGrid _map2InitialiseSpacetreeGrid;

  public:
    RegularGrid2InitialiseSpacetreeGridAdapter();

    virtual ~RegularGrid2InitialiseSpacetreeGridAdapter();
