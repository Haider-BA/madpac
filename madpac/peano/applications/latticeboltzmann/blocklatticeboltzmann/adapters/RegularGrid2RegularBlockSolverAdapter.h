...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_ADAPTERS_RegularGrid2RegularBlockSolverAdapter_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_ADAPTERS_RegularGrid2RegularBlockSolverAdapter_H_
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::adapters::RegularGrid2RegularBlockSolverAdapter {
  private:
