...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_ADAPTERS_SpacetreeGrid2RegularBlockSolverAdapter_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_ADAPTERS_SpacetreeGrid2RegularBlockSolverAdapter_H_
...
namespace peano { 
  namespace applications { 
    namespace latticeboltzmann { 
      ...
      namespace adapters {
        class SpacetreeGrid2RegularBlockSolverAdapter;
      } 
}
}
}
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::adapters::SpacetreeGrid2RegularBlockSolverAdapter {
  private:
  ...
  public:
    SpacetreeGrid2RegularBlockSolverAdapter();

    virtual ~SpacetreeGrid2RegularBlockSolverAdapter();
