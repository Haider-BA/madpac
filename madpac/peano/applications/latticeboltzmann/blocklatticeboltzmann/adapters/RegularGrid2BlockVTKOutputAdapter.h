...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_ADAPTERS_RegularGrid2BlockVTKOutputAdapter_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_ADAPTERS_RegularGrid2BlockVTKOutputAdapter_H_
...
namespace peano { 
  namespace applications { 
    namespace latticeboltzmann { 
      ...
      namespace adapters {
        class RegularGrid2BlockVTKOutputAdapter;
      } 
}
}
}
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::adapters::RegularGrid2BlockVTKOutputAdapter {
  private:
  ...
  public:
    ...
    virtual ~RegularGrid2BlockVTKOutputAdapter();
