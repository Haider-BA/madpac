...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_RegularGrid2InitialiseSpacetreeGrid_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_RegularGrid2InitialiseSpacetreeGrid_H_
...
namespace peano { 
  namespace applications { 
    namespace latticeboltzmann { 
      ...
      namespace mappings {
        class RegularGrid2InitialiseSpacetreeGrid;
      } 
}
}
}
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2InitialiseSpacetreeGrid {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2InitialiseSpacetreeGrid();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2InitialiseSpacetreeGrid();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2InitialiseSpacetreeGrid()
     */
    void beginIteration(
