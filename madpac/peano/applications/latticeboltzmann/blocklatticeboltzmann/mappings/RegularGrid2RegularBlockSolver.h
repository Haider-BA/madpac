...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_RegularGrid2RegularBlockSolver_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_RegularGrid2RegularBlockSolver_H_
...
namespace peano {
  namespace applications {
    namespace latticeboltzmann {
      ...
      namespace mappings {
        class RegularGrid2RegularBlockSolver;
      }
}
}
}
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2RegularBlockSolver();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2RegularBlockSolver();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2RegularBlockSolver()
     */
    void beginIteration(
     ...
     */
    bool parallelise( int numberOfGridCells );
