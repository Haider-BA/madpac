...
#ifdef MADPAC
#include "madpac/peanocoupling/PeanoDataExchangeService.h"
#endif

tarch::logging::Log peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::_log( "peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver" );


peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::RegularGrid2RegularBlockSolver():
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::createInnerVertex(
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::createBoundaryVertex(
  const tarch::la::Vector<DIMENSIONS,double>&  x,
  const tarch::la::Vector<DIMENSIONS,double>&  h,
  peano::applications::latticeboltzmann::blocklatticeboltzmann::RegularGridBlockVertex&  vertex
) {
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::destroyVertex(
  const tarch::la::Vector<DIMENSIONS,double>&  x,
  const tarch::la::Vector<DIMENSIONS,double>&  h,
  peano::applications::latticeboltzmann::blocklatticeboltzmann::RegularGridBlockVertex&  vertex
) {
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::createCell(
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::destroyCell(
  peano::applications::latticeboltzmann::blocklatticeboltzmann::RegularGridBlockVertex const * const vertices,
  peano::applications::latticeboltzmann::blocklatticeboltzmann::RegularGridBlockCell&  cell,
  const peano::kernel::gridinterface::VertexEnumerator&  enumerator
) {
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::touchVertexFirstTime(
  peano::applications::latticeboltzmann::blocklatticeboltzmann::RegularGridBlockVertex&  vertex,
  const tarch::la::Vector<DIMENSIONS,double>&  x
) {
...
#ifdef MADPAC
  tarch::la::Vector<LB_DIMENSIONS_BY_BLOCKSIZE,double> g = 0.0;
  logDebug("touchVertexFirstTime()","Call getAndSetV()");
  madpac::PeanoDataExchangeService::getInstance().getAndSetV(x,_h,velocity, density, g);
#endif
...
#ifdef MADPAC
  madpac::PeanoDataExchangeService::getInstance().adjustF(velocity,density,g,pdf,_level);
#endif
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::handleCell(
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::touchVertexLastTime(
  peano::applications::latticeboltzmann::blocklatticeboltzmann::RegularGridBlockVertex&  vertex,
  const tarch::la::Vector<DIMENSIONS,double>&  x
) {
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::beginIteration(
...
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::endIteration(
  peano::applications::latticeboltzmann::blocklatticeboltzmann::RegularGridBlockState&  solverState
) {
...
bool peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::parallelise( int numberOfGridCells ) {
  return false;
}
...
#ifdef Parallel
void peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2RegularBlockSolver::
mergeWithNeighbour(
  peano::applications::latticeboltzmann::blocklatticeboltzmann::RegularGridBlockVertex& vertex,
