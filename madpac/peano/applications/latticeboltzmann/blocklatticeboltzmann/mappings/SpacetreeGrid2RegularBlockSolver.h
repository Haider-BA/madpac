...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_SpacetreeGrid2RegularBlockSolver_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_SpacetreeGrid2RegularBlockSolver_H_
...
namespace peano {
  namespace applications {
    namespace latticeboltzmann {
      ...
      namespace mappings {
        class SpacetreeGrid2RegularBlockSolver;
      }
}
}
}
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::SpacetreeGrid2RegularBlockSolver {
private:
  /**
   * Logging device.
   */
  ...
  > _blockCollisionModelManager;

  const peano::applications::latticeboltzmann::blocklatticeboltzmann::nonlocaltreatment::
  AABlockStreaming _aaBlockStreaming;

  const peano::applications::latticeboltzmann::blocklatticeboltzmann::BlockRestrictionProlongation
    _blockRestrictionProlongation;

  std::auto_ptr<
    peano::applications::latticeboltzmann::blocklatticeboltzmann::boundaryconditions::
    BlockBoundaryConditionManager
  > _blockBoundaryConditionManager;

  std::auto_ptr<peano::applications::latticeboltzmann::blocklatticeboltzmann::nonlocaltreatment::
  DensityInterpolation> _densityInterpolation;
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2RegularBlockSolver();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2RegularBlockSolver();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2RegularBlockSolver()
     */
    void beginIteration(
