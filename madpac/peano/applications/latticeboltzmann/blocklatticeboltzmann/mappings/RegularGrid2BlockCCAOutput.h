...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_RegularGrid2BlockCCAOutput_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_RegularGrid2BlockCCAOutput_H_
...
namespace peano {
  namespace applications {
    namespace latticeboltzmann {
      ...
      namespace mappings {
        class RegularGrid2BlockCCAOutput;
      }
}
}
}
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2BlockCCAOutput {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2BlockCCAOutput();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2BlockCCAOutput();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2BlockCCAOutput()
     */
    void beginIteration(
