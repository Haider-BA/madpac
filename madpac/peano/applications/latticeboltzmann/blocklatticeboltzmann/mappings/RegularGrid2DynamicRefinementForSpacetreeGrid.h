...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_RegularGrid2DynamicRefinementForSpacetreeGrid_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_RegularGrid2DynamicRefinementForSpacetreeGrid_H_
...
namespace peano { 
  namespace applications { 
    namespace latticeboltzmann { 
      ...
      namespace mappings {
        class RegularGrid2DynamicRefinementForSpacetreeGrid;
      } 
}
}
}
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2DynamicRefinementForSpacetreeGrid {
  private:
    /**
     * Logging device.
     */
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2DynamicRefinementForSpacetreeGrid();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2DynamicRefinementForSpacetreeGrid();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2DynamicRefinementForSpacetreeGrid()
     */
    void beginIteration(
