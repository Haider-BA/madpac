...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_SpacetreeGrid2DynamicRefinementForSpacetreeGrid_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_SpacetreeGrid2DynamicRefinementForSpacetreeGrid_H_
...
namespace peano {
  namespace applications {
    namespace latticeboltzmann {
      ...
      namespace mappings {
        class SpacetreeGrid2DynamicRefinementForSpacetreeGrid;
      }
}
}
}
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::SpacetreeGrid2DynamicRefinementForSpacetreeGrid {
  private:
    /**
     * Logging device.
     */
    ...
    peano::applications::latticeboltzmann::blocklatticeboltzmann::DynamicGeometryRefinement *_dynamicGeometryRefinement;
    int _nextLevel;
    int _referenceLevel;
  ...
  public:
     ...
     * modification.
     */
    SpacetreeGrid2DynamicRefinementForSpacetreeGrid();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~SpacetreeGrid2DynamicRefinementForSpacetreeGrid();
 ...
 \endcode
     ...
     *
     * @see SpacetreeGrid2DynamicRefinementForSpacetreeGrid()
     */
    void beginIteration(
