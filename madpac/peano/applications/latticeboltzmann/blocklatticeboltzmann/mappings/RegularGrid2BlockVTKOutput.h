...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_RegularGrid2BlockVTKOutput_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_RegularGrid2BlockVTKOutput_H_
...
namespace peano {
  namespace applications {
    namespace latticeboltzmann {
      ...
      namespace mappings {
        class RegularGrid2BlockVTKOutput;
      }
}
}
}
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::RegularGrid2BlockVTKOutput {
  ...
  public:
     ...
     * modification.
     */
    RegularGrid2BlockVTKOutput();

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RegularGrid2BlockVTKOutput();
 ...
 \endcode
     ...
     *
     * @see RegularGrid2BlockVTKOutput()
     */
    void beginIteration(
...
//#if defined(Debug) && (!defined(Parallel))
    // counts the number of vertices used by the regular grid and prints their value in all respective sub cells of the
    // corresponding block
    int _blockCounter;
    tarch::plotter::griddata::Writer::CellDataWriter* _blockIdWriter;
//#endif
