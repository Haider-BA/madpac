...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_SpacetreeGrid2BlockCCAOutput_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_SpacetreeGrid2BlockCCAOutput_H_
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::SpacetreeGrid2BlockCCAOutput {
  private:
    /**
     * Logging device.
     */
