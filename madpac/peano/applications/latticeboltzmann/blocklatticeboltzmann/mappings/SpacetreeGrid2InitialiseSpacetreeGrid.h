...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_SpacetreeGrid2InitialiseSpacetreeGrid_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_MAPPINGS_SpacetreeGrid2InitialiseSpacetreeGrid_H_
 ...
 */
class peano::applications::latticeboltzmann::blocklatticeboltzmann::mappings::SpacetreeGrid2InitialiseSpacetreeGrid {
  private:
    /**
     * Logging device.
     */
