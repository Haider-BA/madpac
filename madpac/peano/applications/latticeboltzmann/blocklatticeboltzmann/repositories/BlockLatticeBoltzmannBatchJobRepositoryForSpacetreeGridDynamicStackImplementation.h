...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_REPOSITORIES_BlockLatticeBoltzmannBatchJobRepository_FOR_SPACETREE_GRID_DYNAMIC_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_REPOSITORIES_BlockLatticeBoltzmannBatchJobRepository_FOR_SPACETREE_GRID_DYNAMIC_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace latticeboltzmann { 
      ...
      namespace repositories {
        class BlockLatticeBoltzmannBatchJobRepositoryForSpacetreeGridDynamicStackImplementation;  
      }
}
}
}
...
class peano::applications::latticeboltzmann::blocklatticeboltzmann::repositories::BlockLatticeBoltzmannBatchJobRepositoryForSpacetreeGridDynamicStackImplementation: public peano::applications::latticeboltzmann::blocklatticeboltzmann::repositories::BlockLatticeBoltzmannBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellDynamicStack<peano::applications::latticeboltzmann::blocklatticeboltzmann::SpacetreeGridBlockCell>       CellStack;
    typedef peano::kernel::stacks::VertexDynamicStack<peano::applications::latticeboltzmann::blocklatticeboltzmann::SpacetreeGridBlockVertex>   VertexStack;
  ...
  public:
    BlockLatticeBoltzmannBatchJobRepositoryForSpacetreeGridDynamicStackImplementation(
    ...
    virtual ~BlockLatticeBoltzmannBatchJobRepositoryForSpacetreeGridDynamicStackImplementation();
