...
#ifndef PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_REPOSITORIES_BlockLatticeBoltzmannBatchJobRepository_FOR_SPACETREE_GRID_STD_DOUBLE_STACK_IMPLEMENTATION_H_
#define PEANO_APPLICATIONS_LATTICEBOLTZMANN_BLOCKLATTICEBOLTZMANN_REPOSITORIES_BlockLatticeBoltzmannBatchJobRepository_FOR_SPACETREE_GRID_STD_DOUBLE_STACK_IMPLEMENTATION_H_
  ...
  namespace applications { 
    namespace latticeboltzmann { 
      ...
      namespace repositories {
        class BlockLatticeBoltzmannBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation;  
      }
}
}
}
...
class peano::applications::latticeboltzmann::blocklatticeboltzmann::repositories::BlockLatticeBoltzmannBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation: public peano::applications::latticeboltzmann::blocklatticeboltzmann::repositories::BlockLatticeBoltzmannBatchJobRepositoryForSpacetreeGrid {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::kernel::stacks::CellSTDDoubleStack<peano::applications::latticeboltzmann::blocklatticeboltzmann::SpacetreeGridBlockCell>       CellStack;
    typedef peano::kernel::stacks::VertexSTDDoubleStack<peano::applications::latticeboltzmann::blocklatticeboltzmann::SpacetreeGridBlockVertex>   VertexStack;
  ...
  public:
    BlockLatticeBoltzmannBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation(
    ...
    virtual ~BlockLatticeBoltzmannBatchJobRepositoryForSpacetreeGridSTDDoubleStackImplementation();
