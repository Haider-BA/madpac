...
#ifndef MADPAC_VECTOR_
#define MADPAC_VECTOR_
...
template <typename type, int length>
std::ostream& operator<<(std::ostream& stream, const madpac::core::utils::Vector<type, length>& v) {
...
template <typename type, int length>
madpac::core::utils::Vector<type, length> operator*(double scalar, const madpac::core::utils::Vector<type, length>& v) {
	return v * scalar;
}
...
template <typename type, int length>
class madpac::core::utils::Vector {
