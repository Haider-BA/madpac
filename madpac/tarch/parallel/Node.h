...
class tarch::parallel::Node {
  ...
  private:
    ...
    void plotMessagesInQueueToError(int rank);
  ...
  public:
     ...
     * @return 0
     */
    static int getMasterProcessRank();
    ...
    void writeTimeOutWarning( const std::string& className, const std::string& methodName, int communicationPartnerRank );
