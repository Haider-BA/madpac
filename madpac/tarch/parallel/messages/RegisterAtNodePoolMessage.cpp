...
tarch::parallel::messages::RegisterAtNodePoolMessagePacked tarch::parallel::messages::RegisterAtNodePoolMessage::convert() const{
   ...
   void tarch::parallel::messages::RegisterAtNodePoolMessage::send(int destination, int tag) {
   ...
   void tarch::parallel::messages::RegisterAtNodePoolMessage::receive(int source, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   bool tarch::parallel::messages::RegisterAtNodePoolMessage::isMessageInQueue(int tag) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
...
tarch::parallel::messages::RegisterAtNodePoolMessage tarch::parallel::messages::RegisterAtNodePoolMessagePacked::convert() const{
   ...
   void tarch::parallel::messages::RegisterAtNodePoolMessagePacked::send(int destination, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   void tarch::parallel::messages::RegisterAtNodePoolMessagePacked::receive(int source, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   bool tarch::parallel::messages::RegisterAtNodePoolMessagePacked::isMessageInQueue(int tag) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
