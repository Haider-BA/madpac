...
tarch::parallel::messages::WorkerRequestMessagePacked tarch::parallel::messages::WorkerRequestMessage::convert() const{
   ...
   void tarch::parallel::messages::WorkerRequestMessage::send(int destination, int tag) {
   ...
   void tarch::parallel::messages::WorkerRequestMessage::receive(int source, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   bool tarch::parallel::messages::WorkerRequestMessage::isMessageInQueue(int tag) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
...
tarch::parallel::messages::WorkerRequestMessage tarch::parallel::messages::WorkerRequestMessagePacked::convert() const{
   ...
   void tarch::parallel::messages::WorkerRequestMessagePacked::send(int destination, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   void tarch::parallel::messages::WorkerRequestMessagePacked::receive(int source, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   bool tarch::parallel::messages::WorkerRequestMessagePacked::isMessageInQueue(int tag) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
