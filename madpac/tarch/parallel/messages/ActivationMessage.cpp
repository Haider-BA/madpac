...
tarch::parallel::messages::ActivationMessagePacked tarch::parallel::messages::ActivationMessage::convert() const{
   ...
   void tarch::parallel::messages::ActivationMessage::send(int destination, int tag) {
   ...
   void tarch::parallel::messages::ActivationMessage::receive(int source, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   bool tarch::parallel::messages::ActivationMessage::isMessageInQueue(int tag) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
...
tarch::parallel::messages::ActivationMessage tarch::parallel::messages::ActivationMessagePacked::convert() const{
   ...
   void tarch::parallel::messages::ActivationMessagePacked::send(int destination, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   void tarch::parallel::messages::ActivationMessagePacked::receive(int source, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   bool tarch::parallel::messages::ActivationMessagePacked::isMessageInQueue(int tag) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
