...
tarch::parallel::messages::JobRequestMessagePacked tarch::parallel::messages::JobRequestMessage::convert() const{
   ...
   void tarch::parallel::messages::JobRequestMessage::send(int destination, int tag) {
   ...
   void tarch::parallel::messages::JobRequestMessage::receive(int source, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   bool tarch::parallel::messages::JobRequestMessage::isMessageInQueue(int tag) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
...
void tarch::parallel::messages::JobRequestMessagePacked::PersistentRecords::setDummy(const bool& dummy) {
   short int mask = 1 << (0);
   _packedRecords0 = dummy ? (_packedRecords0 | mask) : (_packedRecords0 & ~mask);
}
...
void tarch::parallel::messages::JobRequestMessagePacked::setDummy(const bool& dummy) {
   short int mask = 1 << (0);
   _persistentRecords._packedRecords0 = dummy ? (_persistentRecords._packedRecords0 | mask) : (_persistentRecords._packedRecords0 & ~mask);
}
...
tarch::parallel::messages::JobRequestMessage tarch::parallel::messages::JobRequestMessagePacked::convert() const{
   ...
   void tarch::parallel::messages::JobRequestMessagePacked::send(int destination, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   void tarch::parallel::messages::JobRequestMessagePacked::receive(int source, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   bool tarch::parallel::messages::JobRequestMessagePacked::isMessageInQueue(int tag) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
